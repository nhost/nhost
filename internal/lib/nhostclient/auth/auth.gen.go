...
func (e LinkProviderParamsProvider) Valid() bool {
	...
	case LinkProviderParamsProviderApple:
		return true
	case LinkProviderParamsProviderAzuread:
		return true
	case LinkProviderParamsProviderBitbucket:
		return true
	case LinkProviderParamsProviderDiscord:
		return true
	case LinkProviderParamsProviderEntraid:
		return true
	case LinkProviderParamsProviderFacebook:
		return true
	case LinkProviderParamsProviderGithub:
		return true
	case LinkProviderParamsProviderGitlab:
		return true
	case LinkProviderParamsProviderGoogle:
		return true
	case LinkProviderParamsProviderLinkedin:
		return true
	case LinkProviderParamsProviderSpotify:
		return true
	case LinkProviderParamsProviderStrava:
		return true
	case LinkProviderParamsProviderTwitch:
		return true
	case LinkProviderParamsProviderTwitter:
		return true
	case LinkProviderParamsProviderWindowslive:
		return true
	case LinkProviderParamsProviderWorkos:
		return true
	default:
		return false
	}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r LinkProviderR) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
