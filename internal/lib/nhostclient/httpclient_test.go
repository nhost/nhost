...
func (m *mockDoer) Post(_, _ string, body io.Reader) (*http.Response, error) {
	m.calls++
...
func TestRetryDoer_Post_SuccessFirstTry(t *testing.T) {
	t.Parallel()
	...
	resp, err := doer.Post(
		"http://localhost/test", "application/json", strings.NewReader(`{"ok":true}`),
	)
	if err != nil {
		t.Fatalf("expected no error, got: %v", err)
	}
...
func TestRetryDoer_Post_SuccessAfterRetries(t *testing.T) {
	t.Parallel()
	...
	resp, err := doer.Post(
		"http://localhost/test", "application/json", strings.NewReader(`{"retry":true}`),
	)
	if err != nil {
		t.Fatalf("expected no error, got: %v", err)
	}
...
func TestRetryDoer_Post_ExhaustsRetries(t *testing.T) {
	t.Parallel()
...
func TestRetryDoer_Post_NilBody(t *testing.T) {
	t.Parallel()
	...
	resp, err := doer.Post("http://localhost/test", "application/json", nil)
	if err != nil {
		t.Fatalf("expected no error, got: %v", err)
	}
...
func TestRetryDoer_Post_BodyReplayedOnRetry(t *testing.T) {
	t.Parallel()
	...
	resp, err := doer.Post(
		"http://localhost/test", "application/json", strings.NewReader(body),
	)
	if err != nil {
		t.Fatalf("expected no error, got: %v", err)
	}
