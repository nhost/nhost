  ...
  useEffect(() => {
    ...
    const fetchAuthRequest = async () => {
      try {
        ...
        setError(
          fetchErr.message || 'Failed to load authorization request.',
        );
      } finally {
        setIsFetching(false);
      }
    ...
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="glass-card w-full p-8 mb-6">
        ...
        <p className="text-muted mb-6">
          <strong>{authRequest.clientName}</strong> is requesting access to your
          account.
        </p>
        ...
        <div className="client-info mb-6">
          <div className="mb-3">
            ...
            <p className="font-medium">{authRequest.clientName}</p>
          </div>
          <div className="mb-3">
