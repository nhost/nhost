  ...
  return (
    <div className="flex flex-row items-center justify-center w-screen min-h-screen bg-gray-100">
      <div className="flex flex-col items-center justify-center w-full max-w-md p-8 bg-white rounded-md shadow">
        <h1 className="mb-8 text-3xl">Sign in with a Magic Link</h1>
      ...
      >
        <DialogContent>
          ...
          <p>
            ...
            follow the link to complete authentication. This page will
            automatically redirect you to the authenticated home page once the
