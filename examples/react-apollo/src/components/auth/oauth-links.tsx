import { SiApple, SiGithub, SiGoogle, SiLinkedin, SiSpotify, SiTwitch } from '@icons-pack/react-simple-icons'
...
export default function OAuthLinks() {
  const { github, apple, google, linkedin, spotify, twitch } = useProviderLink({
