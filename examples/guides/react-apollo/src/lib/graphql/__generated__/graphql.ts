...
export const GetNinjaTurtlesWithCommentsDocument = gql`
...
/**
 * __useGetNinjaTurtlesWithCommentsQuery__
 *
 * To run a query within a React component, call `useGetNinjaTurtlesWithCommentsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetNinjaTurtlesWithCommentsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetNinjaTurtlesWithCommentsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetNinjaTurtlesWithCommentsQuery(
...
export function useGetNinjaTurtlesWithCommentsLazyQuery(
...
export type GetNinjaTurtlesWithCommentsQueryHookResult = ReturnType<
  typeof useGetNinjaTurtlesWithCommentsQuery
>;
export type GetNinjaTurtlesWithCommentsLazyQueryHookResult = ReturnType<
  typeof useGetNinjaTurtlesWithCommentsLazyQuery
>;
export type GetNinjaTurtlesWithCommentsSuspenseQueryHookResult = ReturnType<
  typeof useGetNinjaTurtlesWithCommentsSuspenseQuery
>;
export type GetNinjaTurtlesWithCommentsQueryResult = Apollo.QueryResult<
  GetNinjaTurtlesWithCommentsQuery,
  GetNinjaTurtlesWithCommentsQueryVariables
>;
 ...
 *   variables: {
 *      ninjaTurtleId: // value for 'ninjaTurtleId'
