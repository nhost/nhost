...
**<span className="parameter-name">fn</span>** <span className="optional-status">required</span> [`AuthChangedFunction`](/reference/deprecated/javascript/auth/types/auth-changed-function)
