...
![Add Remote Schema](/images/products/graphql/remote-schemas-create.png)
...
![GraphQL Customizations](/images/products/graphql/remote-schemas-customizations.png)
...
![permission](/images/products/graphql/remote-schemas-settings-permissions.png)
...
![Edit Permissions menu](/images/products/graphql/remote-schemas-permissions-edit.png)
  </Step>
  <Step title="Edit permissions for a role">
    Click on the **Permission** cell for the role you want to configure.

![Permissions matrix](/images/products/graphql/remote-schemas-permissions-cell.png)
...
![Permission roles configuration](/images/products/graphql/remote-schemas-permissions-roles.png)
  </Step>
