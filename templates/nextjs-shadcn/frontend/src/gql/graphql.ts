...
export type GetProfileQuery = { user: { id: string, displayName: string, email: string | null, newEmail: string | null, emailVerified: boolean, avatarUrl: string, metadata: unknown } | null };
