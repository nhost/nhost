...
export type Files_Bool_Exp = {
  ...
  avatarOwner?: Users_Bool_Exp | null | undefined;
...
export type GetTodosQuery = { todos: Array<{ id: string, title: string, completed: boolean, location: string | null, preposition: string, is_public: boolean, sort_order: number, file_id: string | null }> };
...
export type CreateTodoMutation = { insert_todos_one: { id: string, title: string, completed: boolean, location: string | null, preposition: string, is_public: boolean, file_id: string | null } | null };
...
export type GetSharedListQuery = { user: { id: string, displayName: string, todos: Array<{ id: string, title: string, completed: boolean, location: string | null, preposition: string, sort_order: number, file_id: string | null }> } | null };
