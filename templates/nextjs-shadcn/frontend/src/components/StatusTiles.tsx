...
/**
 * Live state of the three things the starter wires up.
 *
 * Shared by every page that shows it, so the answers cannot drift between
 * them: each render re-checks the backend, the session and the data.
 */
    ...
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      ...
      >
        {hasTypedData ? (
          ...
          <>
            A per-user <code>todos</code> table with a typed query and mutation
            is already wired up.
          </>
        )}
      </StatusTile>
