...
const useSignUpEmailPassword: (
  options?: Options
) => [(email: string, password: string) => Promise<Omit<State, 'isLoading'>>, State]
```

| Name                           | Type                                                          | Notes                                                                                                                                                                                                             |
| ------------------------------ | ------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `State.isLoading`              | boolean                                                       | Returns `true` when the action is executing, `false` when it finished its execution.                                                                                                                              |
| `State.needsEmailVerification` | boolean                                                       | Returns `true` if the sign-up has been accepted, but a verificaiton email has been sent and is awaiting.                                                                                                          |
| `State.isSuccess`              | boolean                                                       | Returns `true` if the sign-up suceeded. Returns `false` if the new email needs to be verified first, or if an error occurred.                                                                                     |
| `State.isError`                | boolean                                                       | Returns `true` if an error occurred.                                                                                                                                                                              |
| `State.error`                  | {status: number, error: string, message: string} \| undefined | Provides details about the error.                                                                                                                                                                                 |
