...
**Each organization will have a single subscription regardless of the number of projects in it**. The subscription will be tied to a plan which will determine some of its features and usage included in it and each project in the organzation will inherit the plan in the organization.
...
Unless indicated otherwise, every resouce you use will be counte towards the sama aggregate by counting the exact usage you incur.
...
By default projects are provisioned with 1GB of volume capacity for postgres. Hoever, most plans have an free allowance of at least 10GB. If you have multiple projects you can share this allowance between them or you can choose to increase some of your projects. If you exceed the free allowance you will be charged for the additional volume capacity.
...
Each failed attempt to pay an invoice will send an email to the billing contact with instructions on how to pay the invoice. In addition, any organizaion's state change will send another email to all members of the organization.
