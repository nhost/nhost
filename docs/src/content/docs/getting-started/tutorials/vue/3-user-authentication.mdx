...
description: Add sign up, sign in, sign out, and email verification to your Vue app with Nhost Auth and reactive composables for session state.
keywords: ["Vue", "user authentication", "sign up", "sign in", "email verification", "password authentication"]
head:
  - tag: title
    content: "Add Sign Up and Sign In to Vue | Nhost Docs"
sidebar:
