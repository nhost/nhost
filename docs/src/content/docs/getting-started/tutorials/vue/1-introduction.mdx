---
title: Create Your Nhost Project for Vue
description: Create and configure a new Nhost project as the backend for your Vue app, with PostgreSQL, GraphQL, auth, and storage ready to use.
keywords: ["Vue", "Nhost tutorial", "project setup", "backend configuration", "full-stack development"]
head:
  - tag: title
    content: "Vue Full-Stack Tutorial: Project Setup | Nhost Docs"
sidebar:
