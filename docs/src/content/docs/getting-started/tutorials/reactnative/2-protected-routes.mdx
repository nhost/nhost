...
description: >-
  Learn how to protect screens and content in a React Native application using
  Nhost authentication.
keywords: ["React Native", "protected screens", "authentication", "Expo Router", "session management", "navigation guards"]
head:
  - tag: title
    content: "Secure Expo Router Screens with Auth | Nhost Docs"
sidebar:
  label: Protecting Screens
---
...
```json title="app.json" showLineNumbers {29-32}
{
  "expo": {
...
```tsx title="app/lib/nhost/AsyncStorage.tsx" showLineNumbers
import {
  DEFAULT_SESSION_KEY,
...
```tsx title="app/lib/nhost/AuthProvider.tsx" showLineNumbers
...
<TabItem label="app/styles/theme.ts">

Create the theme constants file:

```tsx title="app/styles/theme.ts" showLineNumbers
/**
...
<TabItem label="app/styles/commonStyles.ts">

Create the common styles file:

```tsx title="app/styles/commonStyles.ts" showLineNumbers
...
```tsx title="app/components/ProtectedScreen.tsx" showLineNumbers
...
```tsx title="app/profile.tsx" showLineNumbers
...
```tsx title="app/index.tsx" showLineNumbers
...
```tsx title="app/_layout.tsx" showLineNumbers
...
<details>
<summary>Screen Protection</summary>
...
<details>
<summary>Cross-device Synchronization</summary>
