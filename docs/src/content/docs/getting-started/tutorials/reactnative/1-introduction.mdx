---
title: Create Your Nhost Project for React Native
description: Create and configure a new Nhost project as the backend for your React Native mobile app, with PostgreSQL, GraphQL, auth, and storage.
keywords: ["React Native", "Nhost tutorial", "project setup", "mobile development", "full-stack development"]
head:
  - tag: title
    content: "React Native Mobile App Tutorial: Project Setup | Nhost Docs"
sidebar:
