...
description: Run GraphQL queries and mutations and set database permissions while building a complete todos app with Nhost and React Native.
keywords: ["React Native", "GraphQL", "CRUD operations", "permissions", "todos app", "mobile app"]
head:
  - tag: title
    content: "Query and Mutate Data with GraphQL on Mobile | Nhost Docs"
sidebar:
...
```tsx title="app/todos.tsx" showLineNumbers
...
```tsx title="app/index.tsx" showLineNumbers {44-49}
...
<details>
<summary>Native Mobile Interface</summary>
