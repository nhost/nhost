...
description: "Add file uploads to your React Native app with Nhost Storage: configure buckets and permissions and build a file management system."
keywords: ["React Native", "file uploads", "storage buckets", "file management", "mobile storage", "Nhost storage"]
head:
  - tag: title
    content: "Manage File Storage and Uploads on Mobile | Nhost Docs"
sidebar:
  label: File Uploads
---
...
```tsx title="app/files.tsx" showLineNumbers
...
```tsx title="app/index.tsx" showLineNumbers {51-56}
...
<details>
<summary>Personal Storage Bucket</summary>
...
<details>
<summary>Native File Upload Interface</summary>
...
<details>
<summary>Mobile File Management</summary>
...
<details>
<summary>Native File Handling</summary>
...
<details>
<summary>Error Handling & UX</summary>
