...
description: Create and configure a new Nhost project as the backend for your SvelteKit app, with PostgreSQL, GraphQL, auth, and storage ready to use.
keywords: ["SvelteKit", "Nhost tutorial", "project setup", "backend configuration", "full-stack development"]
head:
  - tag: title
    content: "SvelteKit Full-Stack Tutorial | Nhost Docs"
sidebar:
