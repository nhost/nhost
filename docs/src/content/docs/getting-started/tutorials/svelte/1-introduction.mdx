---
title: Getting Started with SvelteKit and Nhost
description: >-
  Build a full-stack SvelteKit app with authentication, GraphQL APIs, and file
  uploads using Nhost. Step-by-step tutorial series starting with project setup.
keywords: ["SvelteKit", "Nhost tutorial", "project setup", "backend configuration", "full-stack development"]
head:
  - tag: title
    content: "SvelteKit Full-Stack Tutorial | Nhost Documentation"
sidebar:
