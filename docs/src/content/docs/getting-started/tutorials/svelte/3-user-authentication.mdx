...
description: Add sign up, sign in, and email verification to your SvelteKit app using Nhost Auth and reactive Svelte stores for session state.
keywords: ["SvelteKit", "user authentication", "sign up", "sign in", "email verification", "password authentication"]
head:
  - tag: title
    content: "Add Sign Up and Sign In to SvelteKit | Nhost Docs"
sidebar:
