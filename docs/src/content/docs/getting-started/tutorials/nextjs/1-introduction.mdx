---
title: Create Your Nhost Project for Next.js
description: Create and configure a new Nhost project as the backend for your Next.js app, with PostgreSQL, GraphQL, auth, and storage ready to use.
keywords: ["Next.js", "Nhost tutorial", "project setup", "backend configuration", "full-stack development"]
head:
  - tag: title
    content: "Next.js Full-Stack Tutorial: Project Setup | Nhost Docs"
sidebar:
