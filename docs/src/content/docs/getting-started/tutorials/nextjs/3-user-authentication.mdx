...
description: Add sign up, sign in, and email verification to your Next.js App Router app using Nhost Auth and session-aware server components.
keywords: ["Next.js", "user authentication", "sign up", "sign in", "email verification", "App Router"]
head:
  - tag: title
    content: "Add Sign Up and Sign In to Next.js | Nhost Docs"
sidebar:
...
```tsx title="src/app/signin/page.tsx" showLineNumbers
...
```tsx title="src/app/signin/SignInForm.tsx" showLineNumbers
"use client";
...
```tsx title="src/app/signin/actions.ts" showLineNumbers
"use server";
...
```tsx title="src/app/signup/page.tsx" showLineNumbers
import Link from "next/link";
...
```tsx title="src/app/signup/SignUpForm.tsx" showLineNumbers
"use client";
...
```tsx title="src/app/signup/actions.ts" showLineNumbers
"use server";
...
<Tabs>
<TabItem label="Verify Route Handler">
...
```ts title="src/app/verify/route.ts" showLineNumbers
...
```tsx title="src/app/verify/error/page.tsx" showLineNumbers
import Link from "next/link";
...
```tsx title="src/components/SignOutButton.tsx" showLineNumbers
"use client";
...
```tsx title="src/lib/nhost/actions.ts" showLineNumbers
"use server";
...
```tsx title="src/components/Navigation.tsx" showLineNumbers {3,26,30-35}
import Link from "next/link";
import { createNhostClient } from "../lib/nhost/server";
...
```tsx title="src/proxy.ts" showLineNumbers {6}
...
<details>
<summary>Server Components & Actions</summary>
...
<details>
<summary>PKCE Verification</summary>
...
<details>
<summary>Client/Server Separation</summary>
