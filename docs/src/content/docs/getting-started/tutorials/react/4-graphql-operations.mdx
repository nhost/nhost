...
description: >-
  ...
  building a complete todos application with Nhost and React
keywords: ["React", "GraphQL", "CRUD operations", "permissions", "todos app", "mutations", "queries"]
head:
  - tag: title
    content: "Query and Mutate Data with GraphQL in React | Nhost Docs"
sidebar:
...
```tsx title="src/pages/Todos.tsx" showLineNumbers
...
```tsx title="src/App.tsx" showLineNumbers {16,41}
import {
  createBrowserRouter,
...
```tsx title="src/components/Navigation.tsx" showLineNumbers {36-38}
