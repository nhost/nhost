---
title: Create Your Nhost Project for React
description: Create and configure a new Nhost project as the backend for your React app, with PostgreSQL, GraphQL, auth, and storage ready to use.
keywords: ["React", "Nhost tutorial", "project setup", "backend configuration", "full-stack development"]
head:
  - tag: title
    content: "React Full-Stack Tutorial: Project Setup | Nhost Docs"
sidebar:
