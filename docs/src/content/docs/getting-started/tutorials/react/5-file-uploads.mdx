...
description: "Add file uploads to your React app with Nhost Storage: configure buckets and permissions and build a full file management system."
keywords: ["React", "file uploads", "storage buckets", "file management", "storage permissions", "Nhost storage"]
head:
  - tag: title
    content: "Manage File Storage and Uploads in React | Nhost Docs"
sidebar:
  label: File Uploads
---
...
```tsx title="src/pages/Files.tsx" showLineNumbers
...
```tsx title="src/App.tsx" showLineNumbers {12,43}
import {
  createBrowserRouter,
...
```tsx title="src/components/Navigation.tsx" showLineNumbers {39-41}
