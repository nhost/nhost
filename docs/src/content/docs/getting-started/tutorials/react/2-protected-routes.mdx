...
description: >-
  Learn how to protect routes and content in a React application using Nhost
  authentication.
keywords: ["React", "protected routes", "authentication", "React Router", "session management", "route guards"]
head:
  - tag: title
    content: "Secure React Router Pages with Auth | Nhost Docs"
sidebar:
...
- An [Nhost project](/getting-started/tutorials/react/1-introduction) set up
...
```tsx title="src/lib/nhost/AuthProvider.tsx" showLineNumbers
...
```tsx title="src/pages/Profile.tsx" showLineNumbers
import { useAuth } from "../lib/nhost/AuthProvider";
