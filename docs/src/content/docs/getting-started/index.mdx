...
## Choose how you develop

Run the whole stack on your machine with the CLI, or work straight against a project on Nhost Cloud with nothing installed. Either way, an AI assistant can connect to your backend over MCP.
...
<CardGroup cols={3}>
  ...
  >
    Run PostgreSQL, GraphQL, Auth, and Storage locally with Docker
  </Card>
  <Card
    title="Without the CLI"
    icon="cloud"
    href="/getting-started/cloud-development/dashboard"
  >
    Build on Nhost Cloud from the dashboard, no Docker required
  </Card>
  <Card
    title="Agentic Workflows"
    icon="robot"
    href="/getting-started/agentic-workflows"
  >
    Connect an AI assistant to your backend over MCP
  </Card>
</CardGroup>
