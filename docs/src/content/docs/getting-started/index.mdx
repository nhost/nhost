...
<CardGroup cols={2}>
  ...
  <Card
    title="Yew (Rust)"
    icon="code"
    href="/getting-started/quickstart/yew"
  >
    Learn how to connect Nhost with Rust and Yew
  </Card>
  <Card
    title="Go"
    icon="seti:go"
    href="/getting-started/quickstart/go"
  >
    Learn how to connect Nhost with Go and net/http
  </Card>
  <Card
...
<CardGroup cols={2}>
  ...
  <Card
    title="Rust (CLI)"
    icon="terminal"
    href="/getting-started/tutorials/rust/1-introduction"
  >
  ...
  <Card
    title="Go (CLI)"
    icon="seti:go"
    href="/getting-started/tutorials/go/1-introduction"
  >
