---
title: What is Nhost?
description: Nhost is a backend development platform for building and scaling production-ready apps with PostgreSQL, GraphQL, auth, storage, and serverless functions.
