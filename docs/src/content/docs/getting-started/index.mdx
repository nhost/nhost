...
Start from a template with a single command, or follow one of our quick start guides for learning how to quickly setup Nhost with your framework of choice, in just a few easy steps.

<CardGroup cols={2}>
  <Card
    title="Create a Project"
    icon="rocket"
    href="/getting-started/create-a-project"
  >
    Scaffold a full-stack project from a template in one command
  </Card>
  <Card
    title="Nhost CLI"
    icon="terminal"
