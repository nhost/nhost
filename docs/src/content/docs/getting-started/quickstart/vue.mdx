...
description: "Build a Vue app with Nhost in minutes: install the SDK with Vite, run GraphQL queries, and add authentication to your frontend."
keywords: ["Vue", "quickstart", "Nhost SDK", "GraphQL", "Vite", "frontend integration"]
head:
  - tag: title
    content: "Vue Backend Quickstart Guide | Nhost Docs"
sidebar:
  label: Vue
---
...
- [Full source code](https://github.com/nhost/nhost/tree/main/examples/quickstarts/vue) on GitHub — a complete example configured for a local Nhost project
