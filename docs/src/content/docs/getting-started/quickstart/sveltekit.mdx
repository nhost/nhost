...
description: "Build a SvelteKit app with Nhost in minutes: install the SDK with Vite, run GraphQL queries, and add authentication to your frontend."
keywords: ["SvelteKit", "Svelte", "quickstart", "Nhost SDK", "GraphQL", "Vite"]
head:
  - tag: title
    content: "SvelteKit Backend Quickstart Guide | Nhost Docs"
sidebar:
  label: Svelte
---
...
- [Full source code](https://github.com/nhost/nhost/tree/main/examples/quickstarts/svelte) on GitHub — a complete example configured for a local Nhost project
