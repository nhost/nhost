---
title: assistant (Deprecated)
description: GraphQL query to fetch a single Nhost Graphite AI assistant by its assistantID, including model, instructions, and tools.
head:
  - tag: title
    content: "assistant Query — Fetch a Single AI Assistant | Nhost Docs"
---
