---
title: assistants (Deprecated)
description: GraphQL query to list all AI assistants in your Nhost Graphite project, with their model, instructions, and tools.
head:
  - tag: title
    content: "assistants Query — List All AI Assistants | Nhost Docs"
---
