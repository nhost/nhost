---
title: sendMessage (Deprecated)
description: GraphQL mutation to send a message to a Nhost Graphite chat session and receive the AI assistant's response.
head:
  - tag: title
    content: "sendMessage Mutation — Chat With an AI Assistant | Nhost Docs"
---
