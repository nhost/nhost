---
title: updateAssistant (Deprecated)
description: GraphQL mutation to update an existing Nhost Graphite AI assistant's model, instructions, and tools by its assistantID.
head:
  - tag: title
    content: "updateAssistant Mutation — Modify an AI Assistant | Nhost Docs"
---
