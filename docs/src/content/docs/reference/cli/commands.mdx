...
Create a new Nhost project from a template.

| | |
| --- | --- |
| `--name=""` | Project name, and the directory it lands in (default: the target directory's name). |
...
| `--functions-version=""` | Functions version to use. Default: `"2.3.0"`. Env: `$NHOST_FUNCTIONS_VERSION`. |
