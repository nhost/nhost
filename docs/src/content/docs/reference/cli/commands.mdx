...
description: Complete reference for the Nhost CLI — commands for local development, project management, deployments, secrets, and more.
icon: terminal
---
...
**--dashboard-version**="": Dashboard version to use (default: "nhost/dashboard:2.50.0") [$NHOST_DASHBOARD_VERSION]
