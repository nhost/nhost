...
sidebar:
  label: useSignInSmsPasswordless()
---
...
**<span className="parameter-name">stateOptions</span>** <span className="optional-status">optional</span> <code>NestedRefOfValue&lt;undefined &#124; PasswordlessOptions&gt;</code>
