...
**<span className="parameter-name">params</span>** <span className="optional-status">required</span> [`NhostReactClientConstructorParams`](/reference/deprecated/react/types/nhost-react-client-constructor-params)
...
| <span className="parameter-name"><span className="light-grey">params.</span>clientStorage</span>       | <code>ClientStorage</code>     |          | Object where the refresh token will be persisted and read locally.                                                                       |
| <span className="parameter-name"><span className="light-grey">params.</span>clientStorageType</span>   | <code>ClientStorageType</code> |          | Define a way to get information about the refresh token and its exipration date.                                                         |
