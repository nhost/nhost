...
sidebar:
  label: NhostClientConstructorParams
---
...
**<span className="parameter-name">clientStorageType</span>** <span className="optional-status">optional</span> [`ClientStorageType`](/reference/deprecated/javascript/nhost-js/types/client-storage-type)
...
**<span className="parameter-name">clientStorage</span>** <span className="optional-status">optional</span> [`ClientStorage`](/reference/deprecated/javascript/nhost-js/types/client-storage)
