...
**<span className="parameter-name">options</span>** <span className="optional-status">optional</span> [`EmailOTPOptions`](/reference/deprecated/javascript/auth/types/email-otp-options)
