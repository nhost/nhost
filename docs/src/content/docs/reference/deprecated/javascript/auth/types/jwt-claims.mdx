...
**<span className="parameter-name">https://hasura.io/jwt/claims</span>** <span className="optional-status">required</span> [`JWTHasuraClaims`](/reference/deprecated/javascript/auth/types/jwt-hasura-claims)
