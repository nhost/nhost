...
sidebar:
  label: AddSecurityKeyHandlerResult
---
...
**<span className="parameter-name">key</span>** <span className="optional-status">optional</span> [`SecurityKey`](/reference/deprecated/javascript/auth/types/security-key)
