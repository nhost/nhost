...
**<span className="parameter-name">params</span>** <span className="optional-status">required</span> [`SignInIdTokenParams`](/reference/deprecated/javascript/auth/types/sign-in-id-token-params)

| Property                                                                                    | Type                                                    | Required | Notes |
| :------------------------------------------------------------------------------------------ | :------------------------------------------------------ | :------: | :---- |
| <span className="parameter-name"><span className="light-grey">params.</span>idToken</span>  | <code>string</code>                                     |    ✔️    |       |
| <span className="parameter-name"><span className="light-grey">params.</span>provider</span> | [`Provider`](/reference/deprecated/javascript/auth/types/provider) |    ✔️    |       |
