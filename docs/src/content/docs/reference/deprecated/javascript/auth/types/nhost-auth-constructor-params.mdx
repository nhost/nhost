...
sidebar:
  label: NhostAuthConstructorParams
---
...
**<span className="parameter-name">clientStorage</span>** <span className="optional-status">optional</span> [`ClientStorage`](/reference/deprecated/javascript/auth/types/client-storage)
...
**<span className="parameter-name">clientStorageType</span>** <span className="optional-status">optional</span> [`ClientStorageType`](/reference/deprecated/javascript/auth/types/client-storage-type)
