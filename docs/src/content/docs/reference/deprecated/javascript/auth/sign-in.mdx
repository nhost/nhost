...
**<span className="parameter-name">params</span>** <span className="optional-status">optional</span> [`SignInParams`](/reference/deprecated/javascript/auth/types/sign-in-params)
