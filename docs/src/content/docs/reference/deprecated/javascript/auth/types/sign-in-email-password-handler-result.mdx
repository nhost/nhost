...
sidebar:
  label: SignInEmailPasswordHandlerResult
---
...
**<span className="parameter-name">user</span>** <span className="optional-status">required</span> <code>null &#124; [`User`](/reference/deprecated/javascript/auth/types/user)</code>
