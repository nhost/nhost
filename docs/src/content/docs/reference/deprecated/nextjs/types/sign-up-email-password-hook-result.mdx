...
sidebar:
  label: SignUpEmailPasswordHookResult
---
...
**<span className="parameter-name">signUpEmailPassword</span>** <span className="optional-status">required</span> <code>SignUpEmailPasswordHandler</code>
