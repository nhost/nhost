...
description: Build service URLs from your project subdomain and region, and configure the Nhost SDK to connect to your Cloud project.
keywords: ["subdomain", "region", "service URLs", "cloud project", "Nhost SDK", "endpoint configuration"]
head:
  - tag: title
    content: "Build Cloud Service URLs from Subdomain and Region | Nhost Docs"
---
...
:::note
If you want to use your own domain you can head to the [custom domains documentation](/platform/cloud/custom-domains)
:::

:::note
For information on how to access your local environment check the [cli documentation](/platform/cli/subdomain)
:::
