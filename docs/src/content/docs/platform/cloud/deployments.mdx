...
head:
  - tag: title
    content: "Automate Deployments with Git Push Integration | Nhost Docs"
---

By connecting your Nhost project to GitHub, you can deploy your database migrations, GraphQL metadata, Run services, and serverless functions — either automatically on every push or manually via the CLI or GitHub Actions.
