---
title: Metrics
description: Monitor response times, resource usage, and error rates through a managed Grafana instance with pre-built dashboards for your services.
keywords: ["metrics", "Grafana", "monitoring", "observability", "alerting", "performance dashboards"]
head:
  - tag: title
    content: "Monitor Performance with Managed Grafana Dashboards | Nhost Docs"
---
...
:::tip
Read more about [compute resources](/platform/cloud/compute-resources) and [service replicas](/platform/cloud/service-replicas)
:::
...
<TabItem label="Config">
To configure them include one or more sections in your configuration file:
