---
title: Secrets
description: Securely store API keys, passwords, and credentials as encrypted secrets, set in both local and Nhost Cloud environments.
keywords: ["secrets", "sensitive data", "API keys", "credentials", "secure storage", "encrypted", "passwords"]
head:
  - tag: title
    content: "Securely Store API Keys and Credentials | Nhost Docs"
---
...
### Nhost Cloud
  ...
  ![Secrets](/images/platform/secrets/secrets.png)


## Reference Secrets


```toml title="nhost/nhost.toml"
