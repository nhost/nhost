...
description: Run multiple replicas of the GraphQL, Auth, Storage, and Run services to load-balance traffic for high availability and fault tolerance.
keywords: ["service replicas", "autoscaler", "high availability", "fault tolerance", "load balancing", "horizontal scaling"]
head:
  - tag: title
    content: "Scale Backend Services for High Availability | Nhost Docs"
---
...
:::note
Replicas can be set for GraphQL, Auth, Storage, and Run Services, Postgres support is coming next
:::
