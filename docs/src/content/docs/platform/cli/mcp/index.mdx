...
This is the **CLI MCP server** — it runs on your machine (`nhost mcp start`), authenticates as **you** (admin secret or personal access token), and is meant to help **you build and manage your projects** — whether local or deployed.

If instead you want to expose your project to your **end users'** AI assistants in production — authenticating each user through Nhost Auth and enforcing their own permissions — use the [Project MCP server](/products/ai/mcp) instead.
:::
