...
You can perform as many changes as needed using overlays. For example, you can add an environment variable, enable remote schema permissions, and change the client URL.
