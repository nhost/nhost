...
This guide assumes you've already installed the CLI and have a project running locally. If you haven't, follow the [CLI Quickstart](/getting-started/quickstart/cli) to install the CLI, authenticate, run `nhost init`, and start your stack with `nhost up`.
