...
description: Run the full Nhost stack locally with Docker, including Postgres, GraphQL, Auth, Storage, Functions, and Mailhog.
...
Nhost's command-line interface (CLI) lets you run a complete Nhost development environment locally with the following services: PostgreSQL database, GraphQL, Authentication, Storage (MinIO), Serverless Functions, and Emails (Mailhog).
