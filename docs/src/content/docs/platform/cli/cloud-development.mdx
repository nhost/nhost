...
description: Develop against a cloud-hosted Nhost project with a minimal local setup, automatic migration tracking, and Git-based deployments.
keywords: ["cloud development", "remote development", "Git deployment", "migrations tracking", "Nhost CLI"]
head:
  - tag: title
    content: "Develop Against a Remote Nhost Cloud Project | Nhost Docs"
---
...
If you'd rather not run the CLI at all, see [Get up and running without the CLI](/getting-started/cloud-development/dashboard), which works entirely from the dashboard. To connect an AI assistant to a cloud project, see [Cloud Setup](/platform/cli/mcp/cloud-setup).
...
3. **Enable database public access**:
   ...
   ![public access](/images/platform/cli/cloud-development/public-access.png)
   - Enable **Public Access**
   - Click **Save**

4. **Configure database password**:
   - In the same Database settings section, locate **Reset Password**
   ![reset password](/images/platform/cli/cloud-development/reset-password.png)
...
- **Console**: [https://local.hasura.local.nhost.run](https://local.hasura.local.nhost.run)
