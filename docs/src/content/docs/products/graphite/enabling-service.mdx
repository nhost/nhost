---
title: Enabling Graphite (Deprecated)
description: Historical setup instructions for the deprecated Graphite service.
keywords: ["Graphite", "AI service", "OpenAI", "API key", "enable AI", "configuration", "setup"]
head:
  - tag: title
    content: "How to Enable the Graphite AI Service | Nhost Docs"
---
import { Tabs, TabItem } from '@astrojs/starlight/components';

:::caution[Deprecated]
Graphite is deprecated and has been superseded by [Nhost AI](/products/ai). Do not enable Graphite
for a new integration. These instructions are retained only for existing deployments.
:::

The historical Graphite setup used the following steps:
