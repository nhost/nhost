...
keywords: ["JWT", "custom tokens", "user impersonation", "serverless functions", "access tokens", "custom claims"]
head:
  - tag: title
    content: "Generate Custom JWT Tokens in Functions | Nhost Docs"
---
...
```ts title="./functions/custom-jwt.ts"
