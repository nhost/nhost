...
description: Choose a Node.js runtime for serverless functions and manage dependencies with npm, yarn, or pnpm via nhost.toml.
keywords: ["Node.js", "runtime", "npm", "yarn", "pnpm", "package manager", "dependencies"]
head:
  - tag: title
    content: "Node.js Versions & Package Managers for Functions | Nhost Docs"
---
