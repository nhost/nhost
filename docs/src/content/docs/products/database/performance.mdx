...
[PgHero](https://github.com/ankane/pghero) is one of such tools you can use to identify and address slow queries. You can easily run pghero alongside your postgres with [Nhost Run](/products/run):
