...
description: Every Nhost project gets a dedicated PostgreSQL instance you manage from the dashboard with tables, relationships, SQL, and extensions.
keywords: ["PostgreSQL", "Postgres", "database", "SQL", "relational database", "data storage", "tables"]
head:
  - tag: title
    content: "Dedicated PostgreSQL Database for Every Project | Nhost Docs"
---
...
![Manage database](/images/products/database/dashboard-database.png)
...
<CardGroup cols={2}>
  <Card title="Configure Postgres" icon="postgres" icon="database" href="/products/database/configuring-postgres">
  Learn how to configure Nhost PostgreSQL.
  </Card>
  <Card title="Extensions" icon="grid" href="/products/database/extensions">
