...
description: Configure the Hasura GraphQL Engine through nhost.toml — JWT secrets, CORS, live queries, and other engine settings.
keywords: ["Hasura", "GraphQL", "configuration", "nhost.toml", "JWT secrets", "CORS", "live queries"]
head:
  - tag: title
    content: "Hasura GraphQL Engine Settings Reference | Nhost Docs"
---
