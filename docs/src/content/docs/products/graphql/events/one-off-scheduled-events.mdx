...
![Create One-Off Scheduled Event](/images/graphql/events/scheduled-event-create.png)
</TabItem>
</Tabs>
...
```json
{
  ...
  "payload": {
    ...
    "message": "The platform will undergo maintenance at 3:00 PM UTC.",
    "type": "announcement"
  },
...
The **Events** > **One-Off Scheduled Events** page lists all one-off events. Filter by status using the buttons at the top: **All**, **Scheduled**, **Pending**, **Processed**, or **Failed**.

![One-Off Scheduled Events List](/images/graphql/events/scheduled-event-list.png)
...
![One-Off Scheduled Event Invocation Details](/images/graphql/events/scheduled-event-invocation-details.png)
