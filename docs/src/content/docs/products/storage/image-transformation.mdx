...
|-----------|-------------|--------|
| `w` | Maximum width (maintains aspect ratio) | Pixels, `1` -- `8000` (e.g., `400`) |
| `h` | Maximum height (maintains aspect ratio) | Pixels, `1` -- `8000` (e.g., `300`) |
