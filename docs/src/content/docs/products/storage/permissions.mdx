---
title: Permissions
description: Control file access with Nhost permissions
...
Storage access is controlled through permissions on the `storage.files` table. The dashboard configures these automatically, but understanding the underlying mapping can help with debugging or advanced setups.
