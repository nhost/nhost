---
title: Buckets
description: Organize files into storage buckets with their own size limits, cache settings, and pre-signed URL configuration.
keywords: ["storage", "buckets", "file organization", "configuration", "file restrictions"]
head:
  - tag: title
    content: "Organize Files with Storage Buckets | Nhost Docs"
---
...
You can create buckets through the Nhost Dashboard or via a database migration.

**Via the Dashboard:**
1. Navigate to **Storage**
2. Click **New Bucket** at the top of the sidebar
3. Fill in the bucket name and any configuration settings in the drawer
4. Click **Save**
...
To edit or delete a bucket via the Dashboard:
1. Navigate to **Storage**
2. Hover over the bucket in the sidebar and click the **...** menu
3. Select **Edit Bucket** or **Delete Bucket**
