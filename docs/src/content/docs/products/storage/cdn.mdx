---
title: CDN
description: Serve stored files from a global CDN that caches at edge locations to cut response times and offload the backend.
keywords: ["CDN", "content delivery network", "caching", "fast", "performance", "edge", "global distribution", "Fastly"]
head:
  - tag: title
    content: "Serve Stored Files from a Global CDN | Nhost Docs"
---
