...
description: Add user authentication to your app with Nhost Auth, including sign-in, sessions, JWT access tokens, and refresh tokens.
keywords: ["authentication", "auth", "login", "sign in", "sign up", "user management", "identity"]
head:
  - tag: title
    content: "User Authentication Service for Your App | Nhost Docs"
---
import { Card, CardGroup } from '@components';


Nhost Auth is a ready-to-use authentication service seamlessly integrated with the [GraphQL API](/products/graphql) and its [Permission System](/products/graphql/permissions). This allows you to easily add user authentication to your application without having to build and maintain your own authentication system.
