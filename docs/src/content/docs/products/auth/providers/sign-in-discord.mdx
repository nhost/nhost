...
description: Enable Discord OAuth social login with Nhost Auth — create a Discord application, set redirect URLs, and sign in users.
keywords: ["Discord", "OAuth", "social login", "Discord sign-in", "authentication provider", "gaming"]
head:
  - tag: title
    content: "Discord OAuth Authentication Setup | Nhost Docs"
---
