...
description: Configure Microsoft Entra ID OAuth with Nhost Auth for enterprise SSO and Azure Active Directory social login.
keywords: ["Entra ID", "Microsoft", "Azure", "OAuth", "enterprise SSO", "authentication provider", "Active Directory"]
head:
  - tag: title
    content: "Microsoft Entra ID OAuth Setup | Nhost Docs"
---
