...
description: Add Facebook (Meta) OAuth social login with Nhost Auth — create a Facebook app, configure OAuth, and sign in users.
keywords: ["Facebook", "OAuth", "social login", "Facebook sign-in", "Meta", "authentication provider"]
head:
  - tag: title
    content: "Facebook OAuth Authentication Setup | Nhost Docs"
---
...
<p align="center">
  <img
    ...
    src="/images/auth/facebook-signin.svg"
    width={480}
    height={267}
  />
</p>
