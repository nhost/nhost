...
description: Configure Azure AD (Active Directory) OAuth with Nhost Auth for enterprise SSO and Microsoft account social login.
keywords: ["Azure AD", "Microsoft", "OAuth", "enterprise SSO", "authentication provider", "Active Directory", "deprecated"]
head:
  - tag: title
    content: "Azure Active Directory OAuth Setup | Nhost Docs"
---

:::caution
Deprecated: Use [Entra ID](/products/auth/providers/sign-in-entraid) instead
:::
