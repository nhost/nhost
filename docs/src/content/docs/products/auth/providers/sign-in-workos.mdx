...
description: Configure WorkOS with Nhost Auth for enterprise SSO and SAML — connect WorkOS OAuth and sign in organization users.
keywords: ["WorkOS", "OAuth", "enterprise SSO", "SAML", "authentication provider", "single sign-on"]
head:
  - tag: title
    content: "WorkOS Enterprise SSO Setup | Nhost Docs"
---
...
<p align="center">
  <img
    ...
    src="/images/auth/workos-signin.svg"
    width={480}
    height={267}
  />
</p>
