...
description: Add Bitbucket OAuth social login to your app with Nhost Auth — create an OAuth consumer and sign in Atlassian users.
keywords: ["Bitbucket", "OAuth", "social login", "Bitbucket sign-in", "Atlassian", "authentication provider"]
head:
  - tag: title
    content: "Bitbucket OAuth Authentication Setup | Nhost Docs"
---
