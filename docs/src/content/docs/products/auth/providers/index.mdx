---
title: Social Sign-In with OAuth Providers
description: Add OAuth2 social login to your app with Nhost Auth — let users sign in with Google, GitHub, Apple, and other providers.
keywords: ["OAuth", "OAuth2", "social login", "SSO", "single sign-on", "Google login", "GitHub login", "Apple login", "third-party authentication"]
head:
  - tag: title
    content: "How OAuth2 Authentication Works | Nhost Docs"
sidebar:
  label: Overview
---
