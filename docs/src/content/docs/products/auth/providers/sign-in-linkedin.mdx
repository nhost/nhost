...
description: Add LinkedIn OAuth and OpenID Connect social login with Nhost Auth — create an app, configure scopes, and sign in users.
keywords: ["LinkedIn", "OAuth", "social login", "LinkedIn sign-in", "OpenID Connect", "authentication provider"]
head:
  - tag: title
    content: "LinkedIn OAuth Authentication Setup | Nhost Docs"
---
...
<p align="center">
  <img
    ...
    src="/images/auth/linkedin-signin.svg"
    width={480}
    height={267}
  />
</p>
