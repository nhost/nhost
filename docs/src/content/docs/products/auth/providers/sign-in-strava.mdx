...
description: Add Strava OAuth social login with Nhost Auth — register an API application, configure access, and sign in athletes.
keywords: ["Strava", "OAuth", "social login", "Strava sign-in", "authentication provider", "fitness API"]
head:
  - tag: title
    content: "Strava OAuth Authentication Setup | Nhost Docs"
---
