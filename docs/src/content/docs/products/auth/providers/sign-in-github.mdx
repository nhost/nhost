...
description: Enable GitHub sign-in with Nhost Auth — register an OAuth app, set redirect URLs, and let users log in with GitHub.
keywords: ["GitHub", "GitHub login", "GitHub OAuth", "social login", "GitHub sign in", "developer login"]
head:
  - tag: title
    content: "GitHub OAuth Authentication Setup | Nhost Docs"
---
