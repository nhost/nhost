...
head:
  - tag: title
    content: "Allow and Block Sign-Ups by Email or Domain | Nhost Docs"
---

## Allowed Emails and Domains

Allowed Emails and Domains are used to restrict what email addresses and domains are valid when signing up and signing in.
