...
description: Protect your auth signup, sign-in, and password reset endpoints from bots and spam with Cloudflare Turnstile CAPTCHA.
keywords: ["bot protection", "CAPTCHA", "Turnstile", "Cloudflare", "spam prevention", "security", "automated attacks"]
head:
  - tag: title
    content: "Block Bots and Spam with Cloudflare Turnstile | Nhost Docs"
---
