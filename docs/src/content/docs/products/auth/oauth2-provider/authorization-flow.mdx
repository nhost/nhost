...
:::tip
For CLI tools, IoT devices, and other input-constrained applications that cannot handle browser redirects, use the [Device Authorization Flow](/products/auth/oauth2-provider/device-flow) instead.
:::
