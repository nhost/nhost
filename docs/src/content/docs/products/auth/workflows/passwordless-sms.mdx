---
title: Passwordless Sms
description: Learn how the passwordless SMS authentication workflow works in Nhost Auth using one-time passwords sent via text message.
---
```mermaid
sequenceDiagram
	autonumber
