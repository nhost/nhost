...
description: >-
  How the Backend MCP Server authenticates AI clients with OAuth2 through Nhost Auth,
...
- [Connecting clients](/products/ai/mcp/clients) — point Claude, Cursor, and others at Backend MCP.
