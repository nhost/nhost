---
title: Graphite AI Service Overview
description: Graphite is Nhost's AI service providing auto-embeddings, vector similarity search, and AI assistants for your applications.
keywords: ["AI", "Graphite", "embeddings", "vector", "LLM", "machine learning", "artificial intelligence", "assistants", "RAG"]
head:
  - tag: title
    content: "Graphite: AI, Embeddings and Assistants for Your App | Nhost Docs"
---
...
* AI Agents
  * Provider-agnostic agents supporting Anthropic (Claude), OpenAI, and Google Gemini
  * Real-time streaming responses via Server-Sent Events (SSE)
  * Tool use with web search, web fetch, and MCP support
  * Agentic loop with autonomous multi-step tool chaining
  * Session management with full message history persistence
* Developer Assistant
...
![auto-embeddings-search](/images/products/ai/auto-embeddings-search.png)

Similarly, a GraphQL schema to search for similar objects is also provided:

![auto-embeddings-similar](/images/products/ai/auto-embeddings-similar.png)
...
![assistant-insert](/images/products/ai/assistant-insert.png)
![assistant-thread](/images/products/ai/assistant-thread.png)

## Guides

<CardGroup cols={4}>
  <Card title="Enabling Service" icon="play" href="/products/ai/enabling-service">
  </Card>
  <Card title="Local Development" icon="terminal" href="/products/ai/local-development">
  </Card>
  <Card title="Auto-Embeddings" icon="sparkles" href="/products/ai/auto-embeddings">
  </Card>
  <Card title="Assistants" icon="robot" href="/products/ai/assistants">
  </Card>
  <Card title="Agents" icon="cpu" href="/products/ai/agents">
  </Card>
  <Card title="Developer Assistant" icon="code" href="/products/ai/dev-assistant">
  </Card>
</CardGroup>
