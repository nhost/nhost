...
<CardGroup cols={4}>
  ...
  <Card title="Webhook Payloads" href="/products/events/guides/webhook-payloads">
    Payload structure reference for each event type
  </Card>
  <Card title="Retry Configuration" href="/products/events/guides/retry-configuration">
