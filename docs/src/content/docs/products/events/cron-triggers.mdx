...
head:
  - tag: title
    content: "Scheduling Recurring Webhooks with Cron Triggers | Nhost Docs"
sidebar:
  label: Cron Triggers
---
...
| **Request Options** (accordion)            | Reshape the request with [Kriti templates](/reference/kriti) (see [Transformations](/products/events/transformations)) |
