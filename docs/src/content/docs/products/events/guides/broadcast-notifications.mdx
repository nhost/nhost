...
head:
  - tag: title
    content: "Scheduled Broadcast Notifications Tutorial | Nhost Docs"
sidebar:
  label: Broadcast Notifications (One-Off)
---

A one-off scheduled event fires at a specific date and time. The handler sends a broadcast notification to all active users. You can see this in action in the [react-demo](https://github.com/nhost/nhost/tree/main/examples/demos/react-demo) example, see [`Notifications.tsx`](https://github.com/nhost/nhost/blob/main/examples/demos/react-demo/src/pages/Notifications.tsx).
...
- [Full source code](https://github.com/nhost/nhost/blob/main/examples/demos/backend/functions/events/broadcast-notification.ts) on GitHub
