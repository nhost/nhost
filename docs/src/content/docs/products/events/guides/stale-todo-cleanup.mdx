...
head:
  - tag: title
    content: "Scheduled Cron Cleanup of Stale Records | Nhost Docs"
sidebar:
  label: Stale Todo Cleanup (Cron Trigger)
---

A cron trigger runs every 5 minutes to find incomplete todos not updated in 7+ days, marks them stale, and notifies their owners. You can see this in action in the [react-demo](https://github.com/nhost/nhost/tree/main/examples/demos/react-demo) example, see [`Todos.tsx`](https://github.com/nhost/nhost/blob/main/examples/demos/react-demo/src/pages/Todos.tsx).
...
export default async (req: Request, res: Response) => {
  ...
  // The GraphQL engine runs multiple root-level mutations in one transaction,
...
- [Full source code](https://github.com/nhost/nhost/blob/main/examples/demos/backend/functions/events/stale-todos.ts) on GitHub
