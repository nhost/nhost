...
- [React UI](https://github.com/nhost/nhost/blob/main/examples/demos/react-demo/src/pages/Communities.tsx) -- the Communities page that triggers description updates
