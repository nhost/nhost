---
title: Resources
description: Allocate CPU, memory, and persistent SSD storage for Nhost Run services, and pause services to save costs.
keywords: ["compute resources", "CPU allocation", "memory allocation", "persistent storage", "SSD volumes", "service pausing"]
head:
  - tag: title
    content: "Allocate CPU, Memory & Storage for Run | Nhost Docs"
---
