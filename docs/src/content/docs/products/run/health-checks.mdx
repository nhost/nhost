---
title: Healthchecks
description: Enable health checks for Nhost Run services with a /healthz probe to auto-restart unhealthy containers.
keywords: ["health checks", "service monitoring", "liveness probe", "container health", "automatic restart"]
head:
  - tag: title
    content: "Monitor Run Container Health with Probes | Nhost Docs"
---
