...
description: Automate Nhost Run deployments from any CI with the Nhost CLI, docker buildx, and PAT authentication.
keywords: ["CI/CD", "CLI deployment", "GitHub Actions", "automated deployment", "container deployment", "PAT authentication"]
head:
  - tag: title
    content: "Automate Nhost Run Deployments from CI | Nhost Docs"
---
