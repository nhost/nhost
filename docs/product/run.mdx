...
<CardGroup cols={4}>
  <Card title="Getting Started" icon="square-1" href="../guides/run/getting-started">
  </Card>
  <Card title="Configuration" icon="square-2" href="../guides/run/configuration">
  </Card>
  <Card title="Resources" icon="square-4" href="../guides/run/resources">
  </Card>
  <Card title="CLI & CI Deployments" icon="square-3" href="../guides/run/cli-deployments">
  </Card>
</CardGroup>
