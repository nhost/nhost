...
<Steps>
  ...
  <Step title="Setup Database">
    ...
    <Warning>Make sure that the option `Track this` is enabled</Warning>
  ...
  <Step title="Configure the Nhost client and fetch the list of movies">
    ...
    Create a new file, `./src/lib/nhost.js`, with the following code that creates the Nhost client.
