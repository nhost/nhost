...
<Tabs>
  <Tab title="SQL Editor">
    ...
    INSERT INTO public.todos (title) VALUES ('Call the plumber');
    INSERT INTO public.todos (title) VALUES ('Plan weekend trip');
    INSERT INTO public.todos (title, completed) VALUES ('Read a book', true);
    ```
