...
A continuation we will explain how to configure various parameters to tweak how JWTs are signed and verified. In addition we will explain how to add custom claims that can be used for authorization purposes on your application.
