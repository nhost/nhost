...
<Tabs>
  ...
  <Tab title="react">
  See [react docs](/reference/react/use-sign-in-id-token) for details
  </Tab>

  <Tab title="vue">
  See [vue docs](/reference/react/use-sign-in-id-token) for details
  </Tab>
...
<Tabs>
  ...
  <Tab title="react">
  See [react docs](/reference/react/use-link-id-token) for details
  </Tab>

  <Tab title="vue">
  See [vue docs](/reference/vue/use-link-id-token) for details
  </Tab>
