...
| Any endpoint that an attacker may try to brute-force. This includes sign-in, elevate and verify endpoints<sup>3</sup> | Client IP | 10 / hour | Configurable | 0.33.0 |
| Signup endpoints | Client IP | 5 / 5 minutes | Configurable | 0.33.0 |
