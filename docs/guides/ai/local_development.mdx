...
If you are using the Nhost CLI for local development, as of [v0.11.1](https://github.com/nhost/cli/releases/tag/v1.11.1) you can also start Graphite locally. To do so, follow the next steps:
...
And then running `nhost up` to download the updated the metadata. Afterwards you should see both database migrations and functions' metadata changes in your local project:
