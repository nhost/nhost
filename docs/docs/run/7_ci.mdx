...
Below you can find a simple script to deploy an Nhost Run service using the CLI. This script can be leveraged on any CI or environment as long as you can install the nhost CLI and have access to docker buildx.
