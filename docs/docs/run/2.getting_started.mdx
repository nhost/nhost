...
To get started with Nhost Run you will need first to create an Nhost project. Then you can click on `Run` in the sidebar:
...
Now you can visit the URL you copied before:
