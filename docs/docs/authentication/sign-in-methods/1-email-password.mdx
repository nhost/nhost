...
If **Require Verified Emails** is enabled, users automatically gets a verification email when they sign up. The user must click the verification link in the email before they can sign in. It's possible to edit the ["email-verify" email template](/authentication/email-templates).
