...
:::warning
Personal Access Tokens can only be created through Hasura Auth or the [Nhost JavaScript SDK](/reference/javascript) at the moment. We have plans to add support for PATs in the Nhost Dashboard in the future.
:::
...
Users can create multiple personal access tokens. Each token can be given a name to make it easier to manage them in the future.
