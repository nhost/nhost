...
:::info
Personal Access Tokens can only be created through Hasura Auth or the [Nhost JavaScript SDK](/reference/javascript) at the moment. We have plans to add support for personal access tokens in the Nhost Dashboard in the future.
:::
