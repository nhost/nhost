...
**<span className="parameter-name">params</span>** <span className="optional-status">required</span> [`ChangePasswordParams`](/reference/__docgen__/javascript/auth/types/change-password-params)
