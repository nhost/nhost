...
**<span className="parameter-name">fn</span>** <span className="optional-status">required</span> [`OnTokenChangedFunction`](/reference/__docgen__/javascript/auth/types/on-token-changed-function)
