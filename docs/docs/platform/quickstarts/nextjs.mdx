...
Finally, make sure to store your environment variables for `subdomain` and `region` in `.env.development`:
...
You find your Nhost subdomain and region for your project from [the app dashboard](https://app.nhost.io):
