...
const HomePage = () => {
  ...
  return (
    <>
      <MetaTags title="Dashboard" description="Home page" />

      <h2 className="text-3xl font-semibold">Dashboard</h2>

      <p className="mt-2 text-lg">
        {/* highlight-start */}
        Welcome, {user?.metadata?.firstName || 'stranger'} <span role="img" alt="hello">
          👋
        </span>
        {/* highlight-end */}
      </p>
      ...
      <p className="mt-4 text-gray-500">
        Edit the{' '}
        <code className="bg-blue-100 text-blue-500 px-2 py-px rounded">src/pages/Dashboard.js</code>{' '}
