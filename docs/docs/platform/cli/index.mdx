...
It's recommended to commit and push changes to Git and use the [Git integration](/platform/git) for Nhost to automatically deploy those changes live.
...
- Read our in-depth guide on [Development with the Nhost CLI](/platform/cli/development-with-the-nhost-cli)
