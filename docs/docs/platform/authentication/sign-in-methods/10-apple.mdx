...
- Click on the newly created app to see **Team ID** and **Bundle ID**.

- **Bundle ID**: Copy and paste the **Bundle ID** to your Nhost OAuth settings for Apple.
...
- Fill in the Service information:
  ...
  - Description.
  - Identifier (ex. _service_.io.nhost.app or _service_.com.your-startup.app). Notice you can't use the same identifier as for the app so we recommend adding "service" at the beginning if the identifier.
  - Click **Continue** in the top right corner.
  - Click **Register** in the top right corner.
