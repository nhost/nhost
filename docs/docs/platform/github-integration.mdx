...
The GitHub Integration allows to automatically deploy your Nhost app when on push and merge to a GitHub repository that is connected to your Nhost app.
...
If your Nhost app is not in the root of your git repository you can set a custom base directory. The base directory is the directory where the `nhost` and `functions` directoris are located. In other words, the base directory is the **parent directory** of the `nhost` and `functions` directories.
