...
This package creates a Stripe GraphQL API to interact with Stripe.

The package works best when it's used alongside your existing GraphQL API to connect data from your database and Stripe.
