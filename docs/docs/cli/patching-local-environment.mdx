...
Keep in mind that, while it might be convenient to modify your local environment for development purposes, the more it deviates from production the harder it will become to detect issues before releasing to production. For this reason, we recommend keeping changes to the strictly necessary.
