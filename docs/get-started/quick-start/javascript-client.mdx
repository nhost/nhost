...
Nhost is framework-agnostic, and works with any type of frontend you might want to build. You can also connect to Nhost from your server-side, if you want.

In this guide, we'll keep the example simple. We're not using a fronend framework. In a real-life scenario, you'd probably build a client with a framework such as React, Vue, Svelte or React Native.
...
Create a new folder called `nhost-todos`, and initialise a new JavaScript app there:
