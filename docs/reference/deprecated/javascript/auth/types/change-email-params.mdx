...
**<span className="parameter-name">options</span>** <span className="optional-status">optional</span> [`RedirectOption`](/reference/deprecated/javascript/auth/types/redirect-option)
