...
**<span className="parameter-name">requestOptions</span>** <span className="optional-status">optional</span> [`RequestOptions`](/reference/javascript/auth/types/request-options)
