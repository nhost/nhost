...
**--config-file**="": Configuration file path (default: /homeless-shelter/.config/nhost/mcp-nhost.toml)
...
**--config-file**="": Path to the config file (default: /homeless-shelter/.config/nhost/mcp-nhost.toml)
