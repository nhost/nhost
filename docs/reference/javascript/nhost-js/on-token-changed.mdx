...
**<span className="parameter-name">fn</span>** <span className="optional-status">required</span> [`OnTokenChangedFunction`](/reference/javascript/nhost-js/types/on-token-changed-function)
