...
**<span className="parameter-name">params</span>** <span className="optional-status">required</span> <code>[`FileUploadConfig`](/reference/javascript/nhost-js/types/file-upload-config) &amp; [`UploadMultipleFilesActionParams`](/reference/javascript/nhost-js/types/upload-multiple-files-action-params)</code>
