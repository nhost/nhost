...
**<span className="parameter-name">params</span>** <span className="optional-status">required</span> [`StorageGetUrlParams`](/reference/javascript/nhost-js/types/storage-get-url-params)
