...
**<span className="parameter-name">params</span>** <span className="optional-status">required</span> [`StorageUploadFileParams`](/reference/javascript/nhost-js/types/storage-upload-file-params)
...
**<span className="parameter-name">params</span>** <span className="optional-status">required</span> [`StorageUploadFormDataParams`](/reference/javascript/nhost-js/types/storage-upload-form-data-params)
