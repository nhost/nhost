...
**<span className="parameter-name">params</span>** <span className="optional-status">optional</span> [`SignInParams`](/reference/javascript/nhost-js/types/sign-in-params)
