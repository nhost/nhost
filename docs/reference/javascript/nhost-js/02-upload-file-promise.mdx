...
**<span className="parameter-name">params</span>** <span className="optional-status">required</span> <code>[`FileUploadConfig`](/reference/javascript/nhost-js/types/file-upload-config) &amp; Partial&lt;StorageUploadFileParams&gt;</code>
