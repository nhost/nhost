...
```ts
const withClientDefaults: ClientConfigurationFn
```
...
```ts
const withServerDefaults: ClientConfigurationFn
```
...
```ts
function withAdminDefaults(adminSession: AdminSessionOptions): ClientConfigurationFn
```
