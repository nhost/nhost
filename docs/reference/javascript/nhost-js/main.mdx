...
```ts
optional chainFunctions: ChainFunction[];
```
...
[`NhostClientOptions`](#nhostclientoptions).[`chainFunctions`](#chainfunctions)
...
```ts
function createAdminClient(options: NhostAdminClientOptions): NhostClient
```
...
| --------- | ------------------------- | ------------------------------------------------------------------ |
| `options` | `NhostAdminClientOptions` | Configuration options for the admin client (requires adminSession) |

### Returns

[`NhostClient`](#nhostclient)

A configured Nhost client with admin privileges on storage, graphql, and functions
...
```ts
function createCustomClient(options: NhostCustomClientOptions): NhostClient
```
...
| Parameter | Type                       | Description                                                           |
| --------- | -------------------------- | --------------------------------------------------------------------- |
| `options` | `NhostCustomClientOptions` | Configuration options for the custom client (requires chainFunctions) |

### Returns

[`NhostClient`](#nhostclient)

A configured Nhost client with only your custom middleware
