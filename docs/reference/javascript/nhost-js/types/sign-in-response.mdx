...
**<span className="parameter-name">session</span>** <span className="optional-status">required</span> <code>null &#124; [`NhostSession`](/reference/javascript/nhost-js/types/nhost-session)</code>
