...
**<span className="parameter-name">options</span>** <span className="optional-status">optional</span> [`RedirectOption`](/reference/javascript/nhost-js/types/redirect-option)
