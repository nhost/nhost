...
**<span className="parameter-name">fn</span>** <span className="optional-status">required</span> [`AuthChangedFunction`](/reference/javascript/nhost-js/types/auth-changed-function)
