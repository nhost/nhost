...
icon: wand-magic
keywords: ["magic link", "passwordless", "email login", "link authentication", "no password", "email sign in"]
---
...
<Tip>It is possible to customize the email with the Magic Link, learn how to [here](/products/auth/email-templates)</Tip>
