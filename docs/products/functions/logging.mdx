...
Nhost Functions support logging through standard `console` methods in Node.js. Use `console.log()`, `console.warn()`, and `console.error()` to log messages during function execution. All logs are captured and displayed in the logging page with metadata about each invocation.
