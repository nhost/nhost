...
<Steps>
  ...
  <Step title="Setup Database">
    ...
    <Frame caption="Create Todos Table">
      <img src="/images/quickstarts/react-native/create-table-todos.png" />
    </Frame>
  ...
  <Step title="Configure the todos table permissions">
    ...
    <Frame caption="Insert Permissions">
      <img src="/images/quickstarts/react-native/todos-insert-permissions.png" />
    </Frame>
    ...
    <Frame caption="Select Permissions">
      <img src="/images/quickstarts/react-native/todos-select-permissions.png" />
    </Frame>
    ...
    <Frame caption="Update permissions">
      <img src="/images/quickstarts/react-native/todos-update-permissions.png" />
    </Frame>
    ...
    <Frame caption="Delete permissions">
      <img src="/images/quickstarts/react-native/todos-delete-permissions.png" />
    </Frame>
  </Step>
  ...
  <Step title="Configure permissions to enable user file uploads">
    ...
    <Frame caption="Insert Permissions">
      <img src="/images/quickstarts/react-native/files-insert-permissions.png" />
    </Frame>
    ...
    <Frame caption="Select permissions">
      <img src="/images/quickstarts/react-native/files-select-permissions.png" />
    </Frame>
  </Step>
