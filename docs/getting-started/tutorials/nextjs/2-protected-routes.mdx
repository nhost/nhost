...
```bash
npx create-next-app@latest nhost-nextjs-tutorial --typescript --tailwind --eslint --app
      ...
      <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6 mb-6">
        ...
        <div className="space-y-4">
          <div className="flex flex-col">
            <strong className="text-gray-700 dark:text-gray-300">Display Name:</strong>
            <span className="text-gray-900 dark:text-white">{session.user?.displayName || "Not set"}</span>
          </div>
          <div className="flex flex-col">
            <strong className="text-gray-700 dark:text-gray-300">Email:</strong>
            <span className="text-gray-900 dark:text-white">{session.user?.email || "Not available"}</span>
          </div>
          <div className="flex flex-col">
            <strong className="text-gray-700 dark:text-gray-300">User ID:</strong>
            <span className="text-gray-900 dark:text-white font-mono text-sm">{session.user?.id || "Not available"}</span>
          </div>
          <div className="flex flex-col">
            <strong className="text-gray-700 dark:text-gray-300">Roles:</strong>
            <span className="text-gray-900 dark:text-white">{session.user?.roles?.join(", ") || "None"}</span>
          </div>
          <div className="flex flex-col">
            <strong className="text-gray-700 dark:text-gray-300">Email Verified:</strong>
            <span className={`font-medium ${session.user?.emailVerified ? 'text-green-600' : 'text-red-600'}`}>
...
export default async function Home() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      <header className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Welcome to Nhost Next.js Demo</h1>
      </header>
