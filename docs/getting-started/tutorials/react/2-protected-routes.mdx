...
<Info>
This is **Part 2** in the Full-Stack React Development with Nhost series. This tutorial builds a foundation for authentication-protected routes that you can extend to secure any part of your application.
</Info>
