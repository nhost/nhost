...
sidebarTitle: "React: Protecting Routes"
icon: lock
---
...
<Steps>
<Step title="Create a New React App">
...
<Step title="Create the Nhost Auth Provider">
...
<Step title="Create the Protected Route Component">
...
<Step title="Create the Profile Page">
...
<Step title="Create a Simple Home Page">
...
<Step title="Create the Navigation Component">
...
<Step title="Update the Main App Component">
...
<Step title="Add Application Styles">
