...
Welcome to the **React Authentication Series**! In this comprehensive tutorial series, you'll build a complete React application with Nhost that demonstrates authentication, database operations, and file management.
...
<Info>
This is **Tutorial 1** in the React Authentication Series. This tutorial sets up the foundation by creating your Nhost project and understanding the series structure.
</Info>
...
**Current Tutorial** - Set up your Nhost project
</Card>
...
Take note of your project subdomain and region. You will need this information to connect your application to the Nhost backend in the upcoming tutorials.
