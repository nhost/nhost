...
sidebar:
  label: SignInEmailPasswordHookResult
---
...
**<span className="parameter-name">user</span>** <span className="optional-status">required</span> <code>null &#124; [`User`](/reference/deprecated/nextjs/types/user)</code>
