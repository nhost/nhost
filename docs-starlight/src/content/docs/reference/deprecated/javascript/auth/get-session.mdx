...
**<span className="parameter-name">context</span>** <span className="optional-status">optional</span> [`AuthContext`](/reference/deprecated/javascript/auth/types/auth-context)
...
| <span className="parameter-name"><span className="light-grey">context.</span>user</span>                | <code>[`User`](/reference/deprecated/javascript/auth/types/user) &#124; null</code>                                                |    ✔️    |                                                                                                    |
