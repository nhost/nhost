...
**<span className="parameter-name">params</span>** <span className="optional-status">required</span> [`StorageGetPresignedUrlParams`](/reference/deprecated/javascript/storage/types/storage-get-presigned-url-params)
