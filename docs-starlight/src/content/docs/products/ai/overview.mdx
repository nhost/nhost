...
<CardGroup cols={4}>
  <Card title="Enabling Service" icon="square-1" href="/products/ai/enabling-service">
  </Card>
  <Card title="Local Development" icon="square-2" href="/products/ai/local-development">
  </Card>
  <Card title="Auto-Embeddings" icon="square-3" href="/products/ai/auto-embeddings">
  </Card>
  <Card title="Assistants" icon="square-4" href="/products/ai/assistants">
  </Card>
  <Card title="Developer Assistant" icon="square-5" href="/products/ai/dev-assistant">
  </Card>
</CardGroup>
