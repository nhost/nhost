...
export type EmailTemplateQuery = { __typename?: 'query_root' } & {
  AuthEmailTemplate?: Maybe<
    { __typename?: 'authEmailTemplates' } & Pick<
      AuthEmailTemplates,
      'id' | 'title' | 'html' | 'noHtml' | 'locale'
    >
  >;
};
...
export type InsertProviderRequestMutation = { __typename?: 'mutation_root' } & {
  insertAuthProviderRequest?: Maybe<
    { __typename?: 'authProviderRequests' } & Pick<
...
export type DeleteProviderRequestMutation = { __typename?: 'mutation_root' } & {
...
export type ProviderRequestQuery = { __typename?: 'query_root' } & {
...
export type InsertRefreshTokenMutation = { __typename?: 'mutation_root' } & {
  insertAuthRefreshToken?: Maybe<
    { __typename?: 'authRefreshTokens' } & Pick<
      AuthRefreshTokens,
      'refreshToken'
    >
  >;
...
export type UpdateRefreshTokenMutation = { __typename?: 'mutation_root' } & {
  deleteAuthRefreshTokens?: Maybe<
    { __typename?: 'authRefreshTokens_mutation_response' } & Pick<
...
export type DeleteRefreshTokenMutation = { __typename?: 'mutation_root' } & {
...
export type AuthUserProvidersQuery = { __typename?: 'query_root' } & {
  authUserProviders: Array<
    { __typename?: 'authUserProviders' } & Pick<AuthUserProviders, 'id'> & {
...
export type UserProviderQuery = { __typename?: 'query_root' } & {
  authUserProviders: Array<
    { __typename?: 'authUserProviders' } & Pick<
      AuthUserProviders,
      'id' | 'refreshToken'
    >
  >;
...
export type InsertUserRolesMutation = { __typename?: 'mutation_root' } & {
  insertAuthUserRoles?: Maybe<
    { __typename?: 'authUserRoles_mutation_response' } & Pick<
...
> & {
    roles: Array<
      { __typename?: 'authUserRoles' } & Pick<AuthUserRoles, 'role'>
    >;
  };
...
export type UserQuery = { __typename?: 'query_root' } & {
  user?: Maybe<{ __typename?: 'users' } & UserFieldsFragment>;
};
...
export type GetUsersByRefreshTokenQuery = { __typename?: 'query_root' } & {
  authRefreshTokens: Array<
    { __typename?: 'authRefreshTokens' } & {
      user: { __typename?: 'users' } & UserFieldsFragment;
    }
  >;
};
...
export type UpdateUserMutation = { __typename?: 'mutation_root' } & {
  updateUser?: Maybe<{ __typename?: 'users' } & UserFieldsFragment>;
};
...
export type UpdateUserWhereMutation = { __typename?: 'mutation_root' } & {
  updateUsers?: Maybe<
...
export type RotateUsersTicketMutation = { __typename?: 'mutation_root' } & {
  updateUsers?: Maybe<
    { __typename?: 'users_mutation_response' } & Pick<
      Users_Mutation_Response,
      'affected_rows'
...
export type ActivateUsersMutation = { __typename?: 'mutation_root' } & {
  updateUsers?: Maybe<
    { __typename?: 'users_mutation_response' } & {
      returning: Array<{ __typename?: 'users' } & UserFieldsFragment>;
    }
  >;
};
...
export type ChangeEmailsByTicketMutation = { __typename?: 'mutation_root' } & {
  updateUsers?: Maybe<
    { __typename?: 'users_mutation_response' } & {
      returning: Array<{ __typename?: 'users' } & UserFieldsFragment>;
    }
...
export type InsertUserMutation = { __typename?: 'mutation_root' } & {
  insertUser?: Maybe<{ __typename?: 'users' } & UserFieldsFragment>;
};
...
export type DeleteUserMutation = { __typename?: 'mutation_root' } & {
  deleteAuthUserRoles?: Maybe<
    ...
    >
  >;
  deleteUser?: Maybe<{ __typename?: 'users' } & UserFieldsFragment>;
};
...
export type DeanonymizeUserMutation = { __typename?: 'mutation_root' } & {
  updateAuthUserRoles?: Maybe<
    ...
    >
  >;
  updateUser?: Maybe<{ __typename?: 'users' } & Pick<Users, 'id'>>;
};
...
export type GetUserByTicketQuery = { __typename?: 'query_root' } & {
  users: Array<{ __typename?: 'users' } & UserFieldsFragment>;
};
...
export type UpdateUsersByTicketMutation = { __typename?: 'mutation_root' } & {
  updateUsers?: Maybe<
    { __typename?: 'users_mutation_response' } & Pick<
      Users_Mutation_Response,
      'affected_rows'
...
export type IsWhitelistedEmailQuery = { __typename?: 'query_root' } & {
  AuthWhitelist?: Maybe<
    { __typename?: 'authWhitelist' } & Pick<AuthWhitelist, 'email'>
  >;
};
    ...
    authRefreshTokens(
      where: {
        _and: [
          ...
          {
            _or: [
              { user: { isActive: { _eq: true } } }
              {
                _and: [
                  { user: { isActive: { _eq: false } } }
...
export const ActivateUsersDocument = gql`
  mutation activateUsers(
    ...
    updateUsers(
      ...
      where: {
        _and: [{ isActive: { _eq: false } }, { ticket: { _eq: $ticket } }]
      }
    ) {
      returning {
        ...userFields
...
export const DeanonymizeUserDocument = gql`
  mutation deanonymizeUser($userId: uuid!, $avatarUrl: String, $role: String!) {
    ...
    updateUser(
      ...
      _set: { avatarUrl: $avatarUrl, defaultRole: $role, isActive: true }
    ) {
      id
    }
  }
...
export function getSdk(
  ...
  return {
    emailTemplate(
      variables: EmailTemplateQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<EmailTemplateQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<EmailTemplateQuery>(EmailTemplateDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'emailTemplate'
    ...
    updateRefreshToken(
      variables: UpdateRefreshTokenMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateRefreshTokenMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateRefreshTokenMutation>(
            UpdateRefreshTokenDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'updateRefreshToken'
    ...
    activateUsers(
      variables: ActivateUsersMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<ActivateUsersMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ActivateUsersMutation>(
    ...
    isWhitelistedEmail(
      variables: IsWhitelistedEmailQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<IsWhitelistedEmailQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<IsWhitelistedEmailQuery>(
            IsWhitelistedEmailDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'isWhitelistedEmail'
    ...
    insertWhitelistedEmail(
      variables: InsertWhitelistedEmailMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<InsertWhitelistedEmailMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<InsertWhitelistedEmailMutation>(
            InsertWhitelistedEmailDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'insertWhitelistedEmail'
