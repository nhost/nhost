...
func (r *mutationResolver) UpdateConfig(
	ctx context.Context,
	appID string,
	config model.ConfigConfigUpdateInput,
...
func (r *mutationResolver) ReplaceConfig(
	ctx context.Context,
	appID string,
	config model.ConfigConfigInsertInput,
) (*model.ConfigConfig, error) {
...
func (r *mutationResolver) InsertConfig(
	...
	appID string,
	config model.ConfigConfigInsertInput,
	systemConfig model.ConfigSystemConfigInsertInput,
	secrets []*model.ConfigEnvironmentVariableInsertInput,
...
func (r *mutationResolver) InsertSecret(
	ctx context.Context,
	appID string,
	secret model.ConfigEnvironmentVariableInsertInput,
...
func (r *mutationResolver) UpdateSystemConfig(
	ctx context.Context,
	appID string,
	systemConfig model.ConfigSystemConfigUpdateInput,
...
func (r *mutationResolver) InsertRunServiceConfig(
	ctx context.Context,
	appID string,
	config model.ConfigRunServiceConfigInsertInput,
...
func (r *mutationResolver) UpdateRunServiceConfig(
	...
	appID string,
	serviceID string,
	config model.ConfigRunServiceConfigUpdateInput,
...
func (r *queryResolver) RunServiceConfigsAll(
	ctx context.Context,
	resolve bool,
