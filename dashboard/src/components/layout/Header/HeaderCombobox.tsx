...
const headerComboboxClassName =
  'h-9 justify-start gap-2 border-0 bg-transparent px-3 py-0 font-medium text-foreground hover:bg-neutral-100 dark:hover:bg-accent';
...
const headerComboboxLinkClassName =
  'inline-flex h-9 min-w-0 items-center justify-start gap-2 overflow-hidden rounded-md border-0 bg-transparent px-3 py-0 font-medium text-foreground whitespace-nowrap transition-colors hover:bg-background hover:text-primary';
