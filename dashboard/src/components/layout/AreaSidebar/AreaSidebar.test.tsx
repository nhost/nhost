    ...
    <AreaSidebarRoot>
      <AreaSidebarNav ariaLabel="Example navigation">
        ...
        <AreaSidebarGroup label="Settings">
          <AreaSidebarLink href="/settings?tab=general" exact shallow>
            General
          </AreaSidebarLink>
          <AreaSidebarLink href="/settings?tab=advanced" exact replace shallow>
            Advanced
          </AreaSidebarLink>
          <AreaSidebarLink href="/settings?tab=restricted" exact disabled>
            Restricted
          </AreaSidebarLink>
        </AreaSidebarGroup>
      </AreaSidebarNav>
