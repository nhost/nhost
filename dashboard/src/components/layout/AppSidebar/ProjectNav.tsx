...
export default function ProjectNav() {
  ...
  // Every section stays clickable, including while the project is paused,
  // pausing, waking up or restoring. Sections whose sub-pages depend on the
  // project actually running show the paused state there instead (see
  // projectStatePages.ts).
