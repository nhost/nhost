/**
 * Decorative, animated mark built from the Nhost logo. Used on the
 * `UpgradeBanner` for Pro/Team gated pages. Ported from the Lovable design
 * exploration (see `pro-feature-banner.tsx` there) — purely visual, no
 * behavior.
 */
export function ProIllustration({ className }: { className?: string }) {
  const logo =
  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient id="pro-mark" x1="0" y1="0" x2="0" y2="1">
      ...
      <g
        ...
        opacity="0.25"
      >
        <circle cx="146" cy="80" r="52" strokeWidth="1" strokeDasharray="3 6" />
      </g>
      <g
      ...
      {/* the logo itself */}
      <g
        className="pro-illustration-logo"
        transform="translate(123.5 56) scale(1.5)"
      >
        <path d={logo} fill="url(#pro-mark)" />
      </g>

      {/* unlock badge */}
      <g className="pro-unlock-badge" transform="translate(178 122)">
        <circle cx="0" cy="0" r="17" fill="currentColor" fillOpacity="0.12" />
      ...
      <g
        ...
        opacity="0.4"
      >
        <path d="M206 34v10M201 39h10M64 112v8M60 116h8" />
      </g>
    </svg>
  );
}
