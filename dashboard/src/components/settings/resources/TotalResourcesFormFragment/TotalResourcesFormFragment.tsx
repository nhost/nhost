...
import { getAllocatedResources } from '@/features/resources/utils/getAllocatedResources';
import { prettifyMemory } from '@/features/resources/utils/prettifyMemory';
import { prettifyVCPU } from '@/features/resources/utils/prettifyVCPU';
import type { ResourceSettingsFormValues } from '@/features/resources/utils/resourceSettingsValidationSchema';
import {
  MAX_TOTAL_VCPU,
  MIN_TOTAL_VCPU,
} from '@/features/resources/utils/resourceSettingsValidationSchema';
