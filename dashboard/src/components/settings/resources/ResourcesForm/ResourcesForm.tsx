...
export default function ResourcesForm() {
  ...
  const form = useForm<ResourceSettingsFormValues>({
    values: {
      ...
      databaseVCPU: initialDatabaseResources.vcpu || 500,
      databaseMemory: initialDatabaseResources.memory || 1024,
      hasuraVCPU: initialHasuraResources.vcpu || 500,
      hasuraMemory: initialHasuraResources.memory || 1024,
      authVCPU: initialAuthResources.vcpu || 500,
      authMemory: initialAuthResources.memory || 1024,
      storageVCPU: initialStorageResources.vcpu || 500,
      storageMemory: initialStorageResources.memory || 1024,
    },
