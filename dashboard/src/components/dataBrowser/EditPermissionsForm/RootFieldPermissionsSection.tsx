...
export default function RootFieldPermissionsSection() {
  ...
  return (
    <section className="bg-white border-y-1 border-gray-200">
      ...
      >
        Root fields permissions
      </Text>

      <div className="grid grid-flow-row gap-4 items-center justify-items-stretch px-6 py-4">
        <Text variant="subtitle1">
          By enabling this you can customize the root field permissions. When
          this switch is turned off, all values are enabled by default.
        </Text>
