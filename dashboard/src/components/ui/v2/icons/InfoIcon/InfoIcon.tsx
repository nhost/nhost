...
function InfoIcon({ className, ...props }: IconProps, ref: React.ForwardedRef<SVGSVGElement>) {
  return (
    <Info aria-label="Info" width={16} height={16} className={className} ref={ref} {...props} />
  )
}
