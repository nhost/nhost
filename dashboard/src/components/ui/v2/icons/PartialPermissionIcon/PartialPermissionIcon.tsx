...
function PartialPermissionIcon({ className, ...props }: IconProps) {
  return (
    <svg
      width="20"
      height="20"
      ...
      viewBox="0 0 20 20"
      aria-label="Three horizontal lines, the one in the middle filled"
      fill="currentColor"
      className={className}
      {...props}
    >
      <path d="M5 15h10v2.5H5z" fillOpacity={0.3} />
      <path d="M5 8.75h10v2.5H5z" />
      <path d="M5 2.5h10V5H5z" fillOpacity={0.3} />
    </svg>
  )
}
