...
function AvatarRoot({
  ...
  return (
    <AvatarPrimitive.Root
      data-slot="avatar"
      className={cn(
        'relative flex h-10 w-10 shrink-0 overflow-hidden rounded-full bg-neutral-200 dark:bg-muted',
        className,
      )}
      {...props}
    />
...
function AvatarFallback({
  ...
  return (
    <AvatarPrimitive.Fallback
      ...
      className={cn(
        'flex h-full w-full items-center justify-center rounded-full bg-neutral-200 dark:bg-muted dark:text-muted-foreground',
        className,
      )}
      {...props}
    />
