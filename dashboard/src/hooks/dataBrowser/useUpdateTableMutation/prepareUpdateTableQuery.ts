import { prepareCreateColumnQuery } from '@/hooks/dataBrowser/useCreateColumnMutation';
import { prepareUpdateColumnQuery } from '@/hooks/dataBrowser/useUpdateColumnMutation';
import type {
  DatabaseColumn,
  DatabaseTable,
  ForeignKeyRelation,
