...
import { DataBrowserGridControls } from '@/features/projects/database/dataGrid/components/DataBrowserGridControls';
import { useDeleteColumnWithToastMutation } from '@/features/projects/database/dataGrid/hooks/useDeleteColumnMutation';
...
const CreateColumnForm = dynamic(
  () =>
    import(
      '@/features/projects/database/dataGrid/components/CreateColumnForm/CreateColumnForm'
    ),
...
const EditColumnForm = dynamic(
  () =>
    import(
      '@/features/projects/database/dataGrid/components/EditColumnForm/EditColumnForm'
    ),
  { ssr: false, loading: () => <FormActivityIndicator /> },
);
...
const CreateRecordForm = dynamic(
  () =>
    import(
      '@/features/projects/database/dataGrid/components/CreateRecordForm/CreateRecordForm'
    ),
  { ssr: false, loading: () => <FormActivityIndicator /> },
);
