...
import { useDeleteTableWithToastMutation } from '@/features/projects/database/dataGrid/hooks/useDeleteTableMutation';
...
const CreateTableForm = dynamic(
  () =>
    import(
      '@/features/projects/database/dataGrid/components/CreateTableForm/CreateTableForm'
    ),
  {
    ssr: false,
...
const EditTableForm = dynamic(
  () =>
    import(
      '@/features/projects/database/dataGrid/components/EditTableForm/EditTableForm'
    ),
  {
    ssr: false,
    loading: () => <FormActivityIndicator />,
...
const EditPermissionsForm = dynamic(
  () =>
    import(
      '@/features/projects/database/dataGrid/components/EditPermissionsForm/EditPermissionsForm'
    ),
  {
    ssr: false,
    loading: () => <FormActivityIndicator />,
