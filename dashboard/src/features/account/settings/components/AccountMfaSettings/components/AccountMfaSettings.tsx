...
function MFaEnabledBadge() {
  return (
    <Badge variant="outline" className="text- border-green-400 text-green-400">
      Enabled
    </Badge>
  );
}
      ...
      <div className="flex w-full flex-col items-start gap-6 p-4">
        <div className="flex w-full items-center justify-between">
          <h3 className="text-[1.125rem] font-semibold leading-[1.75]">
            <span className="mr-4">Enable multi-factor authentication </span>
            {isMfaEnabled && <MFaEnabledBadge />}
          </h3>
        </div>
      </div>
