...
it('keeps the header and sidebar visible while auth loads, but hides page content', async () => {
  render(
...
describe.each([
  ...
  ])('reserves the remaining height for content when status is $status', async ({
    status,
    banner,
  }) => {
...
describe('ProjectScope', () => {
  ...
  it('keeps a settings page error inside the settings area', async () => {
