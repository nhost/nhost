...
export interface OneOffsBrowserSidebarProps {
  className?: string;
}

function OneOffsBrowserSidebarContent() {
  const {
  ...
  if (isLoadingCronTriggers) {
    return <OneOffsBrowserSidebarSkeleton />;
  }
...
export default function OneOffsBrowserSidebar({
  className,
}: OneOffsBrowserSidebarProps) {
