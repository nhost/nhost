...
interface CronTriggerInvocationLogDetailsDialogContentProps {
  log: CronTriggerInvocationLogEntry | null;
}

export default function CronTriggerInvocationLogDetailsDialogContent({
  log,
}: CronTriggerInvocationLogDetailsDialogContentProps) {
  return (
