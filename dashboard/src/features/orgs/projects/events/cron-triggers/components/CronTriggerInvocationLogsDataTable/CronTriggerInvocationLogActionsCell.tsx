...
import CronTriggerInvocationLogDetailsDialogContent from './CronTriggerInvocationLogDetailsDialogContent';
import type { CronTriggerInvocationLogsDataTableMeta } from './types';

export default function CronTriggerInvocationLogActionsCell({
  row,
  table,
}: {
  ...
  return (
    <div className="flex items-center gap-1">
      <Dialog open={open} onOpenChange={handleOpenChange}>
        ...
        <CronTriggerInvocationLogDetailsDialogContent log={meta.selectedLog} />
      </Dialog>
    </div>
  );
}
