...
describe('acceptsBoolean', () => {
  ...
  it('false for list-of-Boolean (cannot emit bare true/false on a list arg)', () => {
    expect(caps('bools').acceptsBoolean).toBe(false);
  });
});

describe('enumValues', () => {
  it('returns enum values for Enum and Enum!', () => {
  ...
  it('returns null for list-of-enum (cannot emit bare enum value on a list arg)', () => {
...
describe('acceptsEmptyString', () => {
  it('true for string-like scalars', () => {
  ...
  it('false for Boolean / Int / Float / Enum', () => {
...
describe('acceptsSessionVariable', () => {
  it('true for built-in scalars and enums (any nullability)', () => {
  ...
  it('true for custom scalars', () => {
    expect(caps('uid').acceptsSessionVariable).toBe(true);
    expect(caps('uidRequired').acceptsSessionVariable).toBe(true);
  });

  it('false for list types (preset directive on a list cannot take a bare session-variable string)', () => {
  ...
  it('false for input-object types', () => {
