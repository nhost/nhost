...
import type { EditPermissionsFormProps } from './EditRelationshipsForm';
import EmptyRemoteSchemaRelationships from './EmptyRemoteSchemaRelationships';

export interface EditRelationshipsProps extends DialogFormProps {
  /**
...
export default function EditRemoteSchemaRelationships({
  ...
  return <BaseRemoteSchemaRelationshipForm schema={schema} />;
  ...
  // if (view === 'edit') {
  //   return <EditRelationshipsForm schema={schema} />;
  // }
