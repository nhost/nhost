...
function createLogicalModelBaseSchema(sourceOptions: string[]) {
  return z.object({
    source: z
      .string()
...
export const createLogicalModelFormSchema = (
  ...
  createLogicalModelBaseSchema(sourceOptions).superRefine((values, context) => {
...
interface TypeNodeError extends ErrorMessage {
  scalar?: ErrorMessage;
