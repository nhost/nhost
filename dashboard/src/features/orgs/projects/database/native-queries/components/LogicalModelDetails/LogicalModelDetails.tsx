      ...
      <NativeQueriesDetailsHeader
        ...
        onEdit={() =>
          openDrawer({
            ...
            component: <EditLogicalModelForm model={model} source={source} />,
          })
        }
      />
              ...
              <div className="flex flex-col items-start gap-2">
                {usedBy.map((query) => (
                  <NextLink
                    ...
                    href={`/orgs/${orgSlug}/projects/${appSubdomain}/database/native-queries/${encodeURIComponent(source)}/queries/${encodeURIComponent(query.root_field_name)}`}
...
export default function LogicalModelDetails() {
  ...
  return <LogicalModelDetailsContent source={source} />;
}
