...
describe('buildNativeQueryTrackArgs', () => {
  it('normalizes the top-level comment and preserves required identifiers', () => {
  ...
  it('preserves argument names while trimming meaningful descriptions and omitting blank ones', () => {
    expect(
