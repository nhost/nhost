...
describe('useNativeQueryMetadataMutation', () => {
  ...
  it.each(cases)(
    'executes local $type as one awaited atomic migration and invalidates the cache',
    async ({ type, variables, expectedArgs, expectedName, expectedDown }) => {
  ...
  it.each(cases)(
    'does not migrate or call success for platform metadata failure on $type',
