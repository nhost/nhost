...
export function createDataGridColumn(
  ...
  const defaultColumnConfiguration = {
    ...
    size: 250,
    meta,
    cell: (props: CellContext<UnknownDataBaseRow, string>) => (
  ...
  if (POSTGRESQL_NUMERIC_TYPES.includes(column.data_type)) {
    return {
      ...
      size: 250,
      cell: (props: CellContext<UnknownDataBaseRow, number | null>) => (
  ...
  if (column.data_type === 'boolean') {
    return {
      ...
      size: 140,
      cell: (
        props: CellContext<UnknownDataBaseRow, boolean | undefined | null>,
    ...
    openDrawer({
      ...
      component: (
        <CreateRecordForm
          ...
          columns={memoizedColumns as unknown as DataBrowserGridColumnDef[]}
          onSubmit={refetch}
