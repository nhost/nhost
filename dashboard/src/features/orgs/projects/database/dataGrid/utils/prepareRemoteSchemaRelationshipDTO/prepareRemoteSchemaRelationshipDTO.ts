...
export default function prepareRemoteSchemaRelationshipDTO(
  ...
  type RemoteSchemaDefinition = Extract<
    CreateRemoteRelationshipArgs['definition'],
    { to_remote_schema: unknown }
  >;
  const remoteField = values.remoteSchema
    .remoteField as RemoteSchemaDefinition['to_remote_schema']['remote_field'];
