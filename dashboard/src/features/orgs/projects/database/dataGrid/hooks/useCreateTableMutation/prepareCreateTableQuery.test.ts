  ...
  test('should prepare a simple query', () => {
    const table: DatabaseTable = {
      ...
      columns: [
        {
          name: 'id',
          type: { value: 'uuid', label: 'UUID', isUserDefined: false },
        },
        {
          name: 'name',
          type: { value: 'text', label: 'Text', isUserDefined: false },
        },
      ],
      primaryKey: ['id'],
    };
  ...
  test('should prepare a query with nullable columns', () => {
    const table: DatabaseTable = {
      ...
      columns: [
        ...
        {
          name: 'is_active',
          type: { value: 'bool', label: 'Boolean', isUserDefined: false },
          isNullable: true,
        },
      ],
      primaryKey: ['id'],
  ...
  test('should prepare a query with an identity column', () => {
    const table: DatabaseTable = {
      ...
      columns: [
        {
          name: 'id',
          type: { value: 'int4', label: 'Integer', isUserDefined: false },
        },
        {
          name: 'name',
          type: { value: 'text', label: 'Text', isUserDefined: false },
