    ...
    <AreaSidebarRoot>
      <AreaSidebarNav ariaLabel="Database settings navigation">
        <AreaSidebarGroup label="Engine">
          <AreaSidebarLink href={`${settingsPath}?tab=version`} shallow>
            Postgres version
          </AreaSidebarLink>
        </AreaSidebarGroup>
        <AreaSidebarGroup label="Storage">
          <AreaSidebarLink href={`${settingsPath}?tab=capacity`} shallow>
            Capacity
          </AreaSidebarLink>
          {isPlatform && (
            <AreaSidebarLink href={`${settingsPath}?tab=point-in-time`} shallow>
        ...
        {isPlatform && (
          <>
            <AreaSidebarGroup label="Connectivity">
              <AreaSidebarLink href={`${settingsPath}?tab=access`} shallow>
                Access
              </AreaSidebarLink>
              <AreaSidebarLink
