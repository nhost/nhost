...
async function acknowledgeDeletionAction(
  dialog: HTMLElement,
  user: TestUserEvent,
) {
  await user.click(
    within(dialog).getByRole('checkbox', {
      name: "I'm sure I want to delete this Organization",
    }),
  );
}
...
describe('DeleteOrg', () => {
  ...
  it('requires the exact organization name and both acknowledgments', async () => {
