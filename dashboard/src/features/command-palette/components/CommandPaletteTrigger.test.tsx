...
describe('CommandPaletteTrigger button', () => {
  it('renders the label and shortcut', () => {
    renderTrigger();

    expect(screen.getByText('Search or navigate to...')).toBeInTheDocument();
  ...
  it('opens the palette when the button is clicked', async () => {
    renderTrigger();
