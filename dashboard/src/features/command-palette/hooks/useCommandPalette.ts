...
import type { CommandPaletteProps } from '@/features/command-palette/components/CommandPalette';
...
export interface CommandPaletteController {
  ...
  paletteProps: CommandPaletteProps;
}
...
/**
 * Everything behind a command palette trigger: the dialog state, the visible
 * items for the current scope, navigation, and the ⌘K listener. Call it from
 * exactly one mounted trigger; a second caller would open a second palette.
 */
