...
const CreateTableForm = dynamic(
  () =>
    import(
      '@/features/database/dataGrid/components/CreateTableForm/CreateTableForm'
    ),
  {
    ssr: false,
...
const EditTableForm = dynamic(
  () =>
    import(
      '@/features/database/dataGrid/components/EditTableForm/EditTableForm'
    ),
  {
    ssr: false,
    loading: () => <FormActivityIndicator />,
...
const EditPermissionsForm = dynamic(
  () =>
    import(
      '@/features/database/dataGrid/components/EditPermissionsForm/EditPermissionsForm'
    ),
  {
    ssr: false,
    loading: () => <FormActivityIndicator />,
