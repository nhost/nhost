...
import { SignInWithSecurityKey } from '@/features/auth/signin/security-key/components/SignInWithSecurityKey';
import { SignInWithGithub } from '@/features/auth/signin/signin-with-github';
  ...
  return (
    <div className="grid gap-12 font-[Inter]">
      ...
      <div className="grid grid-flow-row gap-4 rounded-md border bg-transparent p-6 lg:p-12">
        ...
        <p color="secondary" className="text-center text-sm">
      ...
      <p color="secondary" className="text-center lg:text-lg">
