...
import SignUpTabs from '@/features/auth/signup/signup-tabs/SignUpTabs';
import { SignUpWithGithub } from '@/features/auth/signup/signup-with-github';
...
export default function SignUpPage() {
  return (
    <>
      ...
      <p color="secondary" className="text-center text-base lg:text-lg">
