...
function getCspHeader() {
  ...
  if (mode === 'strict') {
    ...
    return [
      ...
      "script-src 'self' 'unsafe-eval' js.stripe.com challenges.cloudflare.com cdn.segment.com googletagmanager.com",
      "img-src 'self' data: blob: github.com avatars.githubusercontent.com s.gravatar.com *.nhost.run nhost.run",
    ].join('; ');
  }
