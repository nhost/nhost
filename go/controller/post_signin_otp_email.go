...
func (ctrl *Controller) PostSigninOtpEmail( //nolint:ireturn
	ctx context.Context,
	request api.PostSigninOtpEmailRequestObject,
) (api.PostSigninOtpEmailResponseObject, error) {
	...
	return api.PostSigninOtpEmail200JSONResponse(api.OK), nil
}
