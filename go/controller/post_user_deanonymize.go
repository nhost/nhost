...
func (ctrl *Controller) PostUserDeanonymize( //nolint:funlen
	ctx context.Context, request api.PostUserDeanonymizeRequestObject,
) (api.PostUserDeanonymizeResponseObject, error) {
	...
	return api.PostUserDeanonymize200JSONResponse(api.OK), nil
}
