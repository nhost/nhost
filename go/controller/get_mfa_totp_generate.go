...
func (ctrl *Controller) GetMfaTotpGenerate( //nolint:ireturn
	ctx context.Context, _ api.GetMfaTotpGenerateRequestObject,
) (api.GetMfaTotpGenerateResponseObject, error) {
	...
	return api.GetMfaTotpGenerate200JSONResponse{
