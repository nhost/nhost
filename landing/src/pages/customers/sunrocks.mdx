...
export const customer = {
  name: 'SunRocks',
  seoTitle: 'How SunRocks Simplified Its Insurance Stack',
  seoDescription:
    'How SunRocks replaced a complex multi-provider stack with Nhost to automate insurance policies and claims for 60,000+ policyholders.',
  website: {
