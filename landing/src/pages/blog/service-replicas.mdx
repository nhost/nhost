...
export const article = {
  ...
  date: '2023-04-26',
  seoTitle: 'High Availability with Service Replicas',
  seoDescription: 'Nhost Service Replicas run multiple instances of Hasura, Auth, and Storage to improve high availability, fault tolerance, and horizontal scaling.',
  authors: [
    {
      name: 'Nuno Pato',
      title: 'CEO',
