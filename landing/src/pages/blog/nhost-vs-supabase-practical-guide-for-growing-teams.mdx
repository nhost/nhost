...
export const article = {
  ...
  image: '/images/blog/nhost-vs-supabase.svg',
  date: '2025-07-09',
  seoTitle: 'Nhost vs Supabase: A Guide for Growing Teams',
  seoDescription: 'Compare Nhost and Supabase on GraphQL, extensibility, infrastructure control, auth, federation, and AI to pick the right backend as you scale.',
  authors: [
    {
      name: 'Nuno Pato',
      title: 'CEO',
