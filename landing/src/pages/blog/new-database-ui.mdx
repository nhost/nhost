...
export const article = {
  ...
  date: '2022-09-27',
  seoTitle: 'New Nhost Database UI for Postgres and Hasura',
  seoDescription: 'Nhost\'s new Database UI lets you manage Postgres tables, columns, data, and foreign keys in the dashboard, built with MUI and TanStack.',
  authors: [
    {
      name: 'Szilárd Dóró',
      title: 'Engineering',
