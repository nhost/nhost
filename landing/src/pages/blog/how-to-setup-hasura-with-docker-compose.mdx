...
export const article = {
  ...
  date: '2022-12-09',
  seoTitle: 'How to Set Up Hasura with Docker Compose',
  seoDescription: 'A step-by-step guide to running Hasura and PostgreSQL locally with Docker Compose to build and deploy GraphQL APIs in minutes.',
  authors: [
    {
      name: 'Johan Eliasson',
      title: 'CEO',
