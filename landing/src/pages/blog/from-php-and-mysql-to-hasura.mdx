...
export const article = {
  ...
  date: '2019-09-04',
  seoTitle: 'From PHP and MySQL to Hasura: Nhost\'s Story',
  seoDescription: 'The origin story of Nhost: how a journey from PHP and MySQL through SPAs and frameworks led to building on Hasura and GraphQL.',
  authors: [
    {
      name: 'Johan Eliasson',
      title: 'CEO',
