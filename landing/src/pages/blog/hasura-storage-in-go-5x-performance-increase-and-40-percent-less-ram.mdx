...
export const article = {
  ...
  date: '2022-05-17',
  seoTitle: 'Hasura Storage in Go: 5x Faster, 40% Less RAM',
  seoDescription: 'How rewriting Hasura Storage from Node.js to Go delivered a 5x increase in requests served while halving memory consumption.',
  authors: [
    {
      name: 'David Barroso',
      title: 'Engineering',
