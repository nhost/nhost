...
export const article = {
  ...
  date: '2022-11-09',
  seoTitle: 'Configuring pnpm and Turborepo for a Monorepo',
  seoDescription: 'How Nhost configured pnpm workspaces and Turborepo to build, cache, and link 10+ packages in a single fast, consistent monorepo.',
  authors: [
    {
