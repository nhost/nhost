...
export const article = {
  ...
  date: '2024-05-17',
  seoTitle: 'How Yalink Migrated from Heroku to Nhost',
  seoDescription: 'Contech startup Yalink shares how it migrated from Flask on Heroku to Nhost, gaining GraphQL APIs, managed auth, and AI embeddings with Graphite.',
  authors: [
    {
      name: 'Alex',
