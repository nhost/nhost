...
export const article = {
  ...
  date: '2022-09-28',
  seoTitle: 'Open Source Stripe GraphQL API',
  seoDescription: 'Query your Postgres database and Stripe account in a single GraphQL request using the open source @nhost/stripe-graphql-js package and Hasura.',
  authors: [
    {
      name: 'Johan Eliasson',
      title: 'CEO',
