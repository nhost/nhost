...
> We're using here a [System Environment Variable](https://docs.nhost.io/platform/environment-variables#system-environment-variables), `NHOST_BACKEND_URL`, to make sure the URL works both locally and in production.
