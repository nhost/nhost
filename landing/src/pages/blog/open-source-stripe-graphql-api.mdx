...
> Note: `@nhost/stripe-graphql-js` creates an **unofficial open-source** Stripe GraphQL API. [The source code is available on GitHub](https://github.com/nhost/nhost/tree/main/packages/stripe-graphql-js).
...
If you want to help us, [the code is open source and available on GitHub](https://github.com/nhost/nhost/tree/main/packages/stripe-graphql-js) - we would be more than happy to accept contributions.
