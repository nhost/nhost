...
export const article = {
  ...
  date: '2023-05-30',
  seoTitle: 'Nhost Config: Environment Parity and Control',
  seoDescription: 'A new config workflow keeps local and cloud Nhost projects in sync, giving granular control over runtime settings. The CLI also hits v1.0.0.',
  authors: [
    {
      name: 'Nuno Pato',
      title: 'CEO',
