...
export const article = {
  ...
  date: '2024-04-23',
  seoTitle: 'Migrating the Nhost Auth Service to Go',
  seoDescription: 'Why and how we rewrote the Nhost Auth service from Node.js to Go using the strangler fig pattern for better performance and reliability.',
  authors: [
    {
      name: 'David Barroso',
      title: 'CTO',
