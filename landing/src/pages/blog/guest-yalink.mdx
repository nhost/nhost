...
While we did experience a small hit to performance due to network latency between the two services (our Flask backend was hosted on Heroku), it was nothing unmanageable since we didn't have a lot of traffic at that time.
