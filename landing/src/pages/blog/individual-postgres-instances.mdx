...
export const article = {
  ...
  date: '2022-09-26',
  seoTitle: 'Dedicated PostgreSQL Instances with Root Access',
  seoDescription: 'Every new Nhost project now gets a dedicated PostgreSQL instance on Kubernetes with root access, custom extensions, and direct connections.',
  authors: [
    {
      name: 'David Barroso',
      title: 'Engineering',
