...
export const article = {
  title: 'IPv6 Support (and IPv4)',
  description:
    'IPv6',
  image: '/images/blog/ipv6/ipv6.png',
  date: '2024-02-12',
  seoTitle: 'IPv6 Support and Free IPv4 on Nhost',
  seoDescription: 'How Nhost added IPv6 support and absorbed AWS\'s new IPv4 charges so users keep free IPv4 with zero changes, thanks to Kubernetes and NLBs.',
  authors: [
    {
      name: 'Nuno Pato',
      title: 'CEO',
