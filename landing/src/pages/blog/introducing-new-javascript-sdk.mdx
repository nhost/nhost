...
export const article = {
  ...
  date: '2025-09-24',
  seoTitle: 'New Nhost JavaScript SDK: Generated & Isomorphic',
  seoDescription: 'Nhost\'s new JavaScript SDK is auto-generated from OpenAPI specs, isomorphic, simpler to use, and a foundation for multi-language support.',
  authors: [
    {
      name: 'Nuno Pato',
      title: 'CEO',
