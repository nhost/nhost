...
```bash
bun install @nhost/nhost-js@^5.0.0
```
...
**If you're using existing packages** (nhost-js < 5.x or framework packages): we'll continue to support them with security patches and bug fixes for at least 6 months, but they won't receive new functionality. While there's no immediate rush to migrate, we recommend starting to plan your transition to the new SDK. Check our [migration guide](https://docs.nhost.io/sdk/migration) for detailed instructions.
