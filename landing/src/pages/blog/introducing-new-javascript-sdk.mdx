...
We've seen these improvements ourselves after migrating our own dashboard two months ago, we experienced significant stability improvements. Beta users have reported similar results, with complex auth workflows working reliably.
