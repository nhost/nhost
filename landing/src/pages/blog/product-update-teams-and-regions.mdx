...
export const article = {
  ...
  date: '2020-05-01',
  seoTitle: 'Product Update: Team Support and More Regions',
  seoDescription: 'Nhost adds New York and London regions, team collaboration, a CLI for local development, and GitHub deployment integration.',
  authors: [
    {
      name: 'Johan Eliasson',
      title: 'CEO',
