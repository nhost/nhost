...
export const article = {
  ...
  date: '2024-06-26',
  seoTitle: 'Node.js 20 Support for Nhost Functions',
  seoDescription: 'Nhost Functions now lets you choose between Node.js 18 and Node.js 20 as your runtime by setting the version in your nhost.toml file.',
  authors: [
    {
      name: 'David Barroso',
      title: 'CTO',
...
For more details don't hesitate to check our [documentation](https://docs.nhost.io/products/functions/runtimes).
