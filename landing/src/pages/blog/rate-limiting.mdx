...
You can configure rate limiting for your services either on the [Nhost Dashboard](https://app.nhost.io/_/_/settings/rate-limiting) or by using the configuration file:
...
Very neat, if you ask me. For a full list of configurations available to all services, please check out the [documentation page](https://docs.nhost.io/platform/rate-limits).
