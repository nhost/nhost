...
export const article = {
  ...
  date: '2024-08-28',
  seoTitle: 'Rate Limiting Now Available on Nhost',
  seoDescription: 'Nhost now offers configurable rate limiting across GraphQL, Storage, Functions, and Auth to protect services from abuse and boost performance.',
  authors: [
    {
      name: 'Nuno Pato',
      title: 'CEO',
