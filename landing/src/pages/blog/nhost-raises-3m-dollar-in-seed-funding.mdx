...
export const article = {
  ...
  date: '2021-04-06',
  seoTitle: 'Nhost Raises $3M in Seed Funding',
  seoDescription: 'Nhost raises $3M in seed funding led by Nauta Capital to build its open-source Firebase alternative with GraphQL and help developers ship faster.',
  authors: [
    {
      name: 'Johan Eliasson',
      title: 'CEO',
