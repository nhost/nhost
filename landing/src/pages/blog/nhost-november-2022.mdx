...
export const article = {
  ...
  date: '2022-12-02',
  seoTitle: 'November 2022: Dashboard Goes Open Source',
  seoDescription: 'November 2022 open-sources the Nhost Dashboard and adds it to the CLI, plus a Google Translation GraphQL API and Twitter and WorkOS sign-in.',
  authors: [
    {
      name: 'Johan Eliasson',
      title: 'CEO',
