...
export const article = {
  ...
  date: '2024-06-26',
  seoTitle: 'Node.js Runtime Support for Nhost Functions',
  seoDescription: 'Choose your Node.js runtime for Nhost Functions by setting the version in nhost.toml to homogenize runtime environments and simplify setups.',
  authors: [
    {
      name: 'David Barroso',
      title: 'CTO',
...
For more details don't hesitate to check our [documentation](https://docs.nhost.io/products/functions/runtimes#runtimes).
