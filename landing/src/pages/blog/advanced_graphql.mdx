...
export const article = {
  ...
  date: '2024-04-11',
  seoTitle: 'Advanced GraphQL Observability and Security',
  seoDescription: 'New GraphQL features for Nhost: an observability dashboard plus security options to disable the admin secret and limit query depth.',
  authors: [
    {
      name: 'David Barroso',
      title: 'CTO',
