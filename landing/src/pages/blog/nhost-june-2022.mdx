...
export const article = {
  ...
  date: '2022-07-01',
  seoTitle: 'June 2022: Nhost CDN & Database UI Preview',
  seoDescription: 'June 2022 launches the Nhost CDN for faster storage, a new domain structure, a database UI and GraphQL Playground preview, and file upload hooks.',
  authors: [
    {
      name: 'Johan Eliasson',
      title: 'CEO',
