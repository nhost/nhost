...
1. Visit your project's [AI Settings](https://app.nhost.io/orgs/_/projects/_/ai/settings) section in the Nhost Dashboard and upgrade the AI service to its latest version: v0.7.1.
