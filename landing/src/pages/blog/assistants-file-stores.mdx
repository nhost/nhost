...
export const article = {
  ...
  date: '2024-12-12',
  seoTitle: 'AI File Stores: Chat With Your Storage Files',
  seoDescription: 'Nhost File Stores let you augment AI Assistants with knowledge from documents in Storage, auto-creating embeddings so you can chat with files.',
  authors: [
    {
      name: 'Nuno Pato',
      title: 'CEO',
