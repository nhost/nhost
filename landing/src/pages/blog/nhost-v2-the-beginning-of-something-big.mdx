...
export const article = {
  ...
  date: '2022-01-25',
  seoTitle: 'Nhost v2: Free Tier, New SDKs, AWS & More',
  seoDescription: 'Nhost v2 launches in public beta with a free tier, redesigned auth and storage, a new JavaScript SDK, a Go CLI, and AWS infrastructure.',
  authors: [
    {
      name: 'Johan Eliasson',
      title: 'CEO',
