...
- We are using a [Pro project without dedicated compute](https://docs.nhost.io/platform/compute-resources#pro-plan). This means half a core for each service (shared).
