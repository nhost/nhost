...
export const article = {
  ...
  description:
    'Release Day of all features announced.',
...
- https://docs.nhost.io/guides/database/extensions#pgvector
- https://docs.nhost.io/guides/ai/auto-embeddings
...
- https://docs.nhost.io/guides/ai/assistants
