...
export const article = {
  ...
  date: '2023-12-22',
  seoTitle: 'AI Week Release Day Recap and Feature Rollout',
  seoDescription: 'A recap of Nhost AI Week: pgvector, Auto-Embeddings, AI Assistants, Dev Assistant, and ChatGPT docs are now all available to use.',
  authors: [
    {
      name: 'Nuno Pato',
      title: 'CEO',
