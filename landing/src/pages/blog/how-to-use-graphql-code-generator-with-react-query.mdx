...
export const article = {
  ...
  date: '2022-07-19',
  seoTitle: 'GraphQL Code Generator with React Query',
  seoDescription: 'Use GraphQL Code Generator with React, React Query v4, and TypeScript to get typed, autocompleted queries and mutations end to end.',
  authors: [
    {
      name: 'Johan Eliasson',
      title: 'CEO',
