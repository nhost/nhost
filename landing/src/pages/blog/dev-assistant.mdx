...
export const article = {
  ...
  date: '2023-12-20',
  seoTitle: 'Graphite: Your Nhost Developer Assistant',
  seoDescription: 'Graphite is an AI developer assistant in the Nhost Dashboard that knows your database and GraphQL schemas to help write SQL and queries.',
  authors: [
    {
      name: 'Nuno Pato',
      title: 'CEO',
