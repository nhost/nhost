...
export const article = {
  ...
  date: '2024-03-05',
  seoTitle: 'Protect Magic Links from Email Clients',
  seoDescription: 'Stop email clients from invalidating one-time magic links by redirecting users through an app page that triggers verification on a click.',
  authors: [
    {
