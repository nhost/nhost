...
export const article = {
  ...
  date: '2025-06-04',
  seoTitle: 'Nhost MCP Server: Connect AI Tools to Your Backend',
  seoDescription: 'The new Nhost MCP server lets AI tools like Cursor and Claude securely query schemas, run GraphQL, manage migrations, and set permissions.',
  authors: [
    {
      name: 'Nuno Pato',
      title: 'CEO',
...
The MCP server is open source and you can find the complete source code and documentation in our <a href="https://github.com/nhost/mcp-nhost" target="_blank" rel="noopener noreferrer">GitHub repository</a>.