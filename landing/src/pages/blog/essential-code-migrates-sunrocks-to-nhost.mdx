...
export const article = {
  ...
  date: '2024-06-06',
  seoTitle: 'How Essential Code Migrated SunRocks to Nhost',
  seoDescription: 'Essential Code shares how it migrated SunRocks, an insurance platform, from a complex Hasura, Keycloak, and OpenShift stack to Nhost.',
  authors: [
    {
      name: 'David',
      title: 'Founder',
