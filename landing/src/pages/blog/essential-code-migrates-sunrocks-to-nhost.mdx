...
export const article = {
  title: 'Guest Blog Post: Essential Code',
  description:
    'Learn how the team at Essential Code migrated SunRocks, an insurance platform, from a convoluted tech stack to Nhost',
  image: '/images/blog/og-nhost-essential-code.png',
  date: '2024-06-06',
  authors: [
    {
      name: 'David',
  ...
  tags: ['Product', 'Customer', 'Guest blogpost', 'Migration to Nhost'],
}
...
After exiting my software agency in 2023 to continue solo, I founded [Essential Code](https://essentialcode.eu), dedicated to empowering SMEs with efficient No-Code and Low-Code solutions. Despite my transition, some of my existing clients insisted on retaining my services, including SunRocks, a company providing insurance services. The platform I built for them streamlines all their daily operations and customer interactions. This blog post details the work and migration efforts I undertook for SunRocks to move from a complicated and cost-intensive hosting environment to Nhost.
