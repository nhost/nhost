...
export const article = {
  ...
  date: '2023-12-18',
  seoTitle: 'Postgres Vector Database and Auto-Embeddings',
  seoDescription: 'Use Nhost Postgres as a vector database with pgvector, and Auto-Embeddings to easily create and keep embeddings up to date for AI apps.',
  authors: [
    {
      name: 'Nuno Pato',
      title: 'CEO',
