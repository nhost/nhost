...
Each day, with the exception of Friday, we will be announcing a new feature with a blog post. 

Most features will only be available for you to try on Friday, a day dedicated to releasing **graphite**, your new AI companion, and demos that showcase how features work. 
...
![Graphite in action](/images/blog/auto-embeddings/graphite-white.png)
