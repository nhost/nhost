...
export const article = {
  ...
  date: '2022-09-29',
  seoTitle: 'WebAuthn Sign-In with Face ID & Fingerprint',
  seoDescription: 'Nhost Auth now supports WebAuthn, letting users sign in with Face ID, Touch ID, or a fingerprint instead of a password, via SDK and React hooks.',
  authors: [
    {
