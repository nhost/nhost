...
The next thing we want to do is set up the [Nhost CLI](https://docs.nhost.io/cli) to work with our app locally. We can start by globally installing the CLI.
