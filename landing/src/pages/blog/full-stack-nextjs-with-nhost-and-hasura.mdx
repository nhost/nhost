...
export const article = {
  ...
  date: '2021-02-27',
  seoTitle: 'Full-Stack Next.js With Nhost and Hasura',
  seoDescription: 'Build a full-stack Next.js app with Nhost and Hasura, scaffolding the frontend for Botler with a Postgres database and GraphQL API.',
  authors: [
    {
      name: 'Johan Eliasson',
      title: 'CEO',
