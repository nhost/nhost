...
export const article = {
  ...
  date: '2026-03-31',
  seoTitle: 'Turn Any Nhost Project into an Agentic Service',
  seoDescription: 'Deploy the open-source Nhost MCP service to expose your GraphQL API to AI agents with OAuth2 auth and your existing permission model.',
  authors: [
    {
      name: 'David Barroso',
      title: 'CTO',
