...
export const article = {
  ...
  image: '/images/blog/og-soc2-compliance.png',
  date: '2025-06-03',
  seoTitle: 'SOC 2 Type II Compliance Achieved',
  seoDescription: 'Nhost has achieved SOC 2 Type II compliance, bringing audited enterprise-grade security to your apps and faster enterprise sales cycles.',
  authors: [
    {
      name: 'Nuno Pato',
      title: 'CEO',
...
If you're on a Team or Enterprise plan and need our SOC 2 Type II report for your compliance process, you can download it directly from your organization settings in the <a href="https://app.nhost.io/orgs/_/settings" target="_blank" rel="noopener noreferrer">Nhost Dashboard</a>. No need to email us or wait for a response.
...
For more details about our security practices and certifications, visit our <a href="https://nhost.io/security" target="_blank" rel="noopener noreferrer">Security Center</a>.

Ready to build on a backend you don't have to worry about? <a href="https://app.nhost.io/signup" target="_blank" rel="noopener noreferrer">Get started with Nhost</a> and see what it's like to have enterprise-grade security without the enterprise-grade headaches.