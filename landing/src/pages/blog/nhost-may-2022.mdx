...
export const article = {
  ...
  date: '2022-06-01',
  seoTitle: 'May 2022: Vue SDK & SMS Phone Sign-In',
  seoDescription: 'May 2022 launches a Vue SDK, quickstart guides, phone number SMS sign-in, custom SMTP and email templates, and 5x faster Go-based storage.',
  authors: [
    {
      name: 'Johan Eliasson',
      title: 'CEO',
