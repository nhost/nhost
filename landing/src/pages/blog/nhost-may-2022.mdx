...
- [Quickstart: React](https://docs.nhost.io/platform/quickstarts/react)
- [Quickstart: Next.js](https://docs.nhost.io/platform/quickstarts/nextjs)
- [Quickstart: RedoowJS](https://docs.nhost.io/platform/quickstarts/redwoodjs)
- [Quickstart: Vue](https://docs.nhost.io/platform/quickstarts/vue)
...
Read the [Email Templates](https://docs.nhost.io/platform/authentication/email-templates) documentation to learn more about how to customize the emails.
...
Read the [Sign in with Phone Number](https://docs.nhost.io/platform/authentication/sign-in-with-phone-number-sms) documentation to learn more about how to sign in users with their phone numbers.
