...
export const article = {
  ...
  date: '2020-07-09',
  seoTitle: 'Understanding JWT Tokens with Hasura',
  seoDescription: 'Learn what JWT tokens are, how Hasura session variables and roles work, and how tokens are signed, sent, and refreshed to authenticate users.',
  authors: [
    {
      name: 'Johan Eliasson',
      title: 'CEO',
