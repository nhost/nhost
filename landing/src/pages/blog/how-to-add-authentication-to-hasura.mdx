...
export const article = {
  ...
  date: '2022-02-17',
  seoTitle: 'How to Add Authentication to Hasura',
  seoDescription: 'Learn how to add authentication to Hasura using the open-source Hasura Auth service, with multiple sign-in methods and JWT-based permissions.',
  authors: [
    {
      name: 'Johan Eliasson',
      title: 'CEO',
