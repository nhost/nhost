...
export const article = {
  ...
  date: '2022-07-04',
  seoTitle: 'GraphQL Code Generator with React and Apollo',
  seoDescription: 'Set up GraphQL Code Generator with React, Apollo Client, and TypeScript for end-to-end type safety on queries, mutations, and subscriptions.',
  authors: [
    {
      name: 'Johan Eliasson',
      title: 'CEO',
