...
export const article = {
  ...
  date: '2026-03-09',
  seoTitle: 'Product Update: OAuth2 Provider & PostgreSQL 18',
  seoDescription: 'Nhost Auth becomes an OAuth2/OIDC provider, plus dashboard trigger management, database views, PostgreSQL 18.1, and embedded docs for LLMs.',
  authors: [
    {
      name: 'David Barroso',
      title: 'CTO',
