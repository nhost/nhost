...
<Image
  src="/images/blog/newsletter-2026q1/grafana_oauth2.png"
  alt="Grafana login page showing Sign in with Nhost button"
  width={800}
  height={500}
/>
...
<Image
  src="/images/blog/newsletter-2026q1/events.png"
  alt="Event triggers management page in the Nhost dashboard"
  width={800}
  height={500}
/>
...
<Image
  src="/images/blog/newsletter-2026q1/database.png"
  alt="Database page showing views and untracked tables"
  width={800}
  height={500}
/>
...
<Image
  src="/images/blog/newsletter-2026q1/data.png"
  alt="Data browser with column filters"
  width={800}
  height={500}
/>
...
<Image
  src="/images/blog/newsletter-2026q1/cli_docs_list.png"
  alt="nhost docs list command showing all available documentation pages"
  width={800}
  height={500}
/>

<Image
  src="/images/blog/newsletter-2026q1/cli_docs_search.png"
  alt="nhost docs search command finding relevant pages for passwordless authentication"
  width={800}
  height={500}
/>

<Image
  src="/images/blog/newsletter-2026q1/cli_docs_show.png"
  alt="nhost docs show command displaying the full content of a documentation page"
  width={800}
  height={500}
/>
