...
export const article = {
  title: 'Migrate from Nhost v1 to v2',
  description: '',
  image: '/images/blog/migrate-from-nhost-v1-to-v2/banner.png',
  date: '2022-01-16',
  seoTitle: 'How to Migrate from Nhost v1 to v2',
  seoDescription: 'A step-by-step guide to migrating a project from Nhost v1 to v2, covering database schema, Hasura metadata changes, and data transfer.',
  authors: [
    {
      name: 'Johan Eliasson',
      title: 'CEO',
...
This is a guide that explains how to migrate a project from [Nhost v1](https://console.nhost.io/) to [Nhost v2](https://app.nhost.io/).
...
Make sure you have the [Nhost CLI](https://docs.nhost.io/platform/cli/local-development) installed.
...
You can also use [TransferGraph](https://github.com/QuestGiverOrg/TransferGraph), an open source tool from the community that helps you do this.
