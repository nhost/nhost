...
export const article = {
  ...
  date: '2022-05-20',
  seoTitle: 'Build a Todo App with Nhost GraphQL & Auth',
  seoDescription: 'A beginner tutorial: build a secure todo app with Nhost by defining a Postgres schema, setting Hasura permissions, and querying via GraphQL.',
  authors: [
    {
      name: 'Nuno Pato',
      title: 'CTO',
