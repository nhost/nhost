...
export const article = {
  ...
  date: '2020-07-05',
  seoTitle: 'A Beginner\'s Guide to GraphQL Fundamentals',
  seoDescription: 'An introductory guide to GraphQL: what it is, how it differs from REST, its history, and how queries fetch exactly the data you need.',
  authors: [
    {
      name: 'Johan Eliasson',
      title: 'CEO',
