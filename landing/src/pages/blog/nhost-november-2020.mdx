...
export const article = {
  ...
  date: '2020-12-01',
  seoTitle: 'November 2020: Serverless Functions Beta',
  seoDescription: 'November 2020 brings Custom API serverless functions in beta, a local-to-GitHub deploy workflow, automatic backups, and new documentation.',
  authors: [
    {
      name: 'Johan Eliasson',
      title: 'CEO',
