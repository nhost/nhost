...
export const article = {
  title: 'RevTron Insights for Triple-Digit Growth',
  description: '',
  image: '/images/blog/revtron-insights-for-triple-digit-growth/banner.png',
  date: '2021-11-10',
  seoTitle: 'How RevTron Scaled Its SaaS Platform on Nhost',
  seoDescription: 'How RevTron used Nhost Postgres, GraphQL, Auth, and Storage to launch its data-heavy React platform and onboard customers in minutes.',
  authors: [
    {
      name: 'Seb Agudelo',
      title: 'Marketing',
      avatarUrl: '/images/avatars/seb.jpeg',
      url: 'https://twitter.com/sebagudelo',
    },
    {
      name: 'Dylan Dempsey',
      title: 'Co-Founder & CEO',
      avatarUrl: '/images/avatars/dylan.png',
      url: 'https://www.linkedin.com/in/dylan-dempsey/',
    },
  ],
  tags: ['User Story'],
}
