...
export const article = {
  ...
  date: '2022-04-14',
  seoTitle: 'Midnight Society: 400K-User Launch in 6 Weeks',
  seoDescription: 'How Midnight Society used Nhost and Hasura to go from mock-up to a 400,000-user game launch in just six weeks with a small team.',
  authors: [
    {
      name: 'Johan Eliasson',
      title: 'CEO',
