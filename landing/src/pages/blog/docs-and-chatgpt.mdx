...
export const article = {
  ...
  date: '2023-12-21',
  seoTitle: 'New Nhost Docs With ChatGPT Support',
  seoDescription: 'A revamped Nhost documentation website with ChatGPT support and rewritten content for a more interactive, personalized learning experience.',
  authors: [
    {
      name: 'Nuno Pato',
      title: 'CEO',
