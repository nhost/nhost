...
export const article = {
  ...
  date: '2023-04-18',
  seoTitle: 'Scale Nhost Apps With Dedicated Compute',
  seoDescription: 'Dedicated Compute lets you allocate CPU and RAM per Nhost service, up to 15 vCPUs and 30GiB each, to scale apps and meet growing demand.',
  authors: [
    {
      name: 'Nuno Pato',
      title: 'CTO',
