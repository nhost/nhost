...
export const article = {
  ...
  date: '2024-04-02',
  seoTitle: 'Connect Social Providers to User Accounts',
  seoDescription: 'Let existing users link additional social logins to their account, keeping the same user ID even when the provider email does not match.',
  authors: [
    {
