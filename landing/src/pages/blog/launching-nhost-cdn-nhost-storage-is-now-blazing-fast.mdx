...
export const article = {
  ...
  date: '2022-06-22',
  seoTitle: 'Nhost CDN: Storage Now Up to 104x Faster',
  seoDescription: 'Nhost CDN serves files up to 104x faster with global edge caching, private-file support, large-file ranges, and automatic cache invalidation.',
  authors: [
    {
      name: 'David Barroso',
      title: 'Engineering',
