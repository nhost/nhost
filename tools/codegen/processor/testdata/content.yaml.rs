...
impl SignInProviderParams {
    fn to_query(&self) -> Vec<(String, String)> {
        ...
        if let Some(v) = &self.allowed_roles {
            push_query(&mut q, "allowedRoles", &serde_json::to_value(v).unwrap_or_default(), false);
        }
        ...
        if let Some(v) = &self.metadata {
            push_query(&mut q, "metadata", &serde_json::to_value(v).unwrap_or_default(), true);
        }
        ...
        if let Some(v) = &self.provider_specific_params {
            push_query(&mut q, "providerSpecificParams", &serde_json::to_value(v).unwrap_or_default(), true);
        }
        q
    }
}
