...
func pythonRequestMethodBindingNames(method *processor.Method) map[string]string {
	...
	if method.HasHeaderParameters() {
		seen["parameter_headers"] = "generated parameter headers local"
	}

	if method.RequestFormData() != nil {
		seen["data"] = "generated multipart data local"
		seen["files"] = "generated multipart files local"
		seen["item"] = "generated multipart item local"
	}
