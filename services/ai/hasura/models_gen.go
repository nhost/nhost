...
type GraphiteAssistantFileStores struct {
...
type GraphiteAssistantFileStoresAggregate struct {
	Aggregate *GraphiteAssistantFileStoresAggregateFields `json:"aggregate,omitempty"`
	Nodes     []*GraphiteAssistantFileStores              `json:"nodes"`
}

// aggregate fields of "graphite.assistant_file_stores"
type GraphiteAssistantFileStoresAggregateFields struct {
	Count int64                                 `json:"count"`
	Max   *GraphiteAssistantFileStoresMaxFields `json:"max,omitempty"`
	Min   *GraphiteAssistantFileStoresMinFields `json:"min,omitempty"`
}
...
type GraphiteAssistantFileStoresBoolExp struct {
	And         []*GraphiteAssistantFileStoresBoolExp `json:"_and,omitempty"`
	Not         *GraphiteAssistantFileStoresBoolExp   `json:"_not,omitempty"`
	Or          []*GraphiteAssistantFileStoresBoolExp `json:"_or,omitempty"`
	AssistantID *StringComparisonExp                  `json:"assistantID,omitempty"`
	CreatedAt   *TimestamptzComparisonExp             `json:"createdAt,omitempty"`
	FileStoreID *UUIDComparisonExp                    `json:"fileStoreID,omitempty"`
...
type GraphiteAssistantFileStoresInsertInput struct {
...
type GraphiteAssistantFileStoresMaxFields struct {
	AssistantID *string    `json:"assistantID,omitempty"`
	CreatedAt   *time.Time `json:"createdAt,omitempty"`
	FileStoreID *string    `json:"fileStoreID,omitempty"`
	UpdatedAt   *time.Time `json:"updatedAt,omitempty"`
...
type GraphiteAssistantFileStoresMinFields struct {
	AssistantID *string    `json:"assistantID,omitempty"`
	CreatedAt   *time.Time `json:"createdAt,omitempty"`
	FileStoreID *string    `json:"fileStoreID,omitempty"`
	UpdatedAt   *time.Time `json:"updatedAt,omitempty"`
...
type GraphiteAssistantFileStoresMutationResponse struct {
	// number of rows affected by the mutation
	AffectedRows int64 `json:"affected_rows"`
	// data from the rows affected by the mutation
	Returning []*GraphiteAssistantFileStores `json:"returning"`
}

// on_conflict condition type for table "graphite.assistant_file_stores"
type GraphiteAssistantFileStoresOnConflict struct {
	Constraint    GraphiteAssistantFileStoresConstraint     `json:"constraint"`
	UpdateColumns []GraphiteAssistantFileStoresUpdateColumn `json:"update_columns"`
	Where         *GraphiteAssistantFileStoresBoolExp       `json:"where,omitempty"`
}

// Ordering options when selecting data from "graphite.assistant_file_stores".
type GraphiteAssistantFileStoresOrderBy struct {
	AssistantID *OrderBy `json:"assistantID,omitempty"`
	CreatedAt   *OrderBy `json:"createdAt,omitempty"`
	FileStoreID *OrderBy `json:"fileStoreID,omitempty"`
	UpdatedAt   *OrderBy `json:"updatedAt,omitempty"`
}

// primary key columns input for table: graphite.assistant_file_stores
type GraphiteAssistantFileStoresPkColumnsInput struct {
	AssistantID string `json:"assistantID"`
	FileStoreID string `json:"fileStoreID"`
}

// input type for updating data in table "graphite.assistant_file_stores"
type GraphiteAssistantFileStoresSetInput struct {
	AssistantID *string    `json:"assistantID,omitempty"`
	CreatedAt   *time.Time `json:"createdAt,omitempty"`
	FileStoreID *string    `json:"fileStoreID,omitempty"`
	UpdatedAt   *time.Time `json:"updatedAt,omitempty"`
...
type GraphiteAssistantFileStoresStreamCursorInput struct {
	// Stream column input with initial value
	InitialValue *GraphiteAssistantFileStoresStreamCursorValueInput `json:"initial_value"`
	// cursor ordering
	Ordering *CursorOrdering `json:"ordering,omitempty"`
}

// Initial value of the column from where the streaming should start
type GraphiteAssistantFileStoresStreamCursorValueInput struct {
	AssistantID *string    `json:"assistantID,omitempty"`
	CreatedAt   *time.Time `json:"createdAt,omitempty"`
	FileStoreID *string    `json:"fileStoreID,omitempty"`
	UpdatedAt   *time.Time `json:"updatedAt,omitempty"`
...
type GraphiteAssistantFileStoresUpdates struct {
	// sets the columns of the filtered rows to the given values
	Set *GraphiteAssistantFileStoresSetInput `json:"_set,omitempty"`
	// filter the rows which have to be updated
	Where *GraphiteAssistantFileStoresBoolExp `json:"where"`
}

// columns and relationships of "graphite.assistants"
type GraphiteAssistants struct {
	AssistantID *string         `json:"assistantID,omitempty"`
	CreatedAt   time.Time       `json:"createdAt"`
...
type GraphiteAssistantsAggregate struct {
	Aggregate *GraphiteAssistantsAggregateFields `json:"aggregate,omitempty"`
	Nodes     []*GraphiteAssistants              `json:"nodes"`
}

// aggregate fields of "graphite.assistants"
type GraphiteAssistantsAggregateFields struct {
	Count int64                        `json:"count"`
	Max   *GraphiteAssistantsMaxFields `json:"max,omitempty"`
	Min   *GraphiteAssistantsMinFields `json:"min,omitempty"`
}

// append existing jsonb value of filtered columns with new jsonb value
type GraphiteAssistantsAppendInput struct {
	Data json.RawMessage `json:"data,omitempty"`
}

// Boolean expression to filter rows from the table "graphite.assistants". All fields are combined with a logical 'AND'.
type GraphiteAssistantsBoolExp struct {
	And         []*GraphiteAssistantsBoolExp `json:"_and,omitempty"`
	Not         *GraphiteAssistantsBoolExp   `json:"_not,omitempty"`
	Or          []*GraphiteAssistantsBoolExp `json:"_or,omitempty"`
	AssistantID *StringComparisonExp         `json:"assistantID,omitempty"`
	CreatedAt   *TimestamptzComparisonExp    `json:"createdAt,omitempty"`
...
type GraphiteAssistantsDeleteAtPathInput struct {
	Data []string `json:"data,omitempty"`
}

// delete the array element with specified index (negative integers count from the end). throws an error if top level container is not an array
type GraphiteAssistantsDeleteElemInput struct {
	Data *int64 `json:"data,omitempty"`
}

// delete key/value pair or string element. key/value pairs are matched based on their key value
type GraphiteAssistantsDeleteKeyInput struct {
	Data *string `json:"data,omitempty"`
}

// input type for inserting data into table "graphite.assistants"
type GraphiteAssistantsInsertInput struct {
	AssistantID *string         `json:"assistantID,omitempty"`
	CreatedAt   *time.Time      `json:"createdAt,omitempty"`
	Data        json.RawMessage `json:"data,omitempty"`
...
// aggregate max on columns
type GraphiteAssistantsMaxFields struct {
	AssistantID *string    `json:"assistantID,omitempty"`
	CreatedAt   *time.Time `json:"createdAt,omitempty"`
	ID          *string    `json:"id,omitempty"`
	UpdatedAt   *time.Time `json:"updatedAt,omitempty"`
...
// aggregate min on columns
type GraphiteAssistantsMinFields struct {
	AssistantID *string    `json:"assistantID,omitempty"`
	CreatedAt   *time.Time `json:"createdAt,omitempty"`
	ID          *string    `json:"id,omitempty"`
	UpdatedAt   *time.Time `json:"updatedAt,omitempty"`
...
type GraphiteAssistantsMutationResponse struct {
	// number of rows affected by the mutation
	AffectedRows int64 `json:"affected_rows"`
	// data from the rows affected by the mutation
	Returning []*GraphiteAssistants `json:"returning"`
}

// on_conflict condition type for table "graphite.assistants"
type GraphiteAssistantsOnConflict struct {
	Constraint    GraphiteAssistantsConstraint     `json:"constraint"`
	UpdateColumns []GraphiteAssistantsUpdateColumn `json:"update_columns"`
	Where         *GraphiteAssistantsBoolExp       `json:"where,omitempty"`
}

// Ordering options when selecting data from "graphite.assistants".
type GraphiteAssistantsOrderBy struct {
	AssistantID *OrderBy `json:"assistantID,omitempty"`
	CreatedAt   *OrderBy `json:"createdAt,omitempty"`
...
type GraphiteAssistantsPkColumnsInput struct {
	ID string `json:"id"`
}

// prepend existing jsonb value of filtered columns with new jsonb value
type GraphiteAssistantsPrependInput struct {
	Data json.RawMessage `json:"data,omitempty"`
}

// input type for updating data in table "graphite.assistants"
type GraphiteAssistantsSetInput struct {
	AssistantID *string         `json:"assistantID,omitempty"`
	CreatedAt   *time.Time      `json:"createdAt,omitempty"`
	Data        json.RawMessage `json:"data,omitempty"`
	ID          *string         `json:"id,omitempty"`
...
type GraphiteAssistantsStreamCursorInput struct {
	// Stream column input with initial value
	InitialValue *GraphiteAssistantsStreamCursorValueInput `json:"initial_value"`
	// cursor ordering
	Ordering *CursorOrdering `json:"ordering,omitempty"`
}

// Initial value of the column from where the streaming should start
type GraphiteAssistantsStreamCursorValueInput struct {
	AssistantID *string         `json:"assistantID,omitempty"`
	CreatedAt   *time.Time      `json:"createdAt,omitempty"`
	Data        json.RawMessage `json:"data,omitempty"`
	ID          *string         `json:"id,omitempty"`
...
type GraphiteAssistantsUpdates struct {
	// append existing jsonb value of filtered columns with new jsonb value
	Append *GraphiteAssistantsAppendInput `json:"_append,omitempty"`
	// delete the field or element with specified path (for JSON arrays, negative integers count from the end)
	DeleteAtPath *GraphiteAssistantsDeleteAtPathInput `json:"_delete_at_path,omitempty"`
	// delete the array element with specified index (negative integers count from the end). throws an error if top level container is not an array
	DeleteElem *GraphiteAssistantsDeleteElemInput `json:"_delete_elem,omitempty"`
	// delete key/value pair or string element. key/value pairs are matched based on their key value
	DeleteKey *GraphiteAssistantsDeleteKeyInput `json:"_delete_key,omitempty"`
	// prepend existing jsonb value of filtered columns with new jsonb value
	Prepend *GraphiteAssistantsPrependInput `json:"_prepend,omitempty"`
	// sets the columns of the filtered rows to the given values
	Set *GraphiteAssistantsSetInput `json:"_set,omitempty"`
	// filter the rows which have to be updated
	Where *GraphiteAssistantsBoolExp `json:"where"`
}

// columns and relationships of "graphite.file_store_buckets"
type GraphiteFileStoreBuckets struct {
...
type GraphiteFileStoreBucketsAggregate struct {
	Aggregate *GraphiteFileStoreBucketsAggregateFields `json:"aggregate,omitempty"`
	Nodes     []*GraphiteFileStoreBuckets              `json:"nodes"`
}

// aggregate fields of "graphite.file_store_buckets"
type GraphiteFileStoreBucketsAggregateFields struct {
	Count int64                              `json:"count"`
	Max   *GraphiteFileStoreBucketsMaxFields `json:"max,omitempty"`
	Min   *GraphiteFileStoreBucketsMinFields `json:"min,omitempty"`
}

// Boolean expression to filter rows from the table "graphite.file_store_buckets". All fields are combined with a logical 'AND'.
type GraphiteFileStoreBucketsBoolExp struct {
	And         []*GraphiteFileStoreBucketsBoolExp `json:"_and,omitempty"`
	Not         *GraphiteFileStoreBucketsBoolExp   `json:"_not,omitempty"`
	Or          []*GraphiteFileStoreBucketsBoolExp `json:"_or,omitempty"`
...
type GraphiteFileStoreBucketsInsertInput struct {
...
// aggregate max on columns
type GraphiteFileStoreBucketsMaxFields struct {
	BucketID    *string    `json:"bucketID,omitempty"`
	CreatedAt   *time.Time `json:"createdAt,omitempty"`
	FileStoreID *string    `json:"fileStoreID,omitempty"`
	UpdatedAt   *time.Time `json:"updatedAt,omitempty"`
...
// aggregate min on columns
type GraphiteFileStoreBucketsMinFields struct {
	BucketID    *string    `json:"bucketID,omitempty"`
	CreatedAt   *time.Time `json:"createdAt,omitempty"`
	FileStoreID *string    `json:"fileStoreID,omitempty"`
	UpdatedAt   *time.Time `json:"updatedAt,omitempty"`
...
type GraphiteFileStoreBucketsMutationResponse struct {
	// number of rows affected by the mutation
	AffectedRows int64 `json:"affected_rows"`
	// data from the rows affected by the mutation
	Returning []*GraphiteFileStoreBuckets `json:"returning"`
}

// on_conflict condition type for table "graphite.file_store_buckets"
type GraphiteFileStoreBucketsOnConflict struct {
	Constraint    GraphiteFileStoreBucketsConstraint     `json:"constraint"`
	UpdateColumns []GraphiteFileStoreBucketsUpdateColumn `json:"update_columns"`
	Where         *GraphiteFileStoreBucketsBoolExp       `json:"where,omitempty"`
}

// Ordering options when selecting data from "graphite.file_store_buckets".
type GraphiteFileStoreBucketsOrderBy struct {
...
type GraphiteFileStoreBucketsPkColumnsInput struct {
	BucketID    string `json:"bucketID"`
	FileStoreID string `json:"fileStoreID"`
}

// input type for updating data in table "graphite.file_store_buckets"
type GraphiteFileStoreBucketsSetInput struct {
	BucketID    *string    `json:"bucketID,omitempty"`
	CreatedAt   *time.Time `json:"createdAt,omitempty"`
	FileStoreID *string    `json:"fileStoreID,omitempty"`
	UpdatedAt   *time.Time `json:"updatedAt,omitempty"`
...
type GraphiteFileStoreBucketsStreamCursorInput struct {
	// Stream column input with initial value
	InitialValue *GraphiteFileStoreBucketsStreamCursorValueInput `json:"initial_value"`
	// cursor ordering
	Ordering *CursorOrdering `json:"ordering,omitempty"`
}

// Initial value of the column from where the streaming should start
type GraphiteFileStoreBucketsStreamCursorValueInput struct {
	BucketID    *string    `json:"bucketID,omitempty"`
	CreatedAt   *time.Time `json:"createdAt,omitempty"`
	FileStoreID *string    `json:"fileStoreID,omitempty"`
	UpdatedAt   *time.Time `json:"updatedAt,omitempty"`
...
type GraphiteFileStoreBucketsUpdates struct {
	// sets the columns of the filtered rows to the given values
	Set *GraphiteFileStoreBucketsSetInput `json:"_set,omitempty"`
	// filter the rows which have to be updated
	Where *GraphiteFileStoreBucketsBoolExp `json:"where"`
}

// columns and relationships of "graphite.file_stores"
type GraphiteFileStores struct {
	CreatedAt     time.Time  `json:"createdAt"`
	ID            string     `json:"id"`
...
type GraphiteFileStoresAggregate struct {
	Aggregate *GraphiteFileStoresAggregateFields `json:"aggregate,omitempty"`
	Nodes     []*GraphiteFileStores              `json:"nodes"`
}

// aggregate fields of "graphite.file_stores"
type GraphiteFileStoresAggregateFields struct {
	Count int64                        `json:"count"`
	Max   *GraphiteFileStoresMaxFields `json:"max,omitempty"`
	Min   *GraphiteFileStoresMinFields `json:"min,omitempty"`
}

// Boolean expression to filter rows from the table "graphite.file_stores". All fields are combined with a logical 'AND'.
type GraphiteFileStoresBoolExp struct {
	And           []*GraphiteFileStoresBoolExp `json:"_and,omitempty"`
	Not           *GraphiteFileStoresBoolExp   `json:"_not,omitempty"`
	Or            []*GraphiteFileStoresBoolExp `json:"_or,omitempty"`
	CreatedAt     *TimestamptzComparisonExp    `json:"createdAt,omitempty"`
	ID            *UUIDComparisonExp           `json:"id,omitempty"`
	LastSyncedAt  *TimestamptzComparisonExp    `json:"lastSyncedAt,omitempty"`
	Name          *StringComparisonExp         `json:"name,omitempty"`
	UpdatedAt     *TimestamptzComparisonExp    `json:"updatedAt,omitempty"`
	UserID        *UUIDComparisonExp           `json:"userID,omitempty"`
	VectorStoreID *StringComparisonExp         `json:"vectorStoreID,omitempty"`
}

// input type for inserting data into table "graphite.file_stores"
type GraphiteFileStoresInsertInput struct {
	CreatedAt     *time.Time `json:"createdAt,omitempty"`
	ID            *string    `json:"id,omitempty"`
	LastSyncedAt  *time.Time `json:"lastSyncedAt,omitempty"`
...
// aggregate max on columns
type GraphiteFileStoresMaxFields struct {
	CreatedAt     *time.Time `json:"createdAt,omitempty"`
	ID            *string    `json:"id,omitempty"`
	LastSyncedAt  *time.Time `json:"lastSyncedAt,omitempty"`
	Name          *string    `json:"name,omitempty"`
...
// aggregate min on columns
type GraphiteFileStoresMinFields struct {
	CreatedAt     *time.Time `json:"createdAt,omitempty"`
	ID            *string    `json:"id,omitempty"`
	LastSyncedAt  *time.Time `json:"lastSyncedAt,omitempty"`
	Name          *string    `json:"name,omitempty"`
...
type GraphiteFileStoresMutationResponse struct {
	// number of rows affected by the mutation
	AffectedRows int64 `json:"affected_rows"`
	// data from the rows affected by the mutation
	Returning []*GraphiteFileStores `json:"returning"`
}

// on_conflict condition type for table "graphite.file_stores"
type GraphiteFileStoresOnConflict struct {
	Constraint    GraphiteFileStoresConstraint     `json:"constraint"`
	UpdateColumns []GraphiteFileStoresUpdateColumn `json:"update_columns"`
	Where         *GraphiteFileStoresBoolExp       `json:"where,omitempty"`
}

// Ordering options when selecting data from "graphite.file_stores".
type GraphiteFileStoresOrderBy struct {
	CreatedAt     *OrderBy `json:"createdAt,omitempty"`
	ID            *OrderBy `json:"id,omitempty"`
	LastSyncedAt  *OrderBy `json:"lastSyncedAt,omitempty"`
	Name          *OrderBy `json:"name,omitempty"`
	UpdatedAt     *OrderBy `json:"updatedAt,omitempty"`
	UserID        *OrderBy `json:"userID,omitempty"`
	VectorStoreID *OrderBy `json:"vectorStoreID,omitempty"`
}

// primary key columns input for table: graphite.file_stores
type GraphiteFileStoresPkColumnsInput struct {
	ID string `json:"id"`
}

// input type for updating data in table "graphite.file_stores"
type GraphiteFileStoresSetInput struct {
	CreatedAt     *time.Time `json:"createdAt,omitempty"`
	ID            *string    `json:"id,omitempty"`
	LastSyncedAt  *time.Time `json:"lastSyncedAt,omitempty"`
	Name          *string    `json:"name,omitempty"`
...
type GraphiteFileStoresStreamCursorInput struct {
	// Stream column input with initial value
	InitialValue *GraphiteFileStoresStreamCursorValueInput `json:"initial_value"`
	// cursor ordering
	Ordering *CursorOrdering `json:"ordering,omitempty"`
}

// Initial value of the column from where the streaming should start
type GraphiteFileStoresStreamCursorValueInput struct {
	CreatedAt     *time.Time `json:"createdAt,omitempty"`
	ID            *string    `json:"id,omitempty"`
	LastSyncedAt  *time.Time `json:"lastSyncedAt,omitempty"`
	Name          *string    `json:"name,omitempty"`
...
type GraphiteFileStoresUpdates struct {
	// sets the columns of the filtered rows to the given values
	Set *GraphiteFileStoresSetInput `json:"_set,omitempty"`
	// filter the rows which have to be updated
	Where *GraphiteFileStoresBoolExp `json:"where"`
}

// columns and relationships of "graphite.files"
type GraphiteFiles struct {
	CreatedAt     time.Time `json:"createdAt"`
...
type GraphiteFilesAggregate struct {
	Aggregate *GraphiteFilesAggregateFields `json:"aggregate,omitempty"`
	Nodes     []*GraphiteFiles              `json:"nodes"`
}

// aggregate fields of "graphite.files"
type GraphiteFilesAggregateFields struct {
	Count int64                   `json:"count"`
	Max   *GraphiteFilesMaxFields `json:"max,omitempty"`
	Min   *GraphiteFilesMinFields `json:"min,omitempty"`
}

// Boolean expression to filter rows from the table "graphite.files". All fields are combined with a logical 'AND'.
type GraphiteFilesBoolExp struct {
	And           []*GraphiteFilesBoolExp   `json:"_and,omitempty"`
	Not           *GraphiteFilesBoolExp     `json:"_not,omitempty"`
	Or            []*GraphiteFilesBoolExp   `json:"_or,omitempty"`
	CreatedAt     *TimestamptzComparisonExp `json:"createdAt,omitempty"`
	Etag          *StringComparisonExp      `json:"etag,omitempty"`
	FileID        *StringComparisonExp      `json:"fileID,omitempty"`
	ID            *UUIDComparisonExp        `json:"id,omitempty"`
	StorageFileID *UUIDComparisonExp        `json:"storageFileID,omitempty"`
	UpdatedAt     *TimestamptzComparisonExp `json:"updatedAt,omitempty"`
}

// input type for inserting data into table "graphite.files"
type GraphiteFilesInsertInput struct {
	CreatedAt     *time.Time `json:"createdAt,omitempty"`
...
// aggregate max on columns
type GraphiteFilesMaxFields struct {
	CreatedAt     *time.Time `json:"createdAt,omitempty"`
	Etag          *string    `json:"etag,omitempty"`
	FileID        *string    `json:"fileID,omitempty"`
	ID            *string    `json:"id,omitempty"`
...
// aggregate min on columns
type GraphiteFilesMinFields struct {
	CreatedAt     *time.Time `json:"createdAt,omitempty"`
	Etag          *string    `json:"etag,omitempty"`
	FileID        *string    `json:"fileID,omitempty"`
	ID            *string    `json:"id,omitempty"`
...
type GraphiteFilesMutationResponse struct {
	// number of rows affected by the mutation
	AffectedRows int64 `json:"affected_rows"`
	// data from the rows affected by the mutation
	Returning []*GraphiteFiles `json:"returning"`
}

// on_conflict condition type for table "graphite.files"
type GraphiteFilesOnConflict struct {
	Constraint    GraphiteFilesConstraint     `json:"constraint"`
	UpdateColumns []GraphiteFilesUpdateColumn `json:"update_columns"`
	Where         *GraphiteFilesBoolExp       `json:"where,omitempty"`
}

// Ordering options when selecting data from "graphite.files".
type GraphiteFilesOrderBy struct {
	CreatedAt     *OrderBy `json:"createdAt,omitempty"`
	Etag          *OrderBy `json:"etag,omitempty"`
	FileID        *OrderBy `json:"fileID,omitempty"`
	ID            *OrderBy `json:"id,omitempty"`
	StorageFileID *OrderBy `json:"storageFileID,omitempty"`
	UpdatedAt     *OrderBy `json:"updatedAt,omitempty"`
}

// primary key columns input for table: graphite.files
type GraphiteFilesPkColumnsInput struct {
	ID string `json:"id"`
}

// input type for updating data in table "graphite.files"
type GraphiteFilesSetInput struct {
	CreatedAt     *time.Time `json:"createdAt,omitempty"`
	Etag          *string    `json:"etag,omitempty"`
	FileID        *string    `json:"fileID,omitempty"`
	ID            *string    `json:"id,omitempty"`
...
type GraphiteFilesStreamCursorInput struct {
	// Stream column input with initial value
	InitialValue *GraphiteFilesStreamCursorValueInput `json:"initial_value"`
	// cursor ordering
	Ordering *CursorOrdering `json:"ordering,omitempty"`
}

// Initial value of the column from where the streaming should start
type GraphiteFilesStreamCursorValueInput struct {
	CreatedAt     *time.Time `json:"createdAt,omitempty"`
	Etag          *string    `json:"etag,omitempty"`
	FileID        *string    `json:"fileID,omitempty"`
	ID            *string    `json:"id,omitempty"`
...
type GraphiteFilesUpdates struct {
	// sets the columns of the filtered rows to the given values
	Set *GraphiteFilesSetInput `json:"_set,omitempty"`
	// filter the rows which have to be updated
	Where *GraphiteFilesBoolExp `json:"where"`
}

// columns and relationships of "graphite.sessions"
type GraphiteSessions struct {
	AssistantID *string   `json:"assistantID,omitempty"`
	CreatedAt   time.Time `json:"createdAt"`
	ID          string    `json:"id"`
...
type GraphiteSessionsAggregate struct {
	Aggregate *GraphiteSessionsAggregateFields `json:"aggregate,omitempty"`
	Nodes     []*GraphiteSessions              `json:"nodes"`
}

// aggregate fields of "graphite.sessions"
type GraphiteSessionsAggregateFields struct {
	Count int64                      `json:"count"`
	Max   *GraphiteSessionsMaxFields `json:"max,omitempty"`
	Min   *GraphiteSessionsMinFields `json:"min,omitempty"`
}

// Boolean expression to filter rows from the table "graphite.sessions". All fields are combined with a logical 'AND'.
type GraphiteSessionsBoolExp struct {
	And         []*GraphiteSessionsBoolExp `json:"_and,omitempty"`
	Not         *GraphiteSessionsBoolExp   `json:"_not,omitempty"`
	Or          []*GraphiteSessionsBoolExp `json:"_or,omitempty"`
	AssistantID *StringComparisonExp       `json:"assistantID,omitempty"`
	CreatedAt   *TimestamptzComparisonExp  `json:"createdAt,omitempty"`
	ID          *UUIDComparisonExp         `json:"id,omitempty"`
...
type GraphiteSessionsInsertInput struct {
	AssistantID *string    `json:"assistantID,omitempty"`
	CreatedAt   *time.Time `json:"createdAt,omitempty"`
	ID          *string    `json:"id,omitempty"`
	SessionID   *string    `json:"sessionID,omitempty"`
...
// aggregate max on columns
type GraphiteSessionsMaxFields struct {
	AssistantID *string    `json:"assistantID,omitempty"`
	CreatedAt   *time.Time `json:"createdAt,omitempty"`
	ID          *string    `json:"id,omitempty"`
	SessionID   *string    `json:"sessionID,omitempty"`
...
// aggregate min on columns
type GraphiteSessionsMinFields struct {
	AssistantID *string    `json:"assistantID,omitempty"`
	CreatedAt   *time.Time `json:"createdAt,omitempty"`
	ID          *string    `json:"id,omitempty"`
	SessionID   *string    `json:"sessionID,omitempty"`
...
type GraphiteSessionsMutationResponse struct {
	// number of rows affected by the mutation
	AffectedRows int64 `json:"affected_rows"`
	// data from the rows affected by the mutation
	Returning []*GraphiteSessions `json:"returning"`
}

// on_conflict condition type for table "graphite.sessions"
type GraphiteSessionsOnConflict struct {
	Constraint    GraphiteSessionsConstraint     `json:"constraint"`
	UpdateColumns []GraphiteSessionsUpdateColumn `json:"update_columns"`
	Where         *GraphiteSessionsBoolExp       `json:"where,omitempty"`
}

// Ordering options when selecting data from "graphite.sessions".
type GraphiteSessionsOrderBy struct {
	AssistantID *OrderBy `json:"assistantID,omitempty"`
	CreatedAt   *OrderBy `json:"createdAt,omitempty"`
	ID          *OrderBy `json:"id,omitempty"`
...
type GraphiteSessionsPkColumnsInput struct {
	ID string `json:"id"`
}

// input type for updating data in table "graphite.sessions"
type GraphiteSessionsSetInput struct {
	AssistantID *string    `json:"assistantID,omitempty"`
	CreatedAt   *time.Time `json:"createdAt,omitempty"`
	ID          *string    `json:"id,omitempty"`
	SessionID   *string    `json:"sessionID,omitempty"`
...
type GraphiteSessionsStreamCursorInput struct {
	// Stream column input with initial value
	InitialValue *GraphiteSessionsStreamCursorValueInput `json:"initial_value"`
	// cursor ordering
	Ordering *CursorOrdering `json:"ordering,omitempty"`
}

// Initial value of the column from where the streaming should start
type GraphiteSessionsStreamCursorValueInput struct {
	AssistantID *string    `json:"assistantID,omitempty"`
	CreatedAt   *time.Time `json:"createdAt,omitempty"`
	ID          *string    `json:"id,omitempty"`
	SessionID   *string    `json:"sessionID,omitempty"`
...
type GraphiteSessionsUpdates struct {
	// sets the columns of the filtered rows to the given values
	Set *GraphiteSessionsSetInput `json:"_set,omitempty"`
	// filter the rows which have to be updated
	Where *GraphiteSessionsBoolExp `json:"where"`
}
...
type SubscriptionRoot struct {
	...
	GraphiteAssistant *GraphiteAssistants `json:"_graphiteAssistant,omitempty"`
	// fetch aggregated fields from the table: "graphite.assistants"
	GraphiteAssistantAggregate *GraphiteAssistantsAggregate `json:"_graphiteAssistantAggregate"`
	// fetch data from the table: "graphite.assistant_file_stores" using primary key columns
	GraphiteAssistantFileStore *GraphiteAssistantFileStores `json:"_graphiteAssistantFileStore,omitempty"`
	// fetch aggregated fields from the table: "graphite.assistant_file_stores"
	GraphiteAssistantFileStoreAggregate *GraphiteAssistantFileStoresAggregate `json:"_graphiteAssistantFileStoreAggregate"`
	// fetch data from the table in a streaming manner: "graphite.assistant_file_stores"
	GraphiteAssistantFileStoreStream []*GraphiteAssistantFileStores `json:"_graphiteAssistantFileStoreStream"`
	// fetch data from the table: "graphite.assistant_file_stores"
	GraphiteAssistantFileStores []*GraphiteAssistantFileStores `json:"_graphiteAssistantFileStores"`
	// fetch data from the table in a streaming manner: "graphite.assistants"
	GraphiteAssistantStream []*GraphiteAssistants `json:"_graphiteAssistantStream"`
	// fetch data from the table: "graphite.assistants"
	GraphiteAssistants []*GraphiteAssistants `json:"_graphiteAssistants"`
	// fetch data from the table: "graphite.files" using primary key columns
	GraphiteFile *GraphiteFiles `json:"_graphiteFile,omitempty"`
	// fetch aggregated fields from the table: "graphite.files"
	GraphiteFileAggregate *GraphiteFilesAggregate `json:"_graphiteFileAggregate"`
	// fetch data from the table: "graphite.file_stores" using primary key columns
	GraphiteFileStore *GraphiteFileStores `json:"_graphiteFileStore,omitempty"`
	// fetch aggregated fields from the table: "graphite.file_stores"
	GraphiteFileStoreAggregate *GraphiteFileStoresAggregate `json:"_graphiteFileStoreAggregate"`
	// fetch data from the table: "graphite.file_store_buckets" using primary key columns
	GraphiteFileStoreBucket *GraphiteFileStoreBuckets `json:"_graphiteFileStoreBucket,omitempty"`
	// fetch aggregated fields from the table: "graphite.file_store_buckets"
	GraphiteFileStoreBucketAggregate *GraphiteFileStoreBucketsAggregate `json:"_graphiteFileStoreBucketAggregate"`
	// fetch data from the table in a streaming manner: "graphite.file_store_buckets"
	GraphiteFileStoreBucketStream []*GraphiteFileStoreBuckets `json:"_graphiteFileStoreBucketStream"`
	// fetch data from the table: "graphite.file_store_buckets"
	GraphiteFileStoreBuckets []*GraphiteFileStoreBuckets `json:"_graphiteFileStoreBuckets"`
	// fetch data from the table in a streaming manner: "graphite.file_stores"
	GraphiteFileStoreStream []*GraphiteFileStores `json:"_graphiteFileStoreStream"`
	// fetch data from the table: "graphite.file_stores"
	GraphiteFileStores []*GraphiteFileStores `json:"_graphiteFileStores"`
	// fetch data from the table in a streaming manner: "graphite.files"
	GraphiteFileStream []*GraphiteFiles `json:"_graphiteFileStream"`
	// fetch data from the table: "graphite.files"
	GraphiteFiles []*GraphiteFiles `json:"_graphiteFiles"`
	// fetch data from the table: "graphite.sessions" using primary key columns
	GraphiteSession *GraphiteSessions `json:"_graphiteSession,omitempty"`
	// fetch aggregated fields from the table: "graphite.sessions"
	GraphiteSessionAggregate *GraphiteSessionsAggregate `json:"_graphiteSessionAggregate"`
	// fetch data from the table in a streaming manner: "graphite.sessions"
	GraphiteSessionStream []*GraphiteSessions `json:"_graphiteSessionStream"`
	// fetch data from the table: "graphite.sessions"
	GraphiteSessions []*GraphiteSessions `json:"_graphiteSessions"`
...
type GraphiteAssistantFileStoresConstraint string

const (
	// unique or primary key constraint on columns "assistant_id", "file_store_id"
	GraphiteAssistantFileStoresConstraintAssistantFileStoresPkey GraphiteAssistantFileStoresConstraint = "assistant_file_stores_pkey"
)

var AllGraphiteAssistantFileStoresConstraint = []GraphiteAssistantFileStoresConstraint{
	GraphiteAssistantFileStoresConstraintAssistantFileStoresPkey,
}

func (e GraphiteAssistantFileStoresConstraint) IsValid() bool {
	switch e {
	case GraphiteAssistantFileStoresConstraintAssistantFileStoresPkey:
		return true
	}
	return false
}

func (e GraphiteAssistantFileStoresConstraint) String() string {
	return string(e)
}

func (e *GraphiteAssistantFileStoresConstraint) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = GraphiteAssistantFileStoresConstraint(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid _graphiteAssistantFileStores_constraint", str)
	}
	return nil
}

func (e GraphiteAssistantFileStoresConstraint) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *GraphiteAssistantFileStoresConstraint) UnmarshalJSON(b []byte) error {
...
func (e GraphiteAssistantFileStoresConstraint) MarshalJSON() ([]byte, error) {
...
type GraphiteAssistantFileStoresSelectColumn string

const (
	// column name
	GraphiteAssistantFileStoresSelectColumnAssistantID GraphiteAssistantFileStoresSelectColumn = "assistantID"
	// column name
	GraphiteAssistantFileStoresSelectColumnCreatedAt GraphiteAssistantFileStoresSelectColumn = "createdAt"
	// column name
	GraphiteAssistantFileStoresSelectColumnFileStoreID GraphiteAssistantFileStoresSelectColumn = "fileStoreID"
	// column name
	GraphiteAssistantFileStoresSelectColumnUpdatedAt GraphiteAssistantFileStoresSelectColumn = "updatedAt"
)

var AllGraphiteAssistantFileStoresSelectColumn = []GraphiteAssistantFileStoresSelectColumn{
	GraphiteAssistantFileStoresSelectColumnAssistantID,
	GraphiteAssistantFileStoresSelectColumnCreatedAt,
	GraphiteAssistantFileStoresSelectColumnFileStoreID,
	GraphiteAssistantFileStoresSelectColumnUpdatedAt,
}

func (e GraphiteAssistantFileStoresSelectColumn) IsValid() bool {
	switch e {
	case GraphiteAssistantFileStoresSelectColumnAssistantID, GraphiteAssistantFileStoresSelectColumnCreatedAt, GraphiteAssistantFileStoresSelectColumnFileStoreID, GraphiteAssistantFileStoresSelectColumnUpdatedAt:
		return true
	}
	return false
}

func (e GraphiteAssistantFileStoresSelectColumn) String() string {
	return string(e)
}

func (e *GraphiteAssistantFileStoresSelectColumn) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = GraphiteAssistantFileStoresSelectColumn(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid _graphiteAssistantFileStores_select_column", str)
	}
	return nil
}

func (e GraphiteAssistantFileStoresSelectColumn) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *GraphiteAssistantFileStoresSelectColumn) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e GraphiteAssistantFileStoresSelectColumn) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
...
type GraphiteAssistantFileStoresUpdateColumn string

const (
	// column name
	GraphiteAssistantFileStoresUpdateColumnAssistantID GraphiteAssistantFileStoresUpdateColumn = "assistantID"
	// column name
	GraphiteAssistantFileStoresUpdateColumnCreatedAt GraphiteAssistantFileStoresUpdateColumn = "createdAt"
	// column name
	GraphiteAssistantFileStoresUpdateColumnFileStoreID GraphiteAssistantFileStoresUpdateColumn = "fileStoreID"
	// column name
	GraphiteAssistantFileStoresUpdateColumnUpdatedAt GraphiteAssistantFileStoresUpdateColumn = "updatedAt"
)

var AllGraphiteAssistantFileStoresUpdateColumn = []GraphiteAssistantFileStoresUpdateColumn{
	GraphiteAssistantFileStoresUpdateColumnAssistantID,
	GraphiteAssistantFileStoresUpdateColumnCreatedAt,
	GraphiteAssistantFileStoresUpdateColumnFileStoreID,
	GraphiteAssistantFileStoresUpdateColumnUpdatedAt,
}

func (e GraphiteAssistantFileStoresUpdateColumn) IsValid() bool {
	switch e {
	case GraphiteAssistantFileStoresUpdateColumnAssistantID, GraphiteAssistantFileStoresUpdateColumnCreatedAt, GraphiteAssistantFileStoresUpdateColumnFileStoreID, GraphiteAssistantFileStoresUpdateColumnUpdatedAt:
		return true
	}
	return false
}

func (e GraphiteAssistantFileStoresUpdateColumn) String() string {
	return string(e)
}

func (e *GraphiteAssistantFileStoresUpdateColumn) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = GraphiteAssistantFileStoresUpdateColumn(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid _graphiteAssistantFileStores_update_column", str)
	}
	return nil
}

func (e GraphiteAssistantFileStoresUpdateColumn) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *GraphiteAssistantFileStoresUpdateColumn) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e GraphiteAssistantFileStoresUpdateColumn) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
...
type GraphiteAssistantsConstraint string

const (
	// unique or primary key constraint on columns "assistant_id"
	GraphiteAssistantsConstraintAssistantsAssistantIDKey GraphiteAssistantsConstraint = "assistants_assistant_id_key"
	// unique or primary key constraint on columns "id"
	GraphiteAssistantsConstraintAssistantsPkey GraphiteAssistantsConstraint = "assistants_pkey"
)

var AllGraphiteAssistantsConstraint = []GraphiteAssistantsConstraint{
	GraphiteAssistantsConstraintAssistantsAssistantIDKey,
	GraphiteAssistantsConstraintAssistantsPkey,
}

func (e GraphiteAssistantsConstraint) IsValid() bool {
	switch e {
	case GraphiteAssistantsConstraintAssistantsAssistantIDKey, GraphiteAssistantsConstraintAssistantsPkey:
		return true
	}
	return false
}

func (e GraphiteAssistantsConstraint) String() string {
	return string(e)
}

func (e *GraphiteAssistantsConstraint) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = GraphiteAssistantsConstraint(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid _graphiteAssistants_constraint", str)
	}
	return nil
}

func (e GraphiteAssistantsConstraint) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *GraphiteAssistantsConstraint) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e GraphiteAssistantsConstraint) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
...
type GraphiteAssistantsSelectColumn string

const (
	// column name
	GraphiteAssistantsSelectColumnAssistantID GraphiteAssistantsSelectColumn = "assistantID"
	// column name
	GraphiteAssistantsSelectColumnCreatedAt GraphiteAssistantsSelectColumn = "createdAt"
	// column name
	GraphiteAssistantsSelectColumnData GraphiteAssistantsSelectColumn = "data"
	// column name
	GraphiteAssistantsSelectColumnID GraphiteAssistantsSelectColumn = "id"
	// column name
	GraphiteAssistantsSelectColumnUpdatedAt GraphiteAssistantsSelectColumn = "updatedAt"
	// column name
	GraphiteAssistantsSelectColumnUserID GraphiteAssistantsSelectColumn = "user_id"
)

var AllGraphiteAssistantsSelectColumn = []GraphiteAssistantsSelectColumn{
	GraphiteAssistantsSelectColumnAssistantID,
	GraphiteAssistantsSelectColumnCreatedAt,
	GraphiteAssistantsSelectColumnData,
	GraphiteAssistantsSelectColumnID,
	GraphiteAssistantsSelectColumnUpdatedAt,
	GraphiteAssistantsSelectColumnUserID,
}

func (e GraphiteAssistantsSelectColumn) IsValid() bool {
	switch e {
	case GraphiteAssistantsSelectColumnAssistantID, GraphiteAssistantsSelectColumnCreatedAt, GraphiteAssistantsSelectColumnData, GraphiteAssistantsSelectColumnID, GraphiteAssistantsSelectColumnUpdatedAt, GraphiteAssistantsSelectColumnUserID:
		return true
	}
	return false
}

func (e GraphiteAssistantsSelectColumn) String() string {
	return string(e)
}

func (e *GraphiteAssistantsSelectColumn) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = GraphiteAssistantsSelectColumn(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid _graphiteAssistants_select_column", str)
	}
	return nil
}

func (e GraphiteAssistantsSelectColumn) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *GraphiteAssistantsSelectColumn) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e GraphiteAssistantsSelectColumn) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
...
type GraphiteAssistantsUpdateColumn string

const (
	// column name
	GraphiteAssistantsUpdateColumnAssistantID GraphiteAssistantsUpdateColumn = "assistantID"
	// column name
	GraphiteAssistantsUpdateColumnCreatedAt GraphiteAssistantsUpdateColumn = "createdAt"
	// column name
	GraphiteAssistantsUpdateColumnData GraphiteAssistantsUpdateColumn = "data"
	// column name
	GraphiteAssistantsUpdateColumnID GraphiteAssistantsUpdateColumn = "id"
	// column name
	GraphiteAssistantsUpdateColumnUpdatedAt GraphiteAssistantsUpdateColumn = "updatedAt"
	// column name
	GraphiteAssistantsUpdateColumnUserID GraphiteAssistantsUpdateColumn = "user_id"
)

var AllGraphiteAssistantsUpdateColumn = []GraphiteAssistantsUpdateColumn{
	GraphiteAssistantsUpdateColumnAssistantID,
	GraphiteAssistantsUpdateColumnCreatedAt,
	GraphiteAssistantsUpdateColumnData,
	GraphiteAssistantsUpdateColumnID,
	GraphiteAssistantsUpdateColumnUpdatedAt,
	GraphiteAssistantsUpdateColumnUserID,
}

func (e GraphiteAssistantsUpdateColumn) IsValid() bool {
	switch e {
	case GraphiteAssistantsUpdateColumnAssistantID, GraphiteAssistantsUpdateColumnCreatedAt, GraphiteAssistantsUpdateColumnData, GraphiteAssistantsUpdateColumnID, GraphiteAssistantsUpdateColumnUpdatedAt, GraphiteAssistantsUpdateColumnUserID:
		return true
	}
	return false
}

func (e GraphiteAssistantsUpdateColumn) String() string {
	return string(e)
}

func (e *GraphiteAssistantsUpdateColumn) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = GraphiteAssistantsUpdateColumn(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid _graphiteAssistants_update_column", str)
	}
	return nil
}

func (e GraphiteAssistantsUpdateColumn) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *GraphiteAssistantsUpdateColumn) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e GraphiteAssistantsUpdateColumn) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
...
type GraphiteFileStoreBucketsConstraint string

const (
	// unique or primary key constraint on columns "bucket_id", "file_store_id"
	GraphiteFileStoreBucketsConstraintFileStoreBucketsPkey GraphiteFileStoreBucketsConstraint = "file_store_buckets_pkey"
)

var AllGraphiteFileStoreBucketsConstraint = []GraphiteFileStoreBucketsConstraint{
	GraphiteFileStoreBucketsConstraintFileStoreBucketsPkey,
}

func (e GraphiteFileStoreBucketsConstraint) IsValid() bool {
	switch e {
	case GraphiteFileStoreBucketsConstraintFileStoreBucketsPkey:
		return true
	}
	return false
}

func (e GraphiteFileStoreBucketsConstraint) String() string {
	return string(e)
}

func (e *GraphiteFileStoreBucketsConstraint) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = GraphiteFileStoreBucketsConstraint(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid _graphiteFileStoreBuckets_constraint", str)
	}
	return nil
}

func (e GraphiteFileStoreBucketsConstraint) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *GraphiteFileStoreBucketsConstraint) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e GraphiteFileStoreBucketsConstraint) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
...
type GraphiteFileStoreBucketsSelectColumn string

const (
	// column name
	GraphiteFileStoreBucketsSelectColumnBucketID GraphiteFileStoreBucketsSelectColumn = "bucketID"
	// column name
	GraphiteFileStoreBucketsSelectColumnCreatedAt GraphiteFileStoreBucketsSelectColumn = "createdAt"
	// column name
	GraphiteFileStoreBucketsSelectColumnFileStoreID GraphiteFileStoreBucketsSelectColumn = "fileStoreID"
	// column name
	GraphiteFileStoreBucketsSelectColumnUpdatedAt GraphiteFileStoreBucketsSelectColumn = "updatedAt"
)

var AllGraphiteFileStoreBucketsSelectColumn = []GraphiteFileStoreBucketsSelectColumn{
	GraphiteFileStoreBucketsSelectColumnBucketID,
	GraphiteFileStoreBucketsSelectColumnCreatedAt,
	GraphiteFileStoreBucketsSelectColumnFileStoreID,
	GraphiteFileStoreBucketsSelectColumnUpdatedAt,
}

func (e GraphiteFileStoreBucketsSelectColumn) IsValid() bool {
	switch e {
	case GraphiteFileStoreBucketsSelectColumnBucketID, GraphiteFileStoreBucketsSelectColumnCreatedAt, GraphiteFileStoreBucketsSelectColumnFileStoreID, GraphiteFileStoreBucketsSelectColumnUpdatedAt:
		return true
	}
	return false
}

func (e GraphiteFileStoreBucketsSelectColumn) String() string {
	return string(e)
}

func (e *GraphiteFileStoreBucketsSelectColumn) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = GraphiteFileStoreBucketsSelectColumn(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid _graphiteFileStoreBuckets_select_column", str)
	}
	return nil
}

func (e GraphiteFileStoreBucketsSelectColumn) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *GraphiteFileStoreBucketsSelectColumn) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e GraphiteFileStoreBucketsSelectColumn) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
...
type GraphiteFileStoreBucketsUpdateColumn string

const (
	// column name
	GraphiteFileStoreBucketsUpdateColumnBucketID GraphiteFileStoreBucketsUpdateColumn = "bucketID"
	// column name
	GraphiteFileStoreBucketsUpdateColumnCreatedAt GraphiteFileStoreBucketsUpdateColumn = "createdAt"
	// column name
	GraphiteFileStoreBucketsUpdateColumnFileStoreID GraphiteFileStoreBucketsUpdateColumn = "fileStoreID"
	// column name
	GraphiteFileStoreBucketsUpdateColumnUpdatedAt GraphiteFileStoreBucketsUpdateColumn = "updatedAt"
)

var AllGraphiteFileStoreBucketsUpdateColumn = []GraphiteFileStoreBucketsUpdateColumn{
	GraphiteFileStoreBucketsUpdateColumnBucketID,
	GraphiteFileStoreBucketsUpdateColumnCreatedAt,
	GraphiteFileStoreBucketsUpdateColumnFileStoreID,
	GraphiteFileStoreBucketsUpdateColumnUpdatedAt,
}

func (e GraphiteFileStoreBucketsUpdateColumn) IsValid() bool {
	switch e {
	case GraphiteFileStoreBucketsUpdateColumnBucketID, GraphiteFileStoreBucketsUpdateColumnCreatedAt, GraphiteFileStoreBucketsUpdateColumnFileStoreID, GraphiteFileStoreBucketsUpdateColumnUpdatedAt:
		return true
	}
	return false
}

func (e GraphiteFileStoreBucketsUpdateColumn) String() string {
	return string(e)
}

func (e *GraphiteFileStoreBucketsUpdateColumn) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = GraphiteFileStoreBucketsUpdateColumn(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid _graphiteFileStoreBuckets_update_column", str)
	}
	return nil
}

func (e GraphiteFileStoreBucketsUpdateColumn) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *GraphiteFileStoreBucketsUpdateColumn) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e GraphiteFileStoreBucketsUpdateColumn) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
...
type GraphiteFileStoresConstraint string

const (
	// unique or primary key constraint on columns "id"
	GraphiteFileStoresConstraintFileStoresPkey GraphiteFileStoresConstraint = "file_stores_pkey"
	// unique or primary key constraint on columns "vector_store_id"
	GraphiteFileStoresConstraintFileStoresVectorStoreIDKey GraphiteFileStoresConstraint = "file_stores_vector_store_id_key"
)

var AllGraphiteFileStoresConstraint = []GraphiteFileStoresConstraint{
	GraphiteFileStoresConstraintFileStoresPkey,
	GraphiteFileStoresConstraintFileStoresVectorStoreIDKey,
}

func (e GraphiteFileStoresConstraint) IsValid() bool {
	switch e {
	case GraphiteFileStoresConstraintFileStoresPkey, GraphiteFileStoresConstraintFileStoresVectorStoreIDKey:
		return true
	}
	return false
}

func (e GraphiteFileStoresConstraint) String() string {
	return string(e)
}

func (e *GraphiteFileStoresConstraint) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = GraphiteFileStoresConstraint(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid _graphiteFileStores_constraint", str)
	}
	return nil
}

func (e GraphiteFileStoresConstraint) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *GraphiteFileStoresConstraint) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e GraphiteFileStoresConstraint) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
...
type GraphiteFileStoresSelectColumn string

const (
	// column name
	GraphiteFileStoresSelectColumnCreatedAt GraphiteFileStoresSelectColumn = "createdAt"
	// column name
	GraphiteFileStoresSelectColumnID GraphiteFileStoresSelectColumn = "id"
	// column name
	GraphiteFileStoresSelectColumnLastSyncedAt GraphiteFileStoresSelectColumn = "lastSyncedAt"
	// column name
	GraphiteFileStoresSelectColumnName GraphiteFileStoresSelectColumn = "name"
	// column name
	GraphiteFileStoresSelectColumnUpdatedAt GraphiteFileStoresSelectColumn = "updatedAt"
	// column name
	GraphiteFileStoresSelectColumnUserID GraphiteFileStoresSelectColumn = "userID"
	// column name
	GraphiteFileStoresSelectColumnVectorStoreID GraphiteFileStoresSelectColumn = "vectorStoreID"
)

var AllGraphiteFileStoresSelectColumn = []GraphiteFileStoresSelectColumn{
	GraphiteFileStoresSelectColumnCreatedAt,
	GraphiteFileStoresSelectColumnID,
	GraphiteFileStoresSelectColumnLastSyncedAt,
	GraphiteFileStoresSelectColumnName,
	GraphiteFileStoresSelectColumnUpdatedAt,
	GraphiteFileStoresSelectColumnUserID,
	GraphiteFileStoresSelectColumnVectorStoreID,
}

func (e GraphiteFileStoresSelectColumn) IsValid() bool {
	switch e {
	case GraphiteFileStoresSelectColumnCreatedAt, GraphiteFileStoresSelectColumnID, GraphiteFileStoresSelectColumnLastSyncedAt, GraphiteFileStoresSelectColumnName, GraphiteFileStoresSelectColumnUpdatedAt, GraphiteFileStoresSelectColumnUserID, GraphiteFileStoresSelectColumnVectorStoreID:
		return true
	}
	return false
}

func (e GraphiteFileStoresSelectColumn) String() string {
	return string(e)
}

func (e *GraphiteFileStoresSelectColumn) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = GraphiteFileStoresSelectColumn(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid _graphiteFileStores_select_column", str)
	}
	return nil
}

func (e GraphiteFileStoresSelectColumn) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *GraphiteFileStoresSelectColumn) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e GraphiteFileStoresSelectColumn) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
...
type GraphiteFileStoresUpdateColumn string

const (
	// column name
	GraphiteFileStoresUpdateColumnCreatedAt GraphiteFileStoresUpdateColumn = "createdAt"
	// column name
	GraphiteFileStoresUpdateColumnID GraphiteFileStoresUpdateColumn = "id"
	// column name
	GraphiteFileStoresUpdateColumnLastSyncedAt GraphiteFileStoresUpdateColumn = "lastSyncedAt"
	// column name
	GraphiteFileStoresUpdateColumnName GraphiteFileStoresUpdateColumn = "name"
	// column name
	GraphiteFileStoresUpdateColumnUpdatedAt GraphiteFileStoresUpdateColumn = "updatedAt"
	// column name
	GraphiteFileStoresUpdateColumnUserID GraphiteFileStoresUpdateColumn = "userID"
	// column name
	GraphiteFileStoresUpdateColumnVectorStoreID GraphiteFileStoresUpdateColumn = "vectorStoreID"
)

var AllGraphiteFileStoresUpdateColumn = []GraphiteFileStoresUpdateColumn{
	GraphiteFileStoresUpdateColumnCreatedAt,
	GraphiteFileStoresUpdateColumnID,
	GraphiteFileStoresUpdateColumnLastSyncedAt,
	GraphiteFileStoresUpdateColumnName,
	GraphiteFileStoresUpdateColumnUpdatedAt,
	GraphiteFileStoresUpdateColumnUserID,
	GraphiteFileStoresUpdateColumnVectorStoreID,
}

func (e GraphiteFileStoresUpdateColumn) IsValid() bool {
	switch e {
	case GraphiteFileStoresUpdateColumnCreatedAt, GraphiteFileStoresUpdateColumnID, GraphiteFileStoresUpdateColumnLastSyncedAt, GraphiteFileStoresUpdateColumnName, GraphiteFileStoresUpdateColumnUpdatedAt, GraphiteFileStoresUpdateColumnUserID, GraphiteFileStoresUpdateColumnVectorStoreID:
		return true
	}
	return false
}

func (e GraphiteFileStoresUpdateColumn) String() string {
	return string(e)
}

func (e *GraphiteFileStoresUpdateColumn) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = GraphiteFileStoresUpdateColumn(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid _graphiteFileStores_update_column", str)
	}
	return nil
}

func (e GraphiteFileStoresUpdateColumn) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *GraphiteFileStoresUpdateColumn) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e GraphiteFileStoresUpdateColumn) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
...
type GraphiteFilesConstraint string

const (
	// unique or primary key constraint on columns "file_id"
	GraphiteFilesConstraintFilesFileIDKey GraphiteFilesConstraint = "files_file_id_key"
	// unique or primary key constraint on columns "id"
	GraphiteFilesConstraintFilesPkey GraphiteFilesConstraint = "files_pkey"
	// unique or primary key constraint on columns "storage_file_id"
	GraphiteFilesConstraintFilesStorageFileIDKey GraphiteFilesConstraint = "files_storage_file_id_key"
)

var AllGraphiteFilesConstraint = []GraphiteFilesConstraint{
	GraphiteFilesConstraintFilesFileIDKey,
	GraphiteFilesConstraintFilesPkey,
	GraphiteFilesConstraintFilesStorageFileIDKey,
}

func (e GraphiteFilesConstraint) IsValid() bool {
	switch e {
	case GraphiteFilesConstraintFilesFileIDKey, GraphiteFilesConstraintFilesPkey, GraphiteFilesConstraintFilesStorageFileIDKey:
		return true
	}
	return false
}

func (e GraphiteFilesConstraint) String() string {
	return string(e)
}

func (e *GraphiteFilesConstraint) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = GraphiteFilesConstraint(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid _graphiteFiles_constraint", str)
	}
	return nil
}

func (e GraphiteFilesConstraint) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *GraphiteFilesConstraint) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e GraphiteFilesConstraint) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
...
type GraphiteFilesSelectColumn string

const (
	// column name
	GraphiteFilesSelectColumnCreatedAt GraphiteFilesSelectColumn = "createdAt"
	// column name
	GraphiteFilesSelectColumnEtag GraphiteFilesSelectColumn = "etag"
	// column name
	GraphiteFilesSelectColumnFileID GraphiteFilesSelectColumn = "fileID"
	// column name
	GraphiteFilesSelectColumnID GraphiteFilesSelectColumn = "id"
	// column name
	GraphiteFilesSelectColumnStorageFileID GraphiteFilesSelectColumn = "storageFileID"
	// column name
	GraphiteFilesSelectColumnUpdatedAt GraphiteFilesSelectColumn = "updatedAt"
)

var AllGraphiteFilesSelectColumn = []GraphiteFilesSelectColumn{
	GraphiteFilesSelectColumnCreatedAt,
	GraphiteFilesSelectColumnEtag,
	GraphiteFilesSelectColumnFileID,
	GraphiteFilesSelectColumnID,
	GraphiteFilesSelectColumnStorageFileID,
	GraphiteFilesSelectColumnUpdatedAt,
}

func (e GraphiteFilesSelectColumn) IsValid() bool {
	switch e {
	case GraphiteFilesSelectColumnCreatedAt, GraphiteFilesSelectColumnEtag, GraphiteFilesSelectColumnFileID, GraphiteFilesSelectColumnID, GraphiteFilesSelectColumnStorageFileID, GraphiteFilesSelectColumnUpdatedAt:
		return true
	}
	return false
}

func (e GraphiteFilesSelectColumn) String() string {
	return string(e)
}

func (e *GraphiteFilesSelectColumn) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = GraphiteFilesSelectColumn(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid _graphiteFiles_select_column", str)
	}
	return nil
}

func (e GraphiteFilesSelectColumn) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *GraphiteFilesSelectColumn) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e GraphiteFilesSelectColumn) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
...
type GraphiteFilesUpdateColumn string

const (
	// column name
	GraphiteFilesUpdateColumnCreatedAt GraphiteFilesUpdateColumn = "createdAt"
	// column name
	GraphiteFilesUpdateColumnEtag GraphiteFilesUpdateColumn = "etag"
	// column name
	GraphiteFilesUpdateColumnFileID GraphiteFilesUpdateColumn = "fileID"
	// column name
	GraphiteFilesUpdateColumnID GraphiteFilesUpdateColumn = "id"
	// column name
	GraphiteFilesUpdateColumnStorageFileID GraphiteFilesUpdateColumn = "storageFileID"
	// column name
	GraphiteFilesUpdateColumnUpdatedAt GraphiteFilesUpdateColumn = "updatedAt"
)

var AllGraphiteFilesUpdateColumn = []GraphiteFilesUpdateColumn{
	GraphiteFilesUpdateColumnCreatedAt,
	GraphiteFilesUpdateColumnEtag,
	GraphiteFilesUpdateColumnFileID,
	GraphiteFilesUpdateColumnID,
	GraphiteFilesUpdateColumnStorageFileID,
	GraphiteFilesUpdateColumnUpdatedAt,
}

func (e GraphiteFilesUpdateColumn) IsValid() bool {
	switch e {
	case GraphiteFilesUpdateColumnCreatedAt, GraphiteFilesUpdateColumnEtag, GraphiteFilesUpdateColumnFileID, GraphiteFilesUpdateColumnID, GraphiteFilesUpdateColumnStorageFileID, GraphiteFilesUpdateColumnUpdatedAt:
		return true
	}
	return false
}

func (e GraphiteFilesUpdateColumn) String() string {
	return string(e)
}

func (e *GraphiteFilesUpdateColumn) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = GraphiteFilesUpdateColumn(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid _graphiteFiles_update_column", str)
	}
	return nil
}

func (e GraphiteFilesUpdateColumn) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *GraphiteFilesUpdateColumn) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e GraphiteFilesUpdateColumn) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
...
type GraphiteSessionsConstraint string

const (
	// unique or primary key constraint on columns "id"
	GraphiteSessionsConstraintSessionsPkey GraphiteSessionsConstraint = "sessions_pkey"
	// unique or primary key constraint on columns "session_id"
	GraphiteSessionsConstraintSessionsSessionIDKey GraphiteSessionsConstraint = "sessions_session_id_key"
)

var AllGraphiteSessionsConstraint = []GraphiteSessionsConstraint{
	GraphiteSessionsConstraintSessionsPkey,
	GraphiteSessionsConstraintSessionsSessionIDKey,
}

func (e GraphiteSessionsConstraint) IsValid() bool {
	switch e {
	case GraphiteSessionsConstraintSessionsPkey, GraphiteSessionsConstraintSessionsSessionIDKey:
		return true
	}
	return false
}

func (e GraphiteSessionsConstraint) String() string {
	return string(e)
}

func (e *GraphiteSessionsConstraint) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = GraphiteSessionsConstraint(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid _graphiteSessions_constraint", str)
	}
	return nil
}

func (e GraphiteSessionsConstraint) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *GraphiteSessionsConstraint) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e GraphiteSessionsConstraint) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
...
type GraphiteSessionsSelectColumn string

const (
	// column name
	GraphiteSessionsSelectColumnAssistantID GraphiteSessionsSelectColumn = "assistantID"
	// column name
	GraphiteSessionsSelectColumnCreatedAt GraphiteSessionsSelectColumn = "createdAt"
	// column name
	GraphiteSessionsSelectColumnID GraphiteSessionsSelectColumn = "id"
	// column name
	GraphiteSessionsSelectColumnSessionID GraphiteSessionsSelectColumn = "sessionID"
	// column name
	GraphiteSessionsSelectColumnUpdatedAt GraphiteSessionsSelectColumn = "updatedAt"
	// column name
	GraphiteSessionsSelectColumnUserID GraphiteSessionsSelectColumn = "userID"
)

var AllGraphiteSessionsSelectColumn = []GraphiteSessionsSelectColumn{
	GraphiteSessionsSelectColumnAssistantID,
	GraphiteSessionsSelectColumnCreatedAt,
	GraphiteSessionsSelectColumnID,
	GraphiteSessionsSelectColumnSessionID,
	GraphiteSessionsSelectColumnUpdatedAt,
	GraphiteSessionsSelectColumnUserID,
}

func (e GraphiteSessionsSelectColumn) IsValid() bool {
	switch e {
	case GraphiteSessionsSelectColumnAssistantID, GraphiteSessionsSelectColumnCreatedAt, GraphiteSessionsSelectColumnID, GraphiteSessionsSelectColumnSessionID, GraphiteSessionsSelectColumnUpdatedAt, GraphiteSessionsSelectColumnUserID:
		return true
	}
	return false
}

func (e GraphiteSessionsSelectColumn) String() string {
	return string(e)
}

func (e *GraphiteSessionsSelectColumn) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = GraphiteSessionsSelectColumn(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid _graphiteSessions_select_column", str)
	}
	return nil
}

func (e GraphiteSessionsSelectColumn) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *GraphiteSessionsSelectColumn) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e GraphiteSessionsSelectColumn) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
...
type GraphiteSessionsUpdateColumn string

const (
	// column name
	GraphiteSessionsUpdateColumnAssistantID GraphiteSessionsUpdateColumn = "assistantID"
	// column name
	GraphiteSessionsUpdateColumnCreatedAt GraphiteSessionsUpdateColumn = "createdAt"
	// column name
	GraphiteSessionsUpdateColumnID GraphiteSessionsUpdateColumn = "id"
	// column name
	GraphiteSessionsUpdateColumnSessionID GraphiteSessionsUpdateColumn = "sessionID"
	// column name
	GraphiteSessionsUpdateColumnUpdatedAt GraphiteSessionsUpdateColumn = "updatedAt"
	// column name
	GraphiteSessionsUpdateColumnUserID GraphiteSessionsUpdateColumn = "userID"
)

var AllGraphiteSessionsUpdateColumn = []GraphiteSessionsUpdateColumn{
	GraphiteSessionsUpdateColumnAssistantID,
	GraphiteSessionsUpdateColumnCreatedAt,
	GraphiteSessionsUpdateColumnID,
	GraphiteSessionsUpdateColumnSessionID,
	GraphiteSessionsUpdateColumnUpdatedAt,
	GraphiteSessionsUpdateColumnUserID,
}

func (e GraphiteSessionsUpdateColumn) IsValid() bool {
	switch e {
	case GraphiteSessionsUpdateColumnAssistantID, GraphiteSessionsUpdateColumnCreatedAt, GraphiteSessionsUpdateColumnID, GraphiteSessionsUpdateColumnSessionID, GraphiteSessionsUpdateColumnUpdatedAt, GraphiteSessionsUpdateColumnUserID:
		return true
	}
	return false
}

func (e GraphiteSessionsUpdateColumn) String() string {
	return string(e)
}

func (e *GraphiteSessionsUpdateColumn) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = GraphiteSessionsUpdateColumn(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid _graphiteSessions_update_column", str)
	}
	return nil
}

func (e GraphiteSessionsUpdateColumn) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *GraphiteSessionsUpdateColumn) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e GraphiteSessionsUpdateColumn) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
