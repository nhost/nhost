...
func TestSuperviseCancelsPeersOnError(t *testing.T) {
	...
	err := runner.Supervise(
		context.Background(), testTierTimeout, []runner.Service{failing, peer},
	)
...
func TestSuperviseJoinsServiceErrors(t *testing.T) {
	...
	err := runner.Supervise(context.Background(), testTierTimeout, []runner.Service{
...
func TestSuperviseRecoversPanickingService(t *testing.T) {
	...
	err := runner.Supervise(
		context.Background(), testTierTimeout, []runner.Service{panicking, peer},
	)
...
func TestSuperviseShutsDownOnContextCancel(t *testing.T) {
	...
	go func() {
		done <- runner.Supervise(ctx, testTierTimeout, []runner.Service{svc, svc})
	}()
...
func TestSuperviseFailureInLaterTierStopsAllAndReturnsErrors(t *testing.T) {
	...
	laterPeer := func(ctx context.Context) error { //nolint:unparam // signature must match runner.Service
		<-ctx.Done()
	...
	go func() {
			...
			context.Background(),
			testTierTimeout,
			[]runner.Service{tierZero},
			[]runner.Service{laterFailure, laterPeer},
		)
	}()
