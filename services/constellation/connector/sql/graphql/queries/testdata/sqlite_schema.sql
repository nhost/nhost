...
-- fixture for the insert-permission post-check regression.
...
-- regression. Postgres uses GENERATED BY DEFAULT AS IDENTITY; SQLite's
-- equivalent rowid alias is INTEGER PRIMARY KEY (without WITHOUT ROWID), which
-- the introspector now flags as IsIdentity.
