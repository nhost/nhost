...
//
// Run locally:
//   go test -fuzz=FuzzLexer    -fuzztime=30s ./services/constellation/internal/jsontmpl
//   go test -fuzz=FuzzParser   -fuzztime=30s ./services/constellation/internal/jsontmpl
//   go test -fuzz=FuzzRender   -fuzztime=30s ./services/constellation/internal/jsontmpl
