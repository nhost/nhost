...
// Defines values for ProviderSpecificParamsPrompt.
const (
	Consent       ProviderSpecificParamsPrompt = "consent"
	None          ProviderSpecificParamsPrompt = "none"
	SelectAccount ProviderSpecificParamsPrompt = "select_account"
)

// Valid indicates whether the value is a known member of the ProviderSpecificParamsPrompt enum.
func (e ProviderSpecificParamsPrompt) Valid() bool {
	switch e {
	case Consent:
		return true
	case None:
...
type ProviderSpecificParams struct {
	...
	AccessType *ProviderSpecificParamsAccessType `json:"access_type,omitempty"`
	...
	IncludeGrantedScopes *ProviderSpecificParamsIncludeGrantedScopes `json:"include_granted_scopes,omitempty"`
	...
	// Prompt (google) OpenID Connect prompt. When omitted, Google uses its default behavior. Use select_account to force the account chooser. See https://developers.google.com/identity/protocols/oauth2/openid-connect#authenticationuriparameters
	Prompt *ProviderSpecificParamsPrompt `json:"prompt,omitempty"`
}
...
// ProviderSpecificParamsPrompt (google) OpenID Connect prompt. When omitted, Google uses its default behavior. Use select_account to force the account chooser. See https://developers.google.com/identity/protocols/oauth2/openid-connect#authenticationuriparameters
type ProviderSpecificParamsPrompt string
