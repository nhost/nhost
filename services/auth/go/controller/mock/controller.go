...
func (m *MockDBClientGetUser) VerifySMSOTP(ctx context.Context, arg sql.VerifySMSOTPParams) (string, error) {
	m.ctrl.T.Helper()
...
// VerifySMSOTP mocks base method.
func (m *MockDBClient) VerifySMSOTP(ctx context.Context, arg sql.VerifySMSOTPParams) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "VerifySMSOTP", ctx, arg)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
