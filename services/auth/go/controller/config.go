...
type Config struct {
	...
	OAuth2ProviderDCREnabled           bool          `json:"AUTH_OAUTH2_PROVIDER_DCR_ENABLED"`
	OAuth2ProviderDCRMaxClientsPerUser int           `json:"AUTH_OAUTH2_PROVIDER_DCR_MAX_CLIENTS_PER_USER"`
}
