...
const (
	...
	flagOAuth2ProviderDCREnabled                 = "oauth2-provider-dcr-enabled"
	flagOAuth2ProviderDCRMaxClientsPerUser       = "oauth2-provider-dcr-max-clients-per-user"
...
func CommandServe() *cli.Command { //nolint:funlen,maintidx
	return &cli.Command{ //nolint: exhaustruct
		...
		Flags: []cli.Flag{
			...
			&cli.BoolFlag{ //nolint: exhaustruct
				Name:     flagOAuth2ProviderDCREnabled,
				Usage:    "Enable OAuth2 Dynamic Client Registration",
				Category: "oauth2-provider",
				Value:    false,
				Sources:  cli.EnvVars("AUTH_OAUTH2_PROVIDER_DCR_ENABLED"),
			},
			&cli.IntFlag{ //nolint: exhaustruct
				Name:     flagOAuth2ProviderDCRMaxClientsPerUser,
				Usage:    "Maximum number of OAuth2 clients a user can register (0 = unlimited)",
				Category: "oauth2-provider",
				Value:    0,
				Sources:  cli.EnvVars("AUTH_OAUTH2_PROVIDER_DCR_MAX_CLIENTS_PER_USER"),
			},
			&cli.BoolFlag{ //nolint: exhaustruct
