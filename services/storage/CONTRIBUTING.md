...
Welcome and thank you for considering contributing to hasura-storage!
...
We take our open source community seriously and hold ourselves and other contributors to high standards of communication. By participating and contributing to this project, you agree to uphold our [Code of Conduct](https://github.com/nhost/hasura-storage/blob/main/CODE_OF_CONDUCT.md).

## Getting Started

Contributions are made to hasura-storage repos via Issues and Pull Requests (PRs). A few general guidelines that cover both:
...
Issues should be used to report problems with hasura-storage. Use Discussions to request a new feature or to discuss potential changes before a PR is created.
