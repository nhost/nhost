...
// getLogger builds the structured logger for the storage server. It delegates
// to the shared serve package so logger construction stays identical across
// every Nhost service binary.
