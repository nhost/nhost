...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Log.service":
		if e.complexity.Log.Service == nil {
			break
		}

		return e.complexity.Log.Service(childComplexity), true
	case "Log.timestamp":
	...
	case "Query.getFunctionsLogs":
		if e.complexity.Query.GetFunctionsLogs == nil {
			break
		}
	...
	case "Query.getServiceLabelValues":
		...
		return e.complexity.Query.GetServiceLabelValues(childComplexity, args["appID"].(string)), true
	case "Query.logs":
		...
		return e.complexity.Query.Logs(childComplexity, args["appID"].(string), args["service"].(*string), args["regexFilter"].(*string), args["from"].(*time.Time), args["to"].(*time.Time)), true

	case "Subscription.getFunctionsLogs":
		if e.complexity.Subscription.GetFunctionsLogs == nil {
			break
		}
	...
	case "Subscription.logs":
		...
		return e.complexity.Subscription.Logs(childComplexity, args["appID"].(string), args["service"].(*string), args["regexFilter"].(*string), args["from"].(*time.Time)), true
...
func (ec *executionContext) field_Query_getFunctionsLogs_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "appID", ec.unmarshalNString2string)
	if err != nil {
		return nil, err
	}
	args["appID"] = arg0
...
func (ec *executionContext) _Query_getServiceLabelValues(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		ec.OperationContext,
		field,
		ec.fieldContext_Query_getServiceLabelValues,
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
...
func (ec *executionContext) marshalNLog2ᚕgithubᚗcomᚋnhostᚋnhostᚋcliᚋcmdᚋconfigserverᚋlogsapiᚋmodelᚐLogᚄ(ctx context.Context, sel ast.SelectionSet, v []model.Log) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNLog2githubᚗcomᚋnhostᚋnhostᚋcliᚋcmdᚋconfigserverᚋlogsapiᚋmodelᚐLog(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
