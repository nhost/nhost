...
// given host user mapping, returning the raw result so callers can assert on
// errors.
func runGetServices(
	t *testing.T,
	...
	return getServices(
		...
		"nhost/cli:dev", "00000000-0000-0000-0000-000000000000", false, hostUser,
	)
}
...
func TestGetServicesEngineMode(t *testing.T) {
	...
	services, err := runGetServices(t, engineModeConfig(), "")
	if err != nil {
