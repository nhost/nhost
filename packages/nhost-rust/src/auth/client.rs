...
impl Client {
    ...
    pub async fn get_jw_ks(&self) -> Result<JwkSet, Error> {
        let url = format!(
    ...
    pub async fn elevate_webauthn(&self) -> Result<PublicKeyCredentialRequestOptions, Error> {
    ...
    pub async fn health_check_get(&self) -> Result<OkResponse, Error> {
    ...
    pub async fn health_check_head(&self) -> Result<(), Error> {
        let url = format!("{base}/healthz", base = self.base_url.as_str());
    ...
    pub async fn link_id_token(&self, body: LinkIdTokenRequest) -> Result<OkResponse, Error> {
    ...
    pub async fn change_user_mfa(&self) -> Result<TotpGenerateResponse, Error> {
    ...
    /// Performs POST /pat.
    pub async fn create_pat(&self, body: CreatePatRequest) -> Result<CreatePatResponse, Error> {
    ...
    ) -> Result<SignInEmailPasswordResponse, Error> {
        let url = format!(
    ...
    ) -> Result<SignInOtpEmailVerifyResponse, Error> {
        let url = format!(
    ...
    ) -> Result<SignInPasswordlessSmsOtpResponse, Error> {
        let url = format!(
    ...
    pub async fn sign_in_pat(&self, body: SignInPatRequest) -> Result<SessionPayload, Error> {
    ...
    pub async fn get_provider_tokens(&self, provider: &str) -> Result<ProviderSession, Error> {
        let url = format!(
    ...
    pub async fn sign_out(&self, body: SignOutRequest) -> Result<OkResponse, Error> {
    ...
    /// Performs POST /token.
    pub async fn refresh_token(&self, body: RefreshTokenRequest) -> Result<Session, Error> {
    ...
    pub async fn verify_token(&self, body: Option<VerifyTokenRequest>) -> Result<String, Error> {
    ...
    pub async fn verify_change_user_mfa(&self, body: UserMfaRequest) -> Result<OkResponse, Error> {
    ...
    pub async fn add_security_key(&self) -> Result<PublicKeyCredentialCreationOptions, Error> {
    ...
    ) -> Result<VerifyAddSecurityKeyResponse, Error> {
    ...
    pub async fn get_version(&self) -> Result<GetVersionResponse200, Error> {
    ...
    pub async fn get_open_id_configuration(&self) -> Result<OAuth2DiscoveryResponse, Error> {
        let url = format!(
    ...
    pub async fn get_o_auth_authorization_server(&self) -> Result<OAuth2DiscoveryResponse, Error> {
        let url = format!(
    ...
    pub async fn oauth2_userinfo_get(&self) -> Result<OAuth2UserinfoResponse, Error> {
    ...
    pub async fn oauth2_userinfo_post(&self) -> Result<OAuth2UserinfoResponse, Error> {
        let url = format!("{base}/oauth2/userinfo", base = self.base_url.as_str());
        let mut request = self.http.request(reqwest::Method::POST, url);
        let (_status, _headers, bytes) = http::send(request, self.session_sink.as_ref()).await?;
        Ok(serde_json::from_slice(&bytes)?)
    ...
    pub async fn oauth2_jwks(&self) -> Result<OAuth2jwksResponse, Error> {
    ...
    pub async fn oauth2_revoke(&self, body: OAuth2RevokeRequest) -> Result<(), Error> {
    ...
    ) -> Result<OAuth2IntrospectResponse, Error> {
    ...
    ) -> Result<OAuth2LoginResponse, Error> {
    ...
    ) -> Result<OAuth2LoginCompleteResponse, Error> {
        let url = format!("{base}/oauth2/login", base = self.base_url.as_str());
        let mut request = self.http.request(reqwest::Method::POST, url);
        request = request.json(&body);
        let (_status, _headers, bytes) = http::send(request, self.session_sink.as_ref()).await?;
