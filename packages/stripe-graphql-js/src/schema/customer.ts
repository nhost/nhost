  ...
  fields: (t) => ({
    ...
    subscriptions: t.field({
      ...
      resolve: async (customer) => {
        ...
        return subscriptions as Stripe.Response<
          Stripe.ApiList<StripeSubscription>
        >;
      },
    }),
    invoices: t.field({
    ...
    paymentIntents: t.field({
      ...
      resolve: async (customer) => {
        ...
        return paymentIntents as Stripe.Response<
          Stripe.ApiList<StripePaymentIntent>
        >;
      },
    }),
    paymentMethods: t.field({
      ...
      resolve: async (
        customer,
        { type, startingAfter, endingBefore, limit },
      ) => {
        ...
        return paymentMethods as Stripe.Response<
          Stripe.ApiList<StripePaymentMethod>
        >;
      },
    }),
    charges: t.field({
