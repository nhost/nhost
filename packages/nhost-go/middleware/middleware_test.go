...
func TestAttachAccessToken(t *testing.T) {
	...
	seen := run(t, middleware.AttachAccessToken(store), newReq(t, "https://x/v1/graphql"))
	...
	seen = run(t, middleware.AttachAccessToken(store), req)
...
func TestWithRole(t *testing.T) {
	...
	seen := run(t, middleware.WithRole("editor"), newReq(t, "https://x/v1/graphql"))
...
func TestUpdateSessionFromResponseSignout(t *testing.T) {
	...
	run(t, middleware.UpdateSessionFromResponse(store), newReq(t, "https://x/v1/signout"))
...
func TestUpdateSessionFromResponseStoresAndRestoresBody(t *testing.T) {
	...
	resp, err := middleware.UpdateSessionFromResponse(store)(next).RoundTrip(newReq(t, "https://x/v1/token"))
	if err != nil {
