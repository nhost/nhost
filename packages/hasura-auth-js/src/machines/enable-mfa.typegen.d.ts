export interface Typegen0 {
    ...
    matchesStates: 'generated' | 'generated.activated' | 'generated.activating' | 'generated.idle' | 'generated.idle.error' | 'generated.idle.idle' | 'generating' | 'idle' | 'idle.error' | 'idle.initial' | {
